...
internal class StopIdsForAgencyListResponseTest {
    ...
    fun create() {
        val stopIdsForAgencyListResponse =
            StopIdsForAgencyListResponse.builder()
                .code(0L)
                .currentTime(0L)
                .text("text")
                .version(0L)
                .data(
                    StopIdsForAgencyListResponse.Data.builder()
                        .limitExceeded(true)
                        .addList("string")
                        .references(
                            References.builder()
        ...
        assertThat(stopIdsForAgencyListResponse.data())
            .isEqualTo(
                StopIdsForAgencyListResponse.Data.builder()
                    .limitExceeded(true)
                    .addList("string")
    ...
    fun roundtrip() {
        ...
        val roundtrippedStopIdsForAgencyListResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(stopIdsForAgencyListResponse),
                jacksonTypeRef<StopIdsForAgencyListResponse>(),
            )
