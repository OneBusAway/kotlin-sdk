...
internal class RouteIdsForAgencyListResponseTest {
    ...
    fun create() {
        val routeIdsForAgencyListResponse =
            RouteIdsForAgencyListResponse.builder()
                .code(0L)
                .currentTime(0L)
                .text("text")
                .version(0L)
                .data(
                    RouteIdsForAgencyListResponse.Data.builder()
                        .limitExceeded(true)
                        .addList("string")
                        .references(
                            References.builder()
        ...
        assertThat(routeIdsForAgencyListResponse.data())
            .isEqualTo(
                RouteIdsForAgencyListResponse.Data.builder()
                    .limitExceeded(true)
                    .addList("string")
    ...
    fun roundtrip() {
        ...
        val roundtrippedRouteIdsForAgencyListResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(routeIdsForAgencyListResponse),
                jacksonTypeRef<RouteIdsForAgencyListResponse>(),
            )

        assertThat(roundtrippedRouteIdsForAgencyListResponse)
            .isEqualTo(routeIdsForAgencyListResponse)
    }
}
