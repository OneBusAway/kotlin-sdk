...
internal class VehiclesForAgencyListResponseTest {
    ...
    fun create() {
        val vehiclesForAgencyListResponse =
            VehiclesForAgencyListResponse.builder()
                .code(0L)
                .currentTime(0L)
                .text("text")
                .version(0L)
                    ...
                    VehiclesForAgencyListResponse.Data.builder()
                        ...
                        .addList(
                            VehiclesForAgencyListResponse.Data.List.builder()
                                ...
                                .lastUpdateTime(0L)
                                .location(
                                    VehiclesForAgencyListResponse.Data.List.Location.builder()
                                        .lat(0.0)
                                        .lon(0.0)
                                        .build()
                                )
                                .tripId("tripId")
                                .tripStatus(
                                    VehiclesForAgencyListResponse.Data.List.TripStatus.builder()
                                        ...
                                        .frequency("frequency")
                                        .lastKnownLocation(
                                            VehiclesForAgencyListResponse.Data.List.TripStatus
                                                .LastKnownLocation
                                                .builder()
                                                .lat(0.0)
                                                .lon(0.0)
                        ...
                        VehiclesForAgencyListResponse.Data.List.builder()
                            ...
                            .tripStatus(
                                VehiclesForAgencyListResponse.Data.List.TripStatus.builder()
                                    ...
                                    .orientation(0.0)
                                    .position(
                                        VehiclesForAgencyListResponse.Data.List.TripStatus.Position
                                            .builder()
                                            .lat(0.0)
                                            .lon(0.0)
                                            .build()
    ...
    fun roundtrip() {
        ...
        val roundtrippedVehiclesForAgencyListResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(vehiclesForAgencyListResponse),
                jacksonTypeRef<VehiclesForAgencyListResponse>(),
            )

        assertThat(roundtrippedVehiclesForAgencyListResponse)
            .isEqualTo(vehiclesForAgencyListResponse)
    }
}
