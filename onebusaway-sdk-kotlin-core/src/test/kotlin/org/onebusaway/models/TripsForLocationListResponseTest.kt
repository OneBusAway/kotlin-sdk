...
internal class TripsForLocationListResponseTest {
                            ...
                            TripsForLocationListResponse.Data.List.builder()
                                .schedule(
                                    TripsForLocationListResponse.Data.List.Schedule.builder()
                                        ...
                                        .addStopTime(
                                            TripsForLocationListResponse.Data.List.Schedule.StopTime
                                                .builder()
                                                .arrivalTime(0L)
                                                .departureTime(0L)
    ...
    fun roundtrip() {
        ...
        val roundtrippedTripsForLocationListResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(tripsForLocationListResponse),
                jacksonTypeRef<TripsForLocationListResponse>(),
            )
