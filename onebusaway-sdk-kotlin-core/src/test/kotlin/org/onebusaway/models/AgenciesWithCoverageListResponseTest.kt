...
internal class AgenciesWithCoverageListResponseTest {
    ...
    fun create() {
        val agenciesWithCoverageListResponse =
            AgenciesWithCoverageListResponse.builder()
                .code(0L)
                .currentTime(0L)
                .text("text")
                .version(0L)
    ...
    fun roundtrip() {
        ...
        val roundtrippedAgenciesWithCoverageListResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(agenciesWithCoverageListResponse),
                jacksonTypeRef<AgenciesWithCoverageListResponse>(),
            )

        assertThat(roundtrippedAgenciesWithCoverageListResponse)
            .isEqualTo(agenciesWithCoverageListResponse)
    }
}
