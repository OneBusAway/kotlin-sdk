...
internal class RoutesForAgencyListResponseTest {
    ...
    fun create() {
        val routesForAgencyListResponse =
            RoutesForAgencyListResponse.builder()
                .code(0L)
                .currentTime(0L)
                .text("text")
                .version(0L)
    ...
    fun roundtrip() {
        ...
        val roundtrippedRoutesForAgencyListResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(routesForAgencyListResponse),
                jacksonTypeRef<RoutesForAgencyListResponse>(),
            )
