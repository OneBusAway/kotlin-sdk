...
internal class RoutesForLocationListResponseTest {
    ...
    fun create() {
        val routesForLocationListResponse =
            RoutesForLocationListResponse.builder()
                .code(0L)
                .currentTime(0L)
                .text("text")
                .version(0L)
                .data(
                    RoutesForLocationListResponse.Data.builder()
                        .limitExceeded(true)
                        .addList(
                            RoutesForLocationListResponse.Data.List.builder()
                                .id("id")
                                .agencyId("agencyId")
                                .type(0L)
                                .color("color")
        ...
        assertThat(routesForLocationListResponse.data())
            .isEqualTo(
                RoutesForLocationListResponse.Data.builder()
                    .limitExceeded(true)
                    .addList(
    ...
    fun roundtrip() {
        ...
        val roundtrippedRoutesForLocationListResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(routesForLocationListResponse),
                jacksonTypeRef<RoutesForLocationListResponse>(),
            )

        assertThat(roundtrippedRoutesForLocationListResponse)
            .isEqualTo(routesForLocationListResponse)
    }
}
