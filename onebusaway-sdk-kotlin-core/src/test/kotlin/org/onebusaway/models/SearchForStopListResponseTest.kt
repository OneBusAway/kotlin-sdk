...
internal class SearchForStopListResponseTest {
    ...
    fun create() {
        val searchForStopListResponse =
            SearchForStopListResponse.builder()
                .code(0L)
                .currentTime(0L)
                .text("text")
                .version(0L)
    ...
    fun roundtrip() {
        ...
        val roundtrippedSearchForStopListResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(searchForStopListResponse),
                jacksonTypeRef<SearchForStopListResponse>(),
            )
