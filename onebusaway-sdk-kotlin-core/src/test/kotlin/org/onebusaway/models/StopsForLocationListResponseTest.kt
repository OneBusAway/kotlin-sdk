...
internal class StopsForLocationListResponseTest {
    ...
    fun create() {
        val stopsForLocationListResponse =
            StopsForLocationListResponse.builder()
                .code(0L)
                .currentTime(0L)
                .text("text")
                .version(0L)
    ...
    fun roundtrip() {
        ...
        val roundtrippedStopsForLocationListResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(stopsForLocationListResponse),
                jacksonTypeRef<StopsForLocationListResponse>(),
            )
