...
internal class AgencyRetrieveResponseTest {

    @Test
    fun create() {
        val agencyRetrieveResponse =
            AgencyRetrieveResponse.builder()
                .code(0L)
                .currentTime(0L)
                .text("text")
                .version(0L)
                .data(
                    AgencyRetrieveResponse.Data.builder()
                        .entry(
                            AgencyRetrieveResponse.Data.Entry.builder()
                                .id("id")
                                .name("name")
                                .timezone("timezone")
                                .url("url")
        ...
        assertThat(agencyRetrieveResponse.code()).isEqualTo(0L)
        assertThat(agencyRetrieveResponse.currentTime()).isEqualTo(0L)
        assertThat(agencyRetrieveResponse.text()).isEqualTo("text")
        assertThat(agencyRetrieveResponse.version()).isEqualTo(0L)
        assertThat(agencyRetrieveResponse.data())
            .isEqualTo(
                AgencyRetrieveResponse.Data.builder()
                    .entry(
                        AgencyRetrieveResponse.Data.Entry.builder()
    ...
    fun roundtrip() {
        ...
        val roundtrippedAgencyRetrieveResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(agencyRetrieveResponse),
                jacksonTypeRef<AgencyRetrieveResponse>(),
            )

        assertThat(roundtrippedAgencyRetrieveResponse).isEqualTo(agencyRetrieveResponse)
    }
}
