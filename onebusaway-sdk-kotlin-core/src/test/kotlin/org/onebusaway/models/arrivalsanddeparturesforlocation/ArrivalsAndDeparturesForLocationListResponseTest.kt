...
internal class ArrivalsAndDeparturesForLocationListResponseTest {
    ...
    @Test
    fun create() {
        val arrivalsAndDeparturesForLocationListResponse =
            ArrivalsAndDeparturesForLocationListResponse.builder()
                .code(0L)
                .currentTime(0L)
                .text("text")
                .version(0L)
                .data(
                    ArrivalsAndDeparturesForLocationListResponse.Data.builder()
                        .entry(
                            ArrivalsAndDeparturesForLocationListResponse.Data.Entry.builder()
                                .addArrivalsAndDeparture(
                                    ArrivalsAndDeparturesForLocationListResponse.Data.Entry
        ...
        assertThat(arrivalsAndDeparturesForLocationListResponse.data())
            .isEqualTo(
                ArrivalsAndDeparturesForLocationListResponse.Data.builder()
                    .entry(
                        ArrivalsAndDeparturesForLocationListResponse.Data.Entry.builder()
                                ...
                                ArrivalsAndDeparturesForLocationListResponse.Data.Entry
                                    ...
                                    .tripStatus(
                                        ArrivalsAndDeparturesForLocationListResponse.Data.Entry
                                            ...
                                            .frequency("frequency")
                                            .lastKnownLocation(
                                                ArrivalsAndDeparturesForLocationListResponse.Data
                                                    .Entry
                                                    .ArrivalsAndDeparture
                                                    .TripStatus
                                                    .LastKnownLocation
                            ...
                            .limitExceeded(true)
                            .addNearbyStopId(
                                ArrivalsAndDeparturesForLocationListResponse.Data.Entry.NearbyStopId
                                    .builder()
                                    .distanceFromQuery(0.0)
                                    .stopId("stopId")
                                    .build()
    ...
    fun roundtrip() {
        ...
        val roundtrippedArrivalsAndDeparturesForLocationListResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(arrivalsAndDeparturesForLocationListResponse),
                jacksonTypeRef<ArrivalsAndDeparturesForLocationListResponse>(),
            )

        assertThat(roundtrippedArrivalsAndDeparturesForLocationListResponse)
            .isEqualTo(arrivalsAndDeparturesForLocationListResponse)
    }
}
