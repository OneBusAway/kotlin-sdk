...
class ArrivalAndDepartureServiceTest {
    ...
    fun retrieve() {
      ...
      val arrivalAndDeparture = arrivalAndDepartureService.retrieve(ArrivalAndDepartureRetrieveParams.builder()
          .stopId("1_75403")
          .serviceDate(0L)
          .tripId("tripId")
          .stopSequence(0L)
    ...
    fun list() {
      ...
      val arrivalAndDeparture = arrivalAndDepartureService.list(ArrivalAndDepartureListParams.builder()
          .stopId("1_75403")
          .minutesAfter(0L)
          .minutesBefore(0L)
