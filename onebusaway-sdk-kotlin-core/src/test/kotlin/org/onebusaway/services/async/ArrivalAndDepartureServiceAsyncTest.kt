...
class ArrivalAndDepartureServiceAsyncTest {
    ...
    suspend fun retrieve() {
      ...
      val arrivalAndDeparture = arrivalAndDepartureServiceAsync.retrieve(ArrivalAndDepartureRetrieveParams.builder()
          .stopId("1_75403")
          .serviceDate(0L)
          .tripId("tripId")
          .stopSequence(0L)
    ...
    suspend fun list() {
      ...
      val arrivalAndDeparture = arrivalAndDepartureServiceAsync.list(ArrivalAndDepartureListParams.builder()
          .stopId("1_75403")
          .minutesAfter(0L)
          .minutesBefore(0L)
