...
@NoAutoDetect
class OnebusawaySdkError @JsonCreator private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [OnebusawaySdkError]. */
        fun builder() = Builder()
    }
    ...
    class Builder internal constructor() {
        ...
        internal fun from(onebusawaySdkError: OnebusawaySdkError) =
            apply {
