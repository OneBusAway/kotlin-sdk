...
class TripForVehicleRetrieveParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(tripForVehicleRetrieveParams: TripForVehicleRetrieveParams) =
            apply {
    ...
    override fun toString() = "TripForVehicleRetrieveParams{vehicleId=$vehicleId, includeSchedule=$includeSchedule, includeStatus=$includeStatus, includeTrip=$includeTrip, time=$time, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
