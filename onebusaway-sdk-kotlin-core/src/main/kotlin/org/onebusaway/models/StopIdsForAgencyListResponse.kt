...
@NoAutoDetect
class StopIdsForAgencyListResponse @JsonCreator private constructor(
    ...
    class Data @JsonCreator private constructor(
        ...
        @JsonProperty("list") @ExcludeMissing private val list: JsonField<List<String>> = JsonMissing.of(),
