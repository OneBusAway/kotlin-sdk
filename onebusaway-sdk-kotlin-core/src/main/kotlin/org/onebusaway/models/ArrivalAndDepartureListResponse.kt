...
@NoAutoDetect
class ArrivalAndDepartureListResponse @JsonCreator private constructor(
    ...
    class Data @JsonCreator private constructor(
        ...
        class Entry @JsonCreator private constructor(
            @JsonProperty("arrivalsAndDepartures") @ExcludeMissing private val arrivalsAndDepartures: JsonField<List<ArrivalsAndDeparture>> = JsonMissing.of(),
            @JsonAnySetter private val additionalProperties: Map<String, JsonValue> = immutableEmptyMap(),
            ...
            @NoAutoDetect
            class ArrivalsAndDeparture @JsonCreator private constructor(
                ...
                @JsonProperty("numberOfStopsAway") @ExcludeMissing private val numberOfStopsAway: JsonField<Long> = JsonMissing.of(),
                @JsonProperty("predictedArrivalTime") @ExcludeMissing private val predictedArrivalTime: JsonField<Long> = JsonMissing.of(),
                @JsonProperty("predictedDepartureTime") @ExcludeMissing private val predictedDepartureTime: JsonField<Long> = JsonMissing.of(),
                @JsonProperty("routeId") @ExcludeMissing private val routeId: JsonField<String> = JsonMissing.of(),
                @JsonProperty("scheduledArrivalTime") @ExcludeMissing private val scheduledArrivalTime: JsonField<Long> = JsonMissing.of(),
                @JsonProperty("scheduledDepartureTime") @ExcludeMissing private val scheduledDepartureTime: JsonField<Long> = JsonMissing.of(),
                ...
                @JsonProperty("stopSequence") @ExcludeMissing private val stopSequence: JsonField<Long> = JsonMissing.of(),
                @JsonProperty("totalStopsInTrip") @ExcludeMissing private val totalStopsInTrip: JsonField<Long> = JsonMissing.of(),
                ...
                @JsonProperty("actualTrack") @ExcludeMissing private val actualTrack: JsonField<String> = JsonMissing.of(),
                @JsonProperty("distanceFromStop") @ExcludeMissing private val distanceFromStop: JsonField<Double> = JsonMissing.of(),
                ...
                @JsonProperty("predictedArrivalInterval") @ExcludeMissing private val predictedArrivalInterval: JsonField<String> = JsonMissing.of(),
                @JsonProperty("predictedDepartureInterval") @ExcludeMissing private val predictedDepartureInterval: JsonField<String> = JsonMissing.of(),
                @JsonProperty("predictedOccupancy") @ExcludeMissing private val predictedOccupancy: JsonField<String> = JsonMissing.of(),
                @JsonProperty("routeLongName") @ExcludeMissing private val routeLongName: JsonField<String> = JsonMissing.of(),
                @JsonProperty("routeShortName") @ExcludeMissing private val routeShortName: JsonField<String> = JsonMissing.of(),
                @JsonProperty("scheduledArrivalInterval") @ExcludeMissing private val scheduledArrivalInterval: JsonField<String> = JsonMissing.of(),
                @JsonProperty("scheduledDepartureInterval") @ExcludeMissing private val scheduledDepartureInterval: JsonField<String> = JsonMissing.of(),
                @JsonProperty("scheduledTrack") @ExcludeMissing private val scheduledTrack: JsonField<String> = JsonMissing.of(),
                ...
                @JsonProperty("tripStatus") @ExcludeMissing private val tripStatus: JsonField<TripStatus> = JsonMissing.of(),
                @JsonAnySetter private val additionalProperties: Map<String, JsonValue> = immutableEmptyMap(),
                ...
                /** Trip-specific status for the arriving transit vehicle. */
                @NoAutoDetect
                class TripStatus @JsonCreator private constructor(
