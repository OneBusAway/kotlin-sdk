...
private constructor(
    ...
    private constructor(
        ...
        private constructor(
            ...
            override fun equals(other: Any?): Boolean {
                ...
                return /* spotless:off */ other is Entry && this.arrivalsAndDepartures == other.arrivalsAndDepartures && this.additionalProperties == other.additionalProperties /* spotless:on */
            }
            ...
            override fun hashCode(): Int {
                if (hashCode == 0) {
                    hashCode = /* spotless:off */ Objects.hash(arrivalsAndDepartures, additionalProperties) /* spotless:on */
                }
                return hashCode
            }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is ArrivalAndDepartureListResponse && this.code == other.code && this.currentTime == other.currentTime && this.text == other.text && this.version == other.version && this.data == other.data && this.additionalProperties == other.additionalProperties /* spotless:on */
    }
