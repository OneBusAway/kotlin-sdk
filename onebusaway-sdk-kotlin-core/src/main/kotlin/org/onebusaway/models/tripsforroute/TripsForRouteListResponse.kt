...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(tripsForRouteListResponse: TripsForRouteListResponse) = apply {
    ...
    fun validate(): TripsForRouteListResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
        ...
        private constructor(
            ...
            private constructor(
                 ...
                 */
                internal fun validity(): Int =
                    (if (nextTripId.asKnown() == null) 0 else 1) +
                        (if (previousTripId.asKnown() == null) 0 else 1) +
                        (stopTimes.asKnown()?.sumOf { it.validity().toInt() } ?: 0) +
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is TripsForRouteListResponse && code == other.code && currentTime == other.currentTime && text == other.text && version == other.version && data == other.data && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "TripsForRouteListResponse{code=$code, currentTime=$currentTime, text=$text, version=$version, data=$data, additionalProperties=$additionalProperties}"
}
