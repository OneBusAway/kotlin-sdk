...
private constructor(
    ...
    private constructor(
        ...
        private constructor(
            ...
            private constructor(
                ...
                @ExcludeMissing
                arrivalsAndDepartures: JsonField<List<ArrivalsAndDeparture>> = JsonMissing.of(),
                @JsonProperty("limitExceeded")
                @ExcludeMissing
                limitExceeded: JsonField<Boolean> = JsonMissing.of(),
                @JsonProperty("nearbyStopIds")
                @ExcludeMissing
                nearbyStopIds: JsonField<List<NearbyStopId>> = JsonMissing.of(),
            ...
            class Builder internal constructor() {
                ...
                fun nearbyStopIds(nearbyStopIds: List<NearbyStopId>) =
                 ...
                 * `List<NearbyStopId>` value instead. This method is primarily for setting the
                 * field to an undocumented or not yet supported value.
                 */
                fun nearbyStopIds(nearbyStopIds: JsonField<List<NearbyStopId>>) = apply {
             ...
             */
            internal fun validity(): Int =
                (arrivalsAndDepartures.asKnown()?.sumOf { it.validity().toInt() } ?: 0) +
                    (if (limitExceeded.asKnown() == null) 0 else 1) +
                    (nearbyStopIds.asKnown()?.sumOf { it.validity().toInt() } ?: 0) +
            ...
            private constructor(
                ...
                internal fun validity(): Int =
                    (if (arrivalEnabled.asKnown() == null) 0 else 1) +
                        (if (blockTripSequence.asKnown() == null) 0 else 1) +
                        (if (departureEnabled.asKnown() == null) 0 else 1) +
                        (if (numberOfStopsAway.asKnown() == null) 0 else 1) +
                        (if (predictedArrivalTime.asKnown() == null) 0 else 1) +
                        (if (predictedDepartureTime.asKnown() == null) 0 else 1) +
                        (if (routeId.asKnown() == null) 0 else 1) +
                        (if (scheduledArrivalTime.asKnown() == null) 0 else 1) +
                        (if (scheduledDepartureTime.asKnown() == null) 0 else 1) +
                        (if (serviceDate.asKnown() == null) 0 else 1) +
                        (if (stopId.asKnown() == null) 0 else 1) +
                        (if (stopSequence.asKnown() == null) 0 else 1) +
                        (if (totalStopsInTrip.asKnown() == null) 0 else 1) +
                        (if (tripHeadsign.asKnown() == null) 0 else 1) +
                        (if (tripId.asKnown() == null) 0 else 1) +
                        (if (vehicleId.asKnown() == null) 0 else 1) +
                        (if (actualTrack.asKnown() == null) 0 else 1) +
                        (if (distanceFromStop.asKnown() == null) 0 else 1) +
                        (if (frequency.asKnown() == null) 0 else 1) +
                        (if (historicalOccupancy.asKnown() == null) 0 else 1) +
                        (if (lastUpdateTime.asKnown() == null) 0 else 1) +
                        (if (occupancyStatus.asKnown() == null) 0 else 1) +
                        (if (predicted.asKnown() == null) 0 else 1) +
                        (if (predictedArrivalInterval.asKnown() == null) 0 else 1) +
                        (if (predictedDepartureInterval.asKnown() == null) 0 else 1) +
                        (if (predictedOccupancy.asKnown() == null) 0 else 1) +
                        (if (routeLongName.asKnown() == null) 0 else 1) +
                        (if (routeShortName.asKnown() == null) 0 else 1) +
                        (if (scheduledArrivalInterval.asKnown() == null) 0 else 1) +
                        (if (scheduledDepartureInterval.asKnown() == null) 0 else 1) +
                        (if (scheduledTrack.asKnown() == null) 0 else 1) +
                        (situationIds.asKnown()?.size ?: 0) +
                ...
                private constructor(
                     ...
                     */
                    internal fun validity(): Int =
                        (if (activeTripId.asKnown() == null) 0 else 1) +
                            (if (blockTripSequence.asKnown() == null) 0 else 1) +
                            (if (closestStop.asKnown() == null) 0 else 1) +
                            (if (distanceAlongTrip.asKnown() == null) 0 else 1) +
                            (if (lastKnownDistanceAlongTrip.asKnown() == null) 0 else 1) +
                            ...
                            (if (predicted.asKnown() == null) 0 else 1) +
                            (if (scheduleDeviation.asKnown() == null) 0 else 1) +
                            (if (serviceDate.asKnown() == null) 0 else 1) +
                            (if (status.asKnown() == null) 0 else 1) +
                            (if (totalDistanceAlongTrip.asKnown() == null) 0 else 1) +
                            (if (closestStopTimeOffset.asKnown() == null) 0 else 1) +
                            (if (frequency.asKnown() == null) 0 else 1) +
                            (lastKnownLocation.asKnown()?.validity() ?: 0) +
                            (if (lastKnownOrientation.asKnown() == null) 0 else 1) +
                            (if (nextStop.asKnown() == null) 0 else 1) +
                            (if (nextStopTimeOffset.asKnown() == null) 0 else 1) +
                            (if (orientation.asKnown() == null) 0 else 1) +
                            (position.asKnown()?.validity() ?: 0) +
                            (if (scheduledDistanceAlongTrip.asKnown() == null) 0 else 1) +
                            (situationIds.asKnown()?.size ?: 0) +
                            (if (vehicleId.asKnown() == null) 0 else 1)
            ...
            private constructor(
                ...
                private constructor(
                    ...
                    @ExcludeMissing
                    distanceFromQuery: JsonField<Double> = JsonMissing.of(),
                    @JsonProperty("stopId")
                    @ExcludeMissing
                    stopId: JsonField<String> = JsonMissing.of(),
                ) : this(distanceFromQuery, stopId, mutableMapOf())

                /**
                 * @throws OnebusawaySdkInvalidDataException if the JSON field has an unexpected
                 *   type (e.g. if the server responded with an unexpected value).
                 */
                fun distanceFromQuery(): Double? =
                    distanceFromQuery.getNullable("distanceFromQuery")
                 ...
                 *
                 * Unlike [distanceFromQuery], this method doesn't throw if the JSON field has an
                 * unexpected type.
                 */
                @JsonProperty("distanceFromQuery")
                @ExcludeMissing
                ...
                class Builder internal constructor() {
                    ...
                    internal fun from(nearbyStopId: NearbyStopId) = apply {
                    ...
                    fun distanceFromQuery(distanceFromQuery: Double) =
                        distanceFromQuery(JsonField.of(distanceFromQuery))

                    /**
                     * Sets [Builder.distanceFromQuery] to an arbitrary JSON value.
                     *
                     * You should usually call [Builder.distanceFromQuery] with a well-typed
                     * [Double] value instead. This method is primarily for setting the field to an
                     * undocumented or not yet supported value.
                     */
                    fun distanceFromQuery(distanceFromQuery: JsonField<Double>) = apply {
                    ...
                    fun build(): NearbyStopId =
                        NearbyStopId(distanceFromQuery, stopId, additionalProperties.toMutableMap())
                }
                 ...
                 *   doesn't match its expected type.
                 */
                fun validate(): NearbyStopId = apply {
                    if (validated) {
                        return@apply
                    }
                 ...
                 */
                internal fun validity(): Int =
                    (if (distanceFromQuery.asKnown() == null) 0 else 1) +
                        (if (stopId.asKnown() == null) 0 else 1)
                ...
                override fun equals(other: Any?): Boolean {
                    ...
                    return other is NearbyStopId &&
                        distanceFromQuery == other.distanceFromQuery &&
                        stopId == other.stopId &&
                        additionalProperties == other.additionalProperties
                }

                private val hashCode: Int by lazy {
                    Objects.hash(distanceFromQuery, stopId, additionalProperties)
                }

                override fun hashCode(): Int = hashCode

                override fun toString() =
                    "NearbyStopId{distanceFromQuery=$distanceFromQuery, stopId=$stopId, additionalProperties=$additionalProperties}"
            }
            ...
            override fun equals(other: Any?): Boolean {
                ...
                return other is Entry &&
                    ...
                    nearbyStopIds == other.nearbyStopIds &&
            ...
            override fun toString() =
                "Entry{arrivalsAndDepartures=$arrivalsAndDepartures, limitExceeded=$limitExceeded, nearbyStopIds=$nearbyStopIds, stopIds=$stopIds, situationIds=$situationIds, additionalProperties=$additionalProperties}"
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ArrivalsAndDeparturesForLocationListResponse &&
            code == other.code &&
    ...
    override fun toString() =
        "ArrivalsAndDeparturesForLocationListResponse{code=$code, currentTime=$currentTime, text=$text, version=$version, data=$data, additionalProperties=$additionalProperties}"
}
