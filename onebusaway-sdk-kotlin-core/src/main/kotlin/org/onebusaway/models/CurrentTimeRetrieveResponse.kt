...
private constructor(
    ...
    class Builder {
        ...
        internal fun from(currentTimeRetrieveResponse: CurrentTimeRetrieveResponse) = apply {
            this.code = currentTimeRetrieveResponse.code
            this.currentTime = currentTimeRetrieveResponse.currentTime
            this.text = currentTimeRetrieveResponse.text
            this.version = currentTimeRetrieveResponse.version
            this.data = currentTimeRetrieveResponse.data
            additionalProperties(currentTimeRetrieveResponse.additionalProperties)
        }
        ...
        private constructor(
            ...
            class Builder {
                ...
                internal fun from(entry: Entry) = apply {
                    this.readableTime = entry.readableTime
            ...
            override fun equals(other: Any?): Boolean {
                ...
                return /* spotless:off */ other is Entry && this.readableTime == other.readableTime && this.time == other.time && this.additionalProperties == other.additionalProperties /* spotless:on */
            }
            ...
            override fun hashCode(): Int {
                if (hashCode == 0) {
                    hashCode = /* spotless:off */ Objects.hash(readableTime, time, additionalProperties) /* spotless:on */
                }
                return hashCode
            }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is CurrentTimeRetrieveResponse && this.code == other.code && this.currentTime == other.currentTime && this.text == other.text && this.version == other.version && this.data == other.data && this.additionalProperties == other.additionalProperties /* spotless:on */
    }
