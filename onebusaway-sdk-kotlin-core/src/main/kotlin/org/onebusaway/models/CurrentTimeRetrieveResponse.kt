...
@NoAutoDetect
class CurrentTimeRetrieveResponse @JsonCreator private constructor(
    ...
    class Data @JsonCreator private constructor(
        ...
        class Entry @JsonCreator private constructor(
            @JsonProperty("readableTime") @ExcludeMissing private val readableTime: JsonField<String> = JsonMissing.of(),
            @JsonProperty("time") @ExcludeMissing private val time: JsonField<Long> = JsonMissing.of(),
            @JsonAnySetter private val additionalProperties: Map<String, JsonValue> = immutableEmptyMap(),
