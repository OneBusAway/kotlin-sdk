...
@JsonDeserialize(builder = TripsForRouteListResponse.Builder::class)
@NoAutoDetect
...
private constructor(
    ...
    class Builder {
        ...
        internal fun from(tripsForRouteListResponse: TripsForRouteListResponse) = apply {
            this.code = tripsForRouteListResponse.code
            this.currentTime = tripsForRouteListResponse.currentTime
            this.text = tripsForRouteListResponse.text
            this.version = tripsForRouteListResponse.version
            this.data = tripsForRouteListResponse.data
            additionalProperties(tripsForRouteListResponse.additionalProperties)
        }
    ...
    private constructor(
        ...
        private constructor(
            ...
            override fun equals(other: Any?): Boolean {
                ...
                return /* spotless:off */ other is List && this.frequency == other.frequency && this.serviceDate == other.serviceDate && this.situationIds == other.situationIds && this.tripId == other.tripId && this.schedule == other.schedule && this.status == other.status && this.additionalProperties == other.additionalProperties /* spotless:on */
            }
            ...
            override fun hashCode(): Int {
                if (hashCode == 0) {
                    hashCode = /* spotless:off */ Objects.hash(frequency, serviceDate, situationIds, tripId, schedule, status, additionalProperties) /* spotless:on */
                }
                return hashCode
            }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is TripsForRouteListResponse && this.code == other.code && this.currentTime == other.currentTime && this.text == other.text && this.version == other.version && this.data == other.data && this.additionalProperties == other.additionalProperties /* spotless:on */
    }
