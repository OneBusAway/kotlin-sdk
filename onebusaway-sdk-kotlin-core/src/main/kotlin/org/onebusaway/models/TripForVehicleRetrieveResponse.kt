...
@JsonDeserialize(builder = TripForVehicleRetrieveResponse.Builder::class)
@NoAutoDetect
...
private constructor(
    ...
    class Builder {
        ...
        internal fun from(tripForVehicleRetrieveResponse: TripForVehicleRetrieveResponse) = apply {
            this.code = tripForVehicleRetrieveResponse.code
            this.currentTime = tripForVehicleRetrieveResponse.currentTime
            this.text = tripForVehicleRetrieveResponse.text
            this.version = tripForVehicleRetrieveResponse.version
            this.data = tripForVehicleRetrieveResponse.data
            additionalProperties(tripForVehicleRetrieveResponse.additionalProperties)
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is TripForVehicleRetrieveResponse && this.code == other.code && this.currentTime == other.currentTime && this.text == other.text && this.version == other.version && this.data == other.data && this.additionalProperties == other.additionalProperties /* spotless:on */
    }
