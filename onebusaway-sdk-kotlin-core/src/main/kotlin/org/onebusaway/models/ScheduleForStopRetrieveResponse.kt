...
@NoAutoDetect
class ScheduleForStopRetrieveResponse @JsonCreator private constructor(
    ...
    class Data @JsonCreator private constructor(
        ...
        class Entry @JsonCreator private constructor(
            @JsonProperty("date") @ExcludeMissing private val date: JsonField<Long> = JsonMissing.of(),
            @JsonProperty("stopId") @ExcludeMissing private val stopId: JsonField<String> = JsonMissing.of(),
            @JsonProperty("stopRouteSchedules") @ExcludeMissing private val stopRouteSchedules: JsonField<List<StopRouteSchedule>> = JsonMissing.of(),
            @JsonAnySetter private val additionalProperties: Map<String, JsonValue> = immutableEmptyMap(),
            ...
            @NoAutoDetect
            class StopRouteSchedule @JsonCreator private constructor(
                @JsonProperty("routeId") @ExcludeMissing private val routeId: JsonField<String> = JsonMissing.of(),
                @JsonProperty("stopRouteDirectionSchedules") @ExcludeMissing private val stopRouteDirectionSchedules: JsonField<List<StopRouteDirectionSchedule>> = JsonMissing.of(),
                @JsonAnySetter private val additionalProperties: Map<String, JsonValue> = immutableEmptyMap(),
                ...
                @NoAutoDetect
                class StopRouteDirectionSchedule @JsonCreator private constructor(
                    @JsonProperty("scheduleStopTimes") @ExcludeMissing private val scheduleStopTimes: JsonField<List<ScheduleStopTime>> = JsonMissing.of(),
                    @JsonProperty("tripHeadsign") @ExcludeMissing private val tripHeadsign: JsonField<String> = JsonMissing.of(),
                    @JsonProperty("scheduleFrequencies") @ExcludeMissing private val scheduleFrequencies: JsonField<List<ScheduleFrequency>> = JsonMissing.of(),
                    @JsonAnySetter private val additionalProperties: Map<String, JsonValue> = immutableEmptyMap(),
                    ...
                    @NoAutoDetect
                    class ScheduleStopTime @JsonCreator private constructor(
                    ...
                    @NoAutoDetect
                    class ScheduleFrequency @JsonCreator private constructor(
                        @JsonProperty("endTime") @ExcludeMissing private val endTime: JsonField<Long> = JsonMissing.of(),
                        @JsonProperty("headway") @ExcludeMissing private val headway: JsonField<Long> = JsonMissing.of(),
                        @JsonProperty("serviceDate") @ExcludeMissing private val serviceDate: JsonField<Long> = JsonMissing.of(),
                        @JsonProperty("serviceId") @ExcludeMissing private val serviceId: JsonField<String> = JsonMissing.of(),
                        @JsonProperty("startTime") @ExcludeMissing private val startTime: JsonField<Long> = JsonMissing.of(),
                        @JsonProperty("tripId") @ExcludeMissing private val tripId: JsonField<String> = JsonMissing.of(),
                        @JsonAnySetter private val additionalProperties: Map<String, JsonValue> = immutableEmptyMap(),
                        ...
                        class Builder internal constructor() {
                            ...
                            fun headway(headway: JsonField<Long>) =
                                apply {
