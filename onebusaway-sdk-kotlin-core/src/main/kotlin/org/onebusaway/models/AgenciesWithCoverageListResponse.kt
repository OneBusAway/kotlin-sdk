...
@NoAutoDetect
class AgenciesWithCoverageListResponse @JsonCreator private constructor(
    ...
    class Data @JsonCreator private constructor(
        ...
        class List @JsonCreator private constructor(
            ...
            @JsonProperty("latSpan") @ExcludeMissing private val latSpan: JsonField<Double> = JsonMissing.of(),
            @JsonProperty("lon") @ExcludeMissing private val lon: JsonField<Double> = JsonMissing.of(),
            @JsonProperty("lonSpan") @ExcludeMissing private val lonSpan: JsonField<Double> = JsonMissing.of(),
            @JsonAnySetter private val additionalProperties: Map<String, JsonValue> = immutableEmptyMap(),
