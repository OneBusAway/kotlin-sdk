...
@NoAutoDetect
class RoutesForAgencyListResponse @JsonCreator private constructor(
    ...
    class Data @JsonCreator private constructor(
        @JsonProperty("limitExceeded") @ExcludeMissing private val limitExceeded: JsonField<Boolean> = JsonMissing.of(),
        @JsonProperty("list") @ExcludeMissing private val list: JsonField<List<List>> = JsonMissing.of(),
        ...
        @JsonProperty("list")
        @ExcludeMissing
        fun _list(): JsonField<List<List>> = list
        ...
        class Builder internal constructor() {
            ...
            fun list(list: JsonField<List<List>>) =
                apply {
        ...
        @NoAutoDetect
        class List @JsonCreator private constructor(
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is RoutesForAgencyListResponse && code == other.code && currentTime == other.currentTime && text == other.text && version == other.version && data == other.data && additionalProperties == other.additionalProperties /* spotless:on */
    }
