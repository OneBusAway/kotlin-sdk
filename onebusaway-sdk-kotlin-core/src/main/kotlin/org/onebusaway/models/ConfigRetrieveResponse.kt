...
@NoAutoDetect
class ConfigRetrieveResponse @JsonCreator private constructor(
    ...
    class Data @JsonCreator private constructor(
        ...
        class Entry @JsonCreator private constructor(
            ...
            @JsonProperty("gitProperties") @ExcludeMissing private val gitProperties: JsonField<GitProperties> = JsonMissing.of(),
            @JsonProperty("name") @ExcludeMissing private val name: JsonField<String> = JsonMissing.of(),
            @JsonProperty("serviceDateFrom") @ExcludeMissing private val serviceDateFrom: JsonField<String> = JsonMissing.of(),
            @JsonProperty("serviceDateTo") @ExcludeMissing private val serviceDateTo: JsonField<String> = JsonMissing.of(),
            @JsonAnySetter private val additionalProperties: Map<String, JsonValue> = immutableEmptyMap(),
            ...
            @NoAutoDetect
            class GitProperties @JsonCreator private constructor(
                @JsonProperty("git.branch") @ExcludeMissing private val gitBranch: JsonField<String> = JsonMissing.of(),
                @JsonProperty("git.build.host") @ExcludeMissing private val gitBuildHost: JsonField<String> = JsonMissing.of(),
                @JsonProperty("git.build.time") @ExcludeMissing private val gitBuildTime: JsonField<String> = JsonMissing.of(),
                @JsonProperty("git.build.user.email") @ExcludeMissing private val gitBuildUserEmail: JsonField<String> = JsonMissing.of(),
                @JsonProperty("git.build.user.name") @ExcludeMissing private val gitBuildUserName: JsonField<String> = JsonMissing.of(),
                @JsonProperty("git.build.version") @ExcludeMissing private val gitBuildVersion: JsonField<String> = JsonMissing.of(),
                @JsonProperty("git.closest.tag.commit.count") @ExcludeMissing private val gitClosestTagCommitCount: JsonField<String> = JsonMissing.of(),
                @JsonProperty("git.closest.tag.name") @ExcludeMissing private val gitClosestTagName: JsonField<String> = JsonMissing.of(),
                @JsonProperty("git.commit.id") @ExcludeMissing private val gitCommitId: JsonField<String> = JsonMissing.of(),
                @JsonProperty("git.commit.id.abbrev") @ExcludeMissing private val gitCommitIdAbbrev: JsonField<String> = JsonMissing.of(),
                @JsonProperty("git.commit.id.describe") @ExcludeMissing private val gitCommitIdDescribe: JsonField<String> = JsonMissing.of(),
                @JsonProperty("git.commit.id.describe-short") @ExcludeMissing private val gitCommitIdDescribeShort: JsonField<String> = JsonMissing.of(),
                @JsonProperty("git.commit.message.full") @ExcludeMissing private val gitCommitMessageFull: JsonField<String> = JsonMissing.of(),
                @JsonProperty("git.commit.message.short") @ExcludeMissing private val gitCommitMessageShort: JsonField<String> = JsonMissing.of(),
                @JsonProperty("git.commit.time") @ExcludeMissing private val gitCommitTime: JsonField<String> = JsonMissing.of(),
                @JsonProperty("git.commit.user.email") @ExcludeMissing private val gitCommitUserEmail: JsonField<String> = JsonMissing.of(),
                @JsonProperty("git.commit.user.name") @ExcludeMissing private val gitCommitUserName: JsonField<String> = JsonMissing.of(),
                @JsonProperty("git.dirty") @ExcludeMissing private val gitDirty: JsonField<String> = JsonMissing.of(),
                @JsonProperty("git.remote.origin.url") @ExcludeMissing private val gitRemoteOriginUrl: JsonField<String> = JsonMissing.of(),
                @JsonProperty("git.tags") @ExcludeMissing private val gitTags: JsonField<String> = JsonMissing.of(),
                @JsonAnySetter private val additionalProperties: Map<String, JsonValue> = immutableEmptyMap(),
