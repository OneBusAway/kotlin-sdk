...
@NoAutoDetect
class StopsForRouteListResponse @JsonCreator private constructor(
    ...
    class Data @JsonCreator private constructor(
        ...
        class Entry @JsonCreator private constructor(
            @JsonProperty("polylines") @ExcludeMissing private val polylines: JsonField<List<Polyline>> = JsonMissing.of(),
            @JsonProperty("routeId") @ExcludeMissing private val routeId: JsonField<String> = JsonMissing.of(),
            @JsonProperty("stopGroupings") @ExcludeMissing private val stopGroupings: JsonField<List<StopGrouping>> = JsonMissing.of(),
            ...
            @NoAutoDetect
            class Polyline @JsonCreator private constructor(
            ...
            @NoAutoDetect
            class StopGrouping @JsonCreator private constructor(
                ...
                class Name @JsonCreator private constructor(
                    ...
                    @JsonProperty("names") @ExcludeMissing private val names: JsonField<List<String>> = JsonMissing.of(),
