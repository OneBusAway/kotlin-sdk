...
@NoAutoDetect
class BlockRetrieveResponse @JsonCreator private constructor(
    ...
    class Data @JsonCreator private constructor(
        ...
        class Entry @JsonCreator private constructor(
            ...
            @JsonProperty("configurations") @ExcludeMissing private val configurations: JsonField<List<Configuration>> = JsonMissing.of(),
            @JsonAnySetter private val additionalProperties: Map<String, JsonValue> = immutableEmptyMap(),
            ...
            class Configuration @JsonCreator private constructor(
                @JsonProperty("activeServiceIds") @ExcludeMissing private val activeServiceIds: JsonField<List<String>> = JsonMissing.of(),
                @JsonProperty("trips") @ExcludeMissing private val trips: JsonField<List<Trip>> = JsonMissing.of(),
                @JsonProperty("inactiveServiceIds") @ExcludeMissing private val inactiveServiceIds: JsonField<List<String>> = JsonMissing.of(),
                @JsonAnySetter private val additionalProperties: Map<String, JsonValue> = immutableEmptyMap(),
                ...
                class Trip @JsonCreator private constructor(
                    @JsonProperty("accumulatedSlackTime") @ExcludeMissing private val accumulatedSlackTime: JsonField<Double> = JsonMissing.of(),
                    @JsonProperty("blockStopTimes") @ExcludeMissing private val blockStopTimes: JsonField<List<BlockStopTime>> = JsonMissing.of(),
                    @JsonProperty("distanceAlongBlock") @ExcludeMissing private val distanceAlongBlock: JsonField<Double> = JsonMissing.of(),
                    ...
                    class Builder internal constructor() {
                        ...
                        fun distanceAlongBlock(distanceAlongBlock: JsonField<Double>) =
                            apply {
                    ...
                    @NoAutoDetect
                    class BlockStopTime @JsonCreator private constructor(
                        @JsonProperty("accumulatedSlackTime") @ExcludeMissing private val accumulatedSlackTime: JsonField<Double> = JsonMissing.of(),
                        @JsonProperty("blockSequence") @ExcludeMissing private val blockSequence: JsonField<Long> = JsonMissing.of(),
                        @JsonProperty("distanceAlongBlock") @ExcludeMissing private val distanceAlongBlock: JsonField<Double> = JsonMissing.of(),
                        @JsonProperty("stopTime") @ExcludeMissing private val stopTime: JsonField<StopTime> = JsonMissing.of(),
                        @JsonAnySetter private val additionalProperties: Map<String, JsonValue> = immutableEmptyMap(),
                        ...
                        class StopTime @JsonCreator private constructor(
                            ...
                            @JsonProperty("dropOffType") @ExcludeMissing private val dropOffType: JsonField<Long> = JsonMissing.of(),
                            @JsonProperty("pickupType") @ExcludeMissing private val pickupType: JsonField<Long> = JsonMissing.of(),
                            @JsonAnySetter private val additionalProperties: Map<String, JsonValue> = immutableEmptyMap(),
