...
/**
 * A client for interacting with the Onebusaway SDK REST API asynchronously. You
...
interface OnebusawaySdkClientAsync {
    ...
    /**
     * A view of [OnebusawaySdkClientAsync] that provides access to raw HTTP responses
     * for each method.
     */
