...
/**
 * A client for interacting with the Onebusaway SDK REST API synchronously. You can
...
interface OnebusawaySdkClient {
    ...
    /**
     * A view of [OnebusawaySdkClient] that provides access to raw HTTP responses for
     * each method.
     */
