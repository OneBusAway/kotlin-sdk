...
interface ReportProblemWithTripService {
    ...
    /**
     * A view of [ReportProblemWithTripService] that provides access to raw HTTP
    ...
    interface WithRawResponse {
         ...
         * same as [ReportProblemWithTripService.retrieve].
         */
        @MustBeClosed
        fun retrieve(params: ReportProblemWithTripRetrieveParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<ResponseWrapper>
    }
}
