...
class TripForVehicleServiceImpl internal constructor(private val clientOptions: ClientOptions) :
    ...
    override fun withOptions(modifier: (ClientOptions.Builder) -> Unit): TripForVehicleService =
        TripForVehicleServiceImpl(clientOptions.toBuilder().apply(modifier).build())
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        override fun retrieve(
            ...
            checkRequired("vehicleId", params.vehicleId())
            val request =
                HttpRequest.builder()
