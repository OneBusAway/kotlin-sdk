...
class StopsForRouteServiceImpl internal constructor(private val clientOptions: ClientOptions) :
    ...
    override fun withOptions(modifier: (ClientOptions.Builder) -> Unit): StopsForRouteService =
        StopsForRouteServiceImpl(clientOptions.toBuilder().apply(modifier).build())
