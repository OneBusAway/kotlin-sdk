...
class TripsForLocationListResponse @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(tripsForLocationListResponse: TripsForLocationListResponse) =
            apply {
     ...
     *   expected type.
     */
    fun validate(): TripsForLocationListResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    class Data @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
        ...
        private constructor(
            ...
            @JsonProperty("outOfRange") @ExcludeMissing outOfRange: JsonField<Boolean> = JsonMissing.of()
        ) : this(
          list,
          references,
          limitExceeded,
        ...
        class Builder internal constructor() {
             ...
             *
             * You should usually call [Builder.outOfRange] with a well-typed [Boolean] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun outOfRange(outOfRange: JsonField<Boolean>) =
                apply {
         ...
         * Used for best match union deserialization.
         */
        internal fun validity(): Int = (list.asKnown()?.sumOf { it.validity().toInt() } ?: 0) + (references.asKnown()?.validity() ?: 0) + (if (limitExceeded.asKnown() == null) 0 else 1) + (if (outOfRange.asKnown() == null) 0 else 1)
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is Data && list == other.list && references == other.references && limitExceeded == other.limitExceeded && outOfRange == other.outOfRange && additionalProperties == other.additionalProperties
        }

        private val hashCode: Int by lazy { Objects.hash(list, references, limitExceeded, outOfRange, additionalProperties) }

        override fun hashCode(): Int = hashCode

        override fun toString() = "Data{list=$list, references=$references, limitExceeded=$limitExceeded, outOfRange=$outOfRange, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is TripsForLocationListResponse && code == other.code && currentTime == other.currentTime && text == other.text && version == other.version && data == other.data && additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() = "TripsForLocationListResponse{code=$code, currentTime=$currentTime, text=$text, version=$version, data=$data, additionalProperties=$additionalProperties}"
}
