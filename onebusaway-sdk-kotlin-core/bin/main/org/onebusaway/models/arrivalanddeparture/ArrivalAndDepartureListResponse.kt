...
class ArrivalAndDepartureListResponse @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(arrivalAndDepartureListResponse: ArrivalAndDepartureListResponse) =
            apply {
                ...
                additionalProperties = arrivalAndDepartureListResponse.additionalProperties.toMutableMap()
            }
     ...
     *   expected type.
     */
    fun validate(): ArrivalAndDepartureListResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    class Data @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
        ...
        class Entry @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
            ...
            private constructor(
              ...
              arrivalsAndDepartures, mutableMapOf()
            )
             ...
             * Used for best match union deserialization.
             */
            internal fun validity(): Int = (arrivalsAndDepartures.asKnown()?.sumOf { it.validity().toInt() } ?: 0)
            ...
            override fun equals(other: Any?): Boolean {
              ...
              return other is Entry && arrivalsAndDepartures == other.arrivalsAndDepartures && additionalProperties == other.additionalProperties
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is ArrivalAndDepartureListResponse && code == other.code && currentTime == other.currentTime && text == other.text && version == other.version && data == other.data && additionalProperties == other.additionalProperties
    }
