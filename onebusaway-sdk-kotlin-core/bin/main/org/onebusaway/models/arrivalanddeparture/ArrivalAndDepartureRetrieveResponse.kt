...
class ArrivalAndDepartureRetrieveResponse @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ArrivalAndDepartureRetrieveResponse].
         *
    ...
    class Builder internal constructor() {
        ...
        internal fun from(arrivalAndDepartureRetrieveResponse: ArrivalAndDepartureRetrieveResponse) =
            apply {
                ...
                additionalProperties = arrivalAndDepartureRetrieveResponse.additionalProperties.toMutableMap()
            }
     ...
     *   expected type.
     */
    fun validate(): ArrivalAndDepartureRetrieveResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is ArrivalAndDepartureRetrieveResponse && code == other.code && currentTime == other.currentTime && text == other.text && version == other.version && data == other.data && additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() = "ArrivalAndDepartureRetrieveResponse{code=$code, currentTime=$currentTime, text=$text, version=$version, data=$data, additionalProperties=$additionalProperties}"
}
