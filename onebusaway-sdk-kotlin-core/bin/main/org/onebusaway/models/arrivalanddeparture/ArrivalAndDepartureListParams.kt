...
class ArrivalAndDepartureListParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(arrivalAndDepartureListParams: ArrivalAndDepartureListParams) =
            apply {
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is ArrivalAndDepartureListParams && stopId == other.stopId && minutesAfter == other.minutesAfter && minutesBefore == other.minutesBefore && time == other.time && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(stopId, minutesAfter, minutesBefore, time, additionalHeaders, additionalQueryParams)

    override fun toString() = "ArrivalAndDepartureListParams{stopId=$stopId, minutesAfter=$minutesAfter, minutesBefore=$minutesBefore, time=$time, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
