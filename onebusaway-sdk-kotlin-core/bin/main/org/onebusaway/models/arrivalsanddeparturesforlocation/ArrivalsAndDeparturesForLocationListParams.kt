...
class ArrivalsAndDeparturesForLocationListParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ArrivalsAndDeparturesForLocationListParams].
         *
    ...
    class Builder internal constructor() {
        ...
        internal fun from(arrivalsAndDeparturesForLocationListParams: ArrivalsAndDeparturesForLocationListParams) =
            apply {
                ...
                additionalHeaders = arrivalsAndDeparturesForLocationListParams.additionalHeaders.toBuilder()
                additionalQueryParams = arrivalsAndDeparturesForLocationListParams.additionalQueryParams.toBuilder()
            }
         ...
         */
        fun emptyReturnsNotFound(emptyReturnsNotFound: Boolean) = emptyReturnsNotFound(emptyReturnsNotFound as Boolean?)
        ...
        /** Include arrivals and departures this many minutes after the query time. */
        fun minutesAfter(minutesAfter: Long?) =
            apply {
        ...
        /** Include arrivals and departures this many minutes before the query time. */
        fun minutesBefore(minutesBefore: Long?) =
            apply {
        ...
        /** Optional list of GTFS routeTypes to filter by (comma delimited) e.g. "1,2,3". */
        fun routeType(routeType: String?) =
            apply {
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is ArrivalsAndDeparturesForLocationListParams && lat == other.lat && lon == other.lon && emptyReturnsNotFound == other.emptyReturnsNotFound && latSpan == other.latSpan && lonSpan == other.lonSpan && maxCount == other.maxCount && minutesAfter == other.minutesAfter && minutesBefore == other.minutesBefore && radius == other.radius && routeType == other.routeType && time == other.time && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(lat, lon, emptyReturnsNotFound, latSpan, lonSpan, maxCount, minutesAfter, minutesBefore, radius, routeType, time, additionalHeaders, additionalQueryParams)

    override fun toString() = "ArrivalsAndDeparturesForLocationListParams{lat=$lat, lon=$lon, emptyReturnsNotFound=$emptyReturnsNotFound, latSpan=$latSpan, lonSpan=$lonSpan, maxCount=$maxCount, minutesAfter=$minutesAfter, minutesBefore=$minutesBefore, radius=$radius, routeType=$routeType, time=$time, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
