...
class ArrivalsAndDeparturesForLocationListResponse @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    ...
    private constructor(
        ...
        @JsonProperty("currentTime") @ExcludeMissing currentTime: JsonField<Long> = JsonMissing.of(),
    ...
    /** @throws OnebusawaySdkInvalidDataException if the JSON field has an unexpected type or is unexpectedly missing or null (e.g. if the server responded with an unexpected value). */
    ...
    class Builder internal constructor() {
        ...
        internal fun from(arrivalsAndDeparturesForLocationListResponse: ArrivalsAndDeparturesForLocationListResponse) =
            apply {
                ...
                additionalProperties = arrivalsAndDeparturesForLocationListResponse.additionalProperties.toMutableMap()
            }
         ...
         *
         * You should usually call [Builder.code] with a well-typed [Long] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
         ...
         *
         * You should usually call [Builder.currentTime] with a well-typed [Long] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
     ...
     *   expected type.
     */
    fun validate(): ArrivalsAndDeparturesForLocationListResponse =
        apply {
            if (validated) {
              return@apply
            }
     ...
     */
    internal fun validity(): Int = (if (code.asKnown() == null) 0 else 1) + (if (currentTime.asKnown() == null) 0 else 1) + (if (text.asKnown() == null) 0 else 1) + (if (version.asKnown() == null) 0 else 1) + (data.asKnown()?.validity() ?: 0)
    ...
    class Data @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
        ...
        private constructor(
            ...
            @JsonProperty("references") @ExcludeMissing references: JsonField<References> = JsonMissing.of()
        ) : this(
          entry,
          references,
          mutableMapOf(),
        ...
        class Builder internal constructor() {
             ...
             *
             * You should usually call [Builder.entry] with a well-typed [Entry] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
             ...
             *
             * You should usually call [Builder.references] with a well-typed [References] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
         ...
         * Used for best match union deserialization.
         */
        internal fun validity(): Int = (entry.asKnown()?.validity() ?: 0) + (references.asKnown()?.validity() ?: 0)

        class Entry @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
            private val arrivalsAndDepartures: JsonField<List<ArrivalsAndDeparture>>,
            private val limitExceeded: JsonField<Boolean>,
            private val nearbyStopIds: JsonField<List<NearbyStopId>>,
            ...
            @JsonCreator
            private constructor(
                @JsonProperty("arrivalsAndDepartures") @ExcludeMissing arrivalsAndDepartures: JsonField<List<ArrivalsAndDeparture>> = JsonMissing.of(),
                @JsonProperty("limitExceeded") @ExcludeMissing limitExceeded: JsonField<Boolean> = JsonMissing.of(),
                @JsonProperty("nearbyStopIds") @ExcludeMissing nearbyStopIds: JsonField<List<NearbyStopId>> = JsonMissing.of(),
                @JsonProperty("stopIds") @ExcludeMissing stopIds: JsonField<List<String>> = JsonMissing.of(),
                @JsonProperty("situationIds") @ExcludeMissing situationIds: JsonField<List<String>> = JsonMissing.of()
            ) : this(
            ...
            /** @throws OnebusawaySdkInvalidDataException if the JSON field has an unexpected type or is unexpectedly missing or null (e.g. if the server responded with an unexpected value). */
            fun nearbyStopIds(): List<NearbyStopId> = nearbyStopIds.getRequired("nearbyStopIds")

            /** @throws OnebusawaySdkInvalidDataException if the JSON field has an unexpected type or is unexpectedly missing or null (e.g. if the server responded with an unexpected value). */
            fun stopIds(): List<String> = stopIds.getRequired("stopIds")

            /** @throws OnebusawaySdkInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value). */
            fun situationIds(): List<String>? = situationIds.getNullable("situationIds")

            /**
             * Returns the raw JSON value of [arrivalsAndDepartures].
             *
             * Unlike [arrivalsAndDepartures], this method doesn't throw if the JSON field has an unexpected type.
             */
            @JsonProperty("arrivalsAndDepartures")
            @ExcludeMissing
            fun _arrivalsAndDepartures(): JsonField<List<ArrivalsAndDeparture>> = arrivalsAndDepartures
             ...
             *
             * Unlike [nearbyStopIds], this method doesn't throw if the JSON field has an unexpected type.
             */
            @JsonProperty("nearbyStopIds")
            @ExcludeMissing
            fun _nearbyStopIds(): JsonField<List<NearbyStopId>> = nearbyStopIds
             ...
             *
             * Unlike [situationIds], this method doesn't throw if the JSON field has an unexpected type.
             */
            ...
            class Builder internal constructor() {
                ...
                private var arrivalsAndDepartures: JsonField<MutableList<ArrivalsAndDeparture>>? = null
                private var limitExceeded: JsonField<Boolean>? = null
                private var nearbyStopIds: JsonField<MutableList<NearbyStopId>>? = null
                 ...
                 *
                 * You should usually call [Builder.arrivalsAndDepartures] with a well-typed `List<ArrivalsAndDeparture>` value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun arrivalsAndDepartures(arrivalsAndDepartures: JsonField<List<ArrivalsAndDeparture>>) =
                    apply {
                 ...
                 */
                fun addArrivalsAndDeparture(arrivalsAndDeparture: ArrivalsAndDeparture) =
                    apply {
                        arrivalsAndDepartures = (arrivalsAndDepartures ?: JsonField.of(mutableListOf())).also {
                 ...
                 *
                 * You should usually call [Builder.limitExceeded] with a well-typed [Boolean] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun limitExceeded(limitExceeded: JsonField<Boolean>) =
                    apply {
                        this.limitExceeded = limitExceeded
                    }

                fun nearbyStopIds(nearbyStopIds: List<NearbyStopId>) = nearbyStopIds(JsonField.of(nearbyStopIds))

                /**
                 * Sets [Builder.nearbyStopIds] to an arbitrary JSON value.
                 *
                 * You should usually call [Builder.nearbyStopIds] with a well-typed `List<NearbyStopId>` value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun nearbyStopIds(nearbyStopIds: JsonField<List<NearbyStopId>>) =
                    apply {
                 ...
                 * @throws IllegalStateException if the field was previously set to a non-list.
                 */
                fun addNearbyStopId(nearbyStopId: NearbyStopId) =
                    apply {
                        nearbyStopIds = (nearbyStopIds ?: JsonField.of(mutableListOf())).also {
                 ...
                 *
                 * You should usually call [Builder.stopIds] with a well-typed `List<String>` value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                 ...
                 *
                 * You should usually call [Builder.situationIds] with a well-typed `List<String>` value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
             ...
             * Used for best match union deserialization.
             */
            internal fun validity(): Int = (arrivalsAndDepartures.asKnown()?.sumOf { it.validity().toInt() } ?: 0) + (if (limitExceeded.asKnown() == null) 0 else 1) + (nearbyStopIds.asKnown()?.sumOf { it.validity().toInt() } ?: 0) + (stopIds.asKnown()?.size ?: 0) + (situationIds.asKnown()?.size ?: 0)

            class ArrivalsAndDeparture @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
                ...
                @JsonCreator
                private constructor(
                    @JsonProperty("arrivalEnabled") @ExcludeMissing arrivalEnabled: JsonField<Boolean> = JsonMissing.of(),
                    @JsonProperty("blockTripSequence") @ExcludeMissing blockTripSequence: JsonField<Long> = JsonMissing.of(),
                    @JsonProperty("departureEnabled") @ExcludeMissing departureEnabled: JsonField<Boolean> = JsonMissing.of(),
                    @JsonProperty("numberOfStopsAway") @ExcludeMissing numberOfStopsAway: JsonField<Long> = JsonMissing.of(),
                    @JsonProperty("predictedArrivalTime") @ExcludeMissing predictedArrivalTime: JsonField<Long> = JsonMissing.of(),
                    @JsonProperty("predictedDepartureTime") @ExcludeMissing predictedDepartureTime: JsonField<Long> = JsonMissing.of(),
                    @JsonProperty("routeId") @ExcludeMissing routeId: JsonField<String> = JsonMissing.of(),
                    @JsonProperty("scheduledArrivalTime") @ExcludeMissing scheduledArrivalTime: JsonField<Long> = JsonMissing.of(),
                    @JsonProperty("scheduledDepartureTime") @ExcludeMissing scheduledDepartureTime: JsonField<Long> = JsonMissing.of(),
                    @JsonProperty("serviceDate") @ExcludeMissing serviceDate: JsonField<Long> = JsonMissing.of(),
                    @JsonProperty("stopId") @ExcludeMissing stopId: JsonField<String> = JsonMissing.of(),
                    @JsonProperty("stopSequence") @ExcludeMissing stopSequence: JsonField<Long> = JsonMissing.of(),
                    @JsonProperty("totalStopsInTrip") @ExcludeMissing totalStopsInTrip: JsonField<Long> = JsonMissing.of(),
                    @JsonProperty("tripHeadsign") @ExcludeMissing tripHeadsign: JsonField<String> = JsonMissing.of(),
                    @JsonProperty("tripId") @ExcludeMissing tripId: JsonField<String> = JsonMissing.of(),
                    @JsonProperty("vehicleId") @ExcludeMissing vehicleId: JsonField<String> = JsonMissing.of(),
                    @JsonProperty("actualTrack") @ExcludeMissing actualTrack: JsonField<String> = JsonMissing.of(),
                    @JsonProperty("distanceFromStop") @ExcludeMissing distanceFromStop: JsonField<Double> = JsonMissing.of(),
                    @JsonProperty("frequency") @ExcludeMissing frequency: JsonField<String> = JsonMissing.of(),
                    @JsonProperty("historicalOccupancy") @ExcludeMissing historicalOccupancy: JsonField<String> = JsonMissing.of(),
                    @JsonProperty("lastUpdateTime") @ExcludeMissing lastUpdateTime: JsonField<Long> = JsonMissing.of(),
                    @JsonProperty("occupancyStatus") @ExcludeMissing occupancyStatus: JsonField<String> = JsonMissing.of(),
                    @JsonProperty("predicted") @ExcludeMissing predicted: JsonField<Boolean> = JsonMissing.of(),
                    @JsonProperty("predictedArrivalInterval") @ExcludeMissing predictedArrivalInterval: JsonField<String> = JsonMissing.of(),
                    @JsonProperty("predictedDepartureInterval") @ExcludeMissing predictedDepartureInterval: JsonField<String> = JsonMissing.of(),
                    @JsonProperty("predictedOccupancy") @ExcludeMissing predictedOccupancy: JsonField<String> = JsonMissing.of(),
                    @JsonProperty("routeLongName") @ExcludeMissing routeLongName: JsonField<String> = JsonMissing.of(),
                    @JsonProperty("routeShortName") @ExcludeMissing routeShortName: JsonField<String> = JsonMissing.of(),
                    @JsonProperty("scheduledArrivalInterval") @ExcludeMissing scheduledArrivalInterval: JsonField<String> = JsonMissing.of(),
                    @JsonProperty("scheduledDepartureInterval") @ExcludeMissing scheduledDepartureInterval: JsonField<String> = JsonMissing.of(),
                    @JsonProperty("scheduledTrack") @ExcludeMissing scheduledTrack: JsonField<String> = JsonMissing.of(),
                    @JsonProperty("situationIds") @ExcludeMissing situationIds: JsonField<List<String>> = JsonMissing.of(),
                    @JsonProperty("status") @ExcludeMissing status: JsonField<String> = JsonMissing.of(),
                    @JsonProperty("tripStatus") @ExcludeMissing tripStatus: JsonField<TripStatus> = JsonMissing.of()
                ) : this(
                  arrivalEnabled,
                  blockTripSequence,
                  departureEnabled,
                 ...
                 * @throws OnebusawaySdkInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
                 */
                fun predictedArrivalInterval(): String? = predictedArrivalInterval.getNullable("predictedArrivalInterval")
                 ...
                 * @throws OnebusawaySdkInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
                 */
                fun predictedDepartureInterval(): String? = predictedDepartureInterval.getNullable("predictedDepartureInterval")
                 ...
                 * @throws OnebusawaySdkInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
                 */
                fun predictedOccupancy(): String? = predictedOccupancy.getNullable("predictedOccupancy")
                 ...
                 * @throws OnebusawaySdkInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
                 */
                fun scheduledArrivalInterval(): String? = scheduledArrivalInterval.getNullable("scheduledArrivalInterval")
                 ...
                 * @throws OnebusawaySdkInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
                 */
                fun scheduledDepartureInterval(): String? = scheduledDepartureInterval.getNullable("scheduledDepartureInterval")
                 ...
                 *
                 * Unlike [arrivalEnabled], this method doesn't throw if the JSON field has an unexpected type.
                 */
                 ...
                 *
                 * Unlike [blockTripSequence], this method doesn't throw if the JSON field has an unexpected type.
                 */
                 ...
                 *
                 * Unlike [departureEnabled], this method doesn't throw if the JSON field has an unexpected type.
                 */
                 ...
                 *
                 * Unlike [numberOfStopsAway], this method doesn't throw if the JSON field has an unexpected type.
                 */
                 ...
                 *
                 * Unlike [predictedArrivalTime], this method doesn't throw if the JSON field has an unexpected type.
                 */
                 ...
                 *
                 * Unlike [predictedDepartureTime], this method doesn't throw if the JSON field has an unexpected type.
                 */
                 ...
                 *
                 * Unlike [scheduledArrivalTime], this method doesn't throw if the JSON field has an unexpected type.
                 */
                 ...
                 *
                 * Unlike [scheduledDepartureTime], this method doesn't throw if the JSON field has an unexpected type.
                 */
                 ...
                 *
                 * Unlike [serviceDate], this method doesn't throw if the JSON field has an unexpected type.
                 */
                 ...
                 *
                 * Unlike [totalStopsInTrip], this method doesn't throw if the JSON field has an unexpected type.
                 */
                 ...
                 *
                 * Unlike [tripHeadsign], this method doesn't throw if the JSON field has an unexpected type.
                 */
                 ...
                 *
                 * Unlike [actualTrack], this method doesn't throw if the JSON field has an unexpected type.
                 */
                 ...
                 *
                 * Unlike [distanceFromStop], this method doesn't throw if the JSON field has an unexpected type.
                 */
                 ...
                 *
                 * Unlike [historicalOccupancy], this method doesn't throw if the JSON field has an unexpected type.
                 */
                 ...
                 *
                 * Unlike [lastUpdateTime], this method doesn't throw if the JSON field has an unexpected type.
                 */
                 ...
                 *
                 * Unlike [occupancyStatus], this method doesn't throw if the JSON field has an unexpected type.
                 */
                 ...
                 *
                 * Unlike [predicted], this method doesn't throw if the JSON field has an unexpected type.
                 */
                 ...
                 *
                 * Unlike [predictedArrivalInterval], this method doesn't throw if the JSON field has an unexpected type.
                 */
                 ...
                 *
                 * Unlike [predictedDepartureInterval], this method doesn't throw if the JSON field has an unexpected type.
                 */
                 ...
                 *
                 * Unlike [predictedOccupancy], this method doesn't throw if the JSON field has an unexpected type.
                 */
                 ...
                 *
                 * Unlike [routeLongName], this method doesn't throw if the JSON field has an unexpected type.
                 */
                 ...
                 *
                 * Unlike [routeShortName], this method doesn't throw if the JSON field has an unexpected type.
                 */
                 ...
                 *
                 * Unlike [scheduledArrivalInterval], this method doesn't throw if the JSON field has an unexpected type.
                 */
                 ...
                 *
                 * Unlike [scheduledDepartureInterval], this method doesn't throw if the JSON field has an unexpected type.
                 */
                 ...
                 *
                 * Unlike [scheduledTrack], this method doesn't throw if the JSON field has an unexpected type.
                 */
                 ...
                 *
                 * Unlike [tripStatus], this method doesn't throw if the JSON field has an unexpected type.
                 */
                ...
                companion object {
                    ...
                    /**
                     * Returns a mutable builder for constructing an instance of [ArrivalsAndDeparture].
                     *
                     * The following fields are required:
                     *
                     * ```kotlin
                ...
                class Builder internal constructor() {
                    ...
                    internal fun from(arrivalsAndDeparture: ArrivalsAndDeparture) =
                        apply {
                            ...
                            additionalProperties = arrivalsAndDeparture.additionalProperties.toMutableMap()
                        }
                     ...
                     *
                     * You should usually call [Builder.arrivalEnabled] with a well-typed [Boolean] value instead. This method is primarily for setting the field to an undocumented or not yet
                     * supported value.
                     */
                     ...
                     *
                     * You should usually call [Builder.blockTripSequence] with a well-typed [Long] value instead. This method is primarily for setting the field to an undocumented or not yet
                     * supported value.
                     */
                     ...
                     *
                     * You should usually call [Builder.departureEnabled] with a well-typed [Boolean] value instead. This method is primarily for setting the field to an undocumented or not yet
                     * supported value.
                     */
                     ...
                     *
                     * You should usually call [Builder.numberOfStopsAway] with a well-typed [Long] value instead. This method is primarily for setting the field to an undocumented or not yet
                     * supported value.
                     */
                    fun numberOfStopsAway(numberOfStopsAway: JsonField<Long>) =
                        apply {
                     ...
                     *
                     * You should usually call [Builder.predictedArrivalTime] with a well-typed [Long] value instead. This method is primarily for setting the field to an undocumented or not yet
                     * supported value.
                     */
                    fun predictedArrivalTime(predictedArrivalTime: JsonField<Long>) =
                        apply {
                     ...
                     *
                     * You should usually call [Builder.predictedDepartureTime] with a well-typed [Long] value instead. This method is primarily for setting the field to an undocumented or not yet
                     * supported value.
                     */
                    fun predictedDepartureTime(predictedDepartureTime: JsonField<Long>) =
                        apply {
                     ...
                     *
                     * You should usually call [Builder.routeId] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
                     * supported value.
                     */
                     ...
                     *
                     * You should usually call [Builder.scheduledArrivalTime] with a well-typed [Long] value instead. This method is primarily for setting the field to an undocumented or not yet
                     * supported value.
                     */
                    fun scheduledArrivalTime(scheduledArrivalTime: JsonField<Long>) =
                        apply {
                     ...
                     *
                     * You should usually call [Builder.scheduledDepartureTime] with a well-typed [Long] value instead. This method is primarily for setting the field to an undocumented or not yet
                     * supported value.
                     */
                    fun scheduledDepartureTime(scheduledDepartureTime: JsonField<Long>) =
                        apply {
                     ...
                     *
                     * You should usually call [Builder.serviceDate] with a well-typed [Long] value instead. This method is primarily for setting the field to an undocumented or not yet
                     * supported value.
                     */
                     ...
                     *
                     * You should usually call [Builder.stopId] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
                     * supported value.
                     */
                     ...
                     *
                     * You should usually call [Builder.stopSequence] with a well-typed [Long] value instead. This method is primarily for setting the field to an undocumented or not yet
                     * supported value.
                     */
                    fun stopSequence(stopSequence: JsonField<Long>) =
                        apply {
                     ...
                     *
                     * You should usually call [Builder.totalStopsInTrip] with a well-typed [Long] value instead. This method is primarily for setting the field to an undocumented or not yet
                     * supported value.
                     */
                    fun totalStopsInTrip(totalStopsInTrip: JsonField<Long>) =
                        apply {
                     ...
                     *
                     * You should usually call [Builder.tripHeadsign] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
                     * supported value.
                     */
                     ...
                     *
                     * You should usually call [Builder.tripId] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
                     * supported value.
                     */
                     ...
                     *
                     * You should usually call [Builder.vehicleId] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
                     * supported value.
                     */
                     ...
                     *
                     * You should usually call [Builder.actualTrack] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
                     * supported value.
                     */
                    fun actualTrack(actualTrack: JsonField<String>) =
                        apply {
                     ...
                     *
                     * You should usually call [Builder.distanceFromStop] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
                     * supported value.
                     */
                    fun distanceFromStop(distanceFromStop: JsonField<Double>) =
                        apply {
                     ...
                     *
                     * You should usually call [Builder.frequency] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
                     * supported value.
                     */
                     ...
                     *
                     * You should usually call [Builder.historicalOccupancy] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
                     * supported value.
                     */
                     ...
                     *
                     * You should usually call [Builder.lastUpdateTime] with a well-typed [Long] value instead. This method is primarily for setting the field to an undocumented or not yet
                     * supported value.
                     */
                     ...
                     *
                     * You should usually call [Builder.occupancyStatus] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
                     * supported value.
                     */
                     ...
                     *
                     * You should usually call [Builder.predicted] with a well-typed [Boolean] value instead. This method is primarily for setting the field to an undocumented or not yet
                     * supported value.
                     */
                    ...
                    /** Interval for predicted arrival time, if available. */
                    fun predictedArrivalInterval(predictedArrivalInterval: String?) = predictedArrivalInterval(JsonField.ofNullable(predictedArrivalInterval))

                    /**
                     * Sets [Builder.predictedArrivalInterval] to an arbitrary JSON value.
                     *
                     * You should usually call [Builder.predictedArrivalInterval] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
                     * supported value.
                     */
                    ...
                    /** Interval for predicted departure time, if available. */
                    fun predictedDepartureInterval(predictedDepartureInterval: String?) = predictedDepartureInterval(JsonField.ofNullable(predictedDepartureInterval))

                    /**
                     * Sets [Builder.predictedDepartureInterval] to an arbitrary JSON value.
                     *
                     * You should usually call [Builder.predictedDepartureInterval] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
                     * supported value.
                     */
                     ...
                     *
                     * You should usually call [Builder.predictedOccupancy] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
                     * supported value.
                     */
                    fun predictedOccupancy(predictedOccupancy: JsonField<String>) =
                        apply {
                     ...
                     *
                     * You should usually call [Builder.routeLongName] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
                     * supported value.
                     */
                    fun routeLongName(routeLongName: JsonField<String>) =
                        apply {
                     ...
                     *
                     * You should usually call [Builder.routeShortName] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
                     * supported value.
                     */
                    ...
                    /** Interval for scheduled arrival time. */
                    fun scheduledArrivalInterval(scheduledArrivalInterval: String?) = scheduledArrivalInterval(JsonField.ofNullable(scheduledArrivalInterval))

                    /**
                     * Sets [Builder.scheduledArrivalInterval] to an arbitrary JSON value.
                     *
                     * You should usually call [Builder.scheduledArrivalInterval] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
                     * supported value.
                     */
                    ...
                    /** Interval for scheduled departure time. */
                    fun scheduledDepartureInterval(scheduledDepartureInterval: String?) = scheduledDepartureInterval(JsonField.ofNullable(scheduledDepartureInterval))

                    /**
                     * Sets [Builder.scheduledDepartureInterval] to an arbitrary JSON value.
                     *
                     * You should usually call [Builder.scheduledDepartureInterval] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
                     * supported value.
                     */
                     ...
                     *
                     * You should usually call [Builder.scheduledTrack] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
                     * supported value.
                     */
                    fun scheduledTrack(scheduledTrack: JsonField<String>) =
                        apply {
                     ...
                     *
                     * You should usually call [Builder.tripStatus] with a well-typed [TripStatus] value instead. This method is primarily for setting the field to an undocumented or not yet
                     * supported value.
                     */
                    fun tripStatus(tripStatus: JsonField<TripStatus>) =
                        apply {
                 ...
                 *   expected type.
                 */
                fun validate(): ArrivalsAndDeparture =
                    apply {
                        if (validated) {
                          return@apply
                        }
                 ...
                 * Used for best match union deserialization.
                 */
                internal fun validity(): Int = (if (arrivalEnabled.asKnown() == null) 0 else 1) + (if (blockTripSequence.asKnown() == null) 0 else 1) + (if (departureEnabled.asKnown() == null) 0 else 1) + (if (numberOfStopsAway.asKnown() == null) 0 else 1) + (if (predictedArrivalTime.asKnown() == null) 0 else 1) + (if (predictedDepartureTime.asKnown() == null) 0 else 1) + (if (routeId.asKnown() == null) 0 else 1) + (if (scheduledArrivalTime.asKnown() == null) 0 else 1) + (if (scheduledDepartureTime.asKnown() == null) 0 else 1) + (if (serviceDate.asKnown() == null) 0 else 1) + (if (stopId.asKnown() == null) 0 else 1) + (if (stopSequence.asKnown() == null) 0 else 1) + (if (totalStopsInTrip.asKnown() == null) 0 else 1) + (if (tripHeadsign.asKnown() == null) 0 else 1) + (if (tripId.asKnown() == null) 0 else 1) + (if (vehicleId.asKnown() == null) 0 else 1) + (if (actualTrack.asKnown() == null) 0 else 1) + (if (distanceFromStop.asKnown() == null) 0 else 1) + (if (frequency.asKnown() == null) 0 else 1) + (if (historicalOccupancy.asKnown() == null) 0 else 1) + (if (lastUpdateTime.asKnown() == null) 0 else 1) + (if (occupancyStatus.asKnown() == null) 0 else 1) + (if (predicted.asKnown() == null) 0 else 1) + (if (predictedArrivalInterval.asKnown() == null) 0 else 1) + (if (predictedDepartureInterval.asKnown() == null) 0 else 1) + (if (predictedOccupancy.asKnown() == null) 0 else 1) + (if (routeLongName.asKnown() == null) 0 else 1) + (if (routeShortName.asKnown() == null) 0 else 1) + (if (scheduledArrivalInterval.asKnown() == null) 0 else 1) + (if (scheduledDepartureInterval.asKnown() == null) 0 else 1) + (if (scheduledTrack.asKnown() == null) 0 else 1) + (situationIds.asKnown()?.size ?: 0) + (if (status.asKnown() == null) 0 else 1) + (tripStatus.asKnown()?.validity() ?: 0)

                /** Trip-specific status for the arriving transit vehicle. */
                class TripStatus @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
                    ...
                    @JsonCreator
                    private constructor(
                        @JsonProperty("activeTripId") @ExcludeMissing activeTripId: JsonField<String> = JsonMissing.of(),
                        @JsonProperty("blockTripSequence") @ExcludeMissing blockTripSequence: JsonField<Long> = JsonMissing.of(),
                        @JsonProperty("closestStop") @ExcludeMissing closestStop: JsonField<String> = JsonMissing.of(),
                        @JsonProperty("distanceAlongTrip") @ExcludeMissing distanceAlongTrip: JsonField<Double> = JsonMissing.of(),
                        @JsonProperty("lastKnownDistanceAlongTrip") @ExcludeMissing lastKnownDistanceAlongTrip: JsonField<Double> = JsonMissing.of(),
                        @JsonProperty("lastLocationUpdateTime") @ExcludeMissing lastLocationUpdateTime: JsonField<Long> = JsonMissing.of(),
                        @JsonProperty("lastUpdateTime") @ExcludeMissing lastUpdateTime: JsonField<Long> = JsonMissing.of(),
                        @JsonProperty("occupancyCapacity") @ExcludeMissing occupancyCapacity: JsonField<Long> = JsonMissing.of(),
                        @JsonProperty("occupancyCount") @ExcludeMissing occupancyCount: JsonField<Long> = JsonMissing.of(),
                        @JsonProperty("occupancyStatus") @ExcludeMissing occupancyStatus: JsonField<String> = JsonMissing.of(),
                        @JsonProperty("phase") @ExcludeMissing phase: JsonField<String> = JsonMissing.of(),
                        @JsonProperty("predicted") @ExcludeMissing predicted: JsonField<Boolean> = JsonMissing.of(),
                        @JsonProperty("scheduleDeviation") @ExcludeMissing scheduleDeviation: JsonField<Long> = JsonMissing.of(),
                        @JsonProperty("serviceDate") @ExcludeMissing serviceDate: JsonField<Long> = JsonMissing.of(),
                        @JsonProperty("status") @ExcludeMissing status: JsonField<String> = JsonMissing.of(),
                        @JsonProperty("totalDistanceAlongTrip") @ExcludeMissing totalDistanceAlongTrip: JsonField<Double> = JsonMissing.of(),
                        @JsonProperty("closestStopTimeOffset") @ExcludeMissing closestStopTimeOffset: JsonField<Long> = JsonMissing.of(),
                        @JsonProperty("frequency") @ExcludeMissing frequency: JsonField<String> = JsonMissing.of(),
                        @JsonProperty("lastKnownLocation") @ExcludeMissing lastKnownLocation: JsonField<LastKnownLocation> = JsonMissing.of(),
                        @JsonProperty("lastKnownOrientation") @ExcludeMissing lastKnownOrientation: JsonField<Double> = JsonMissing.of(),
                        @JsonProperty("nextStop") @ExcludeMissing nextStop: JsonField<String> = JsonMissing.of(),
                        @JsonProperty("nextStopTimeOffset") @ExcludeMissing nextStopTimeOffset: JsonField<Long> = JsonMissing.of(),
                        ...
                        @JsonProperty("scheduledDistanceAlongTrip") @ExcludeMissing scheduledDistanceAlongTrip: JsonField<Double> = JsonMissing.of(),
                        @JsonProperty("situationIds") @ExcludeMissing situationIds: JsonField<List<String>> = JsonMissing.of(),
                        @JsonProperty("vehicleId") @ExcludeMissing vehicleId: JsonField<String> = JsonMissing.of()
                    ) : this(
                      activeTripId,
                     ...
                     *
                     * Unlike [activeTripId], this method doesn't throw if the JSON field has an unexpected type.
                     */
                     ...
                     *
                     * Unlike [closestStop], this method doesn't throw if the JSON field has an unexpected type.
                     */
                     ...
                     *
                     * Unlike [distanceAlongTrip], this method doesn't throw if the JSON field has an unexpected type.
                     */
                     ...
                     *
                     * Unlike [lastKnownDistanceAlongTrip], this method doesn't throw if the JSON field has an unexpected type.
                     */
                     ...
                     *
                     * Unlike [lastLocationUpdateTime], this method doesn't throw if the JSON field has an unexpected type.
                     */
                     ...
                     *
                     * Unlike [occupancyCapacity], this method doesn't throw if the JSON field has an unexpected type.
                     */
                     ...
                     *
                     * Unlike [occupancyCount], this method doesn't throw if the JSON field has an unexpected type.
                     */
                     ...
                     *
                     * Unlike [scheduleDeviation], this method doesn't throw if the JSON field has an unexpected type.
                     */
                     ...
                     *
                     * Unlike [totalDistanceAlongTrip], this method doesn't throw if the JSON field has an unexpected type.
                     */
                     ...
                     *
                     * Unlike [closestStopTimeOffset], this method doesn't throw if the JSON field has an unexpected type.
                     */
                     ...
                     *
                     * Unlike [lastKnownLocation], this method doesn't throw if the JSON field has an unexpected type.
                     */
                     ...
                     *
                     * Unlike [lastKnownOrientation], this method doesn't throw if the JSON field has an unexpected type.
                     */
                     ...
                     *
                     * Unlike [nextStop], this method doesn't throw if the JSON field has an unexpected type.
                     */
                     ...
                     *
                     * Unlike [nextStopTimeOffset], this method doesn't throw if the JSON field has an unexpected type.
                     */
                     ...
                     *
                     * Unlike [scheduledDistanceAlongTrip], this method doesn't throw if the JSON field has an unexpected type.
                     */
                    ...
                    class Builder internal constructor() {
                        ...
                        internal fun from(tripStatus: TripStatus) =
                            apply {
                         ...
                         *
                         * You should usually call [Builder.activeTripId] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
                         * supported value.
                         */
                         ...
                         *
                         * You should usually call [Builder.closestStop] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
                         * supported value.
                         */
                         ...
                         *
                         * You should usually call [Builder.distanceAlongTrip] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
                         * supported value.
                         */
                         ...
                         *
                         * You should usually call [Builder.lastKnownDistanceAlongTrip] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
                         * supported value.
                         */
                         ...
                         *
                         * You should usually call [Builder.lastLocationUpdateTime] with a well-typed [Long] value instead. This method is primarily for setting the field to an undocumented or not yet
                         * supported value.
                         */
                         ...
                         *
                         * You should usually call [Builder.occupancyCapacity] with a well-typed [Long] value instead. This method is primarily for setting the field to an undocumented or not yet
                         * supported value.
                         */
                         ...
                         *
                         * You should usually call [Builder.occupancyCount] with a well-typed [Long] value instead. This method is primarily for setting the field to an undocumented or not yet
                         * supported value.
                         */
                         ...
                         *
                         * You should usually call [Builder.phase] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
                         * supported value.
                         */
                         ...
                         *
                         * You should usually call [Builder.scheduleDeviation] with a well-typed [Long] value instead. This method is primarily for setting the field to an undocumented or not yet
                         * supported value.
                         */
                         ...
                         *
                         * You should usually call [Builder.totalDistanceAlongTrip] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
                         * supported value.
                         */
                         ...
                         *
                         * You should usually call [Builder.closestStopTimeOffset] with a well-typed [Long] value instead. This method is primarily for setting the field to an undocumented or not yet
                         * supported value.
                         */
                        ...
                        /** Last known location of the transit vehicle (optional). */
                        fun lastKnownLocation(lastKnownLocation: LastKnownLocation?) = lastKnownLocation(JsonField.ofNullable(lastKnownLocation))

                        /**
                         * Sets [Builder.lastKnownLocation] to an arbitrary JSON value.
                         *
                         * You should usually call [Builder.lastKnownLocation] with a well-typed [LastKnownLocation] value instead. This method is primarily for setting the field to an undocumented or not yet
                         * supported value.
                         */
                         ...
                         *
                         * You should usually call [Builder.lastKnownOrientation] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
                         * supported value.
                         */
                         ...
                         *
                         * You should usually call [Builder.nextStop] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
                         * supported value.
                         */
                         ...
                         *
                         * You should usually call [Builder.nextStopTimeOffset] with a well-typed [Long] value instead. This method is primarily for setting the field to an undocumented or not yet
                         * supported value.
                         */
                         ...
                         *
                         * You should usually call [Builder.scheduledDistanceAlongTrip] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
                         * supported value.
                         */
                     ...
                     * Used for best match union deserialization.
                     */
                    internal fun validity(): Int = (if (activeTripId.asKnown() == null) 0 else 1) + (if (blockTripSequence.asKnown() == null) 0 else 1) + (if (closestStop.asKnown() == null) 0 else 1) + (if (distanceAlongTrip.asKnown() == null) 0 else 1) + (if (lastKnownDistanceAlongTrip.asKnown() == null) 0 else 1) + (if (lastLocationUpdateTime.asKnown() == null) 0 else 1) + (if (lastUpdateTime.asKnown() == null) 0 else 1) + (if (occupancyCapacity.asKnown() == null) 0 else 1) + (if (occupancyCount.asKnown() == null) 0 else 1) + (if (occupancyStatus.asKnown() == null) 0 else 1) + (if (phase.asKnown() == null) 0 else 1) + (if (predicted.asKnown() == null) 0 else 1) + (if (scheduleDeviation.asKnown() == null) 0 else 1) + (if (serviceDate.asKnown() == null) 0 else 1) + (if (status.asKnown() == null) 0 else 1) + (if (totalDistanceAlongTrip.asKnown() == null) 0 else 1) + (if (closestStopTimeOffset.asKnown() == null) 0 else 1) + (if (frequency.asKnown() == null) 0 else 1) + (lastKnownLocation.asKnown()?.validity() ?: 0) + (if (lastKnownOrientation.asKnown() == null) 0 else 1) + (if (nextStop.asKnown() == null) 0 else 1) + (if (nextStopTimeOffset.asKnown() == null) 0 else 1) + (if (orientation.asKnown() == null) 0 else 1) + (position.asKnown()?.validity() ?: 0) + (if (scheduledDistanceAlongTrip.asKnown() == null) 0 else 1) + (situationIds.asKnown()?.size ?: 0) + (if (vehicleId.asKnown() == null) 0 else 1)

                    /** Last known location of the transit vehicle (optional). */
                    class LastKnownLocation @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
                         ...
                         * Used for best match union deserialization.
                         */
                        internal fun validity(): Int = (if (lat.asKnown() == null) 0 else 1) + (if (lon.asKnown() == null) 0 else 1)
                        ...
                        override fun equals(other: Any?): Boolean {
                          ...
                          return other is LastKnownLocation && lat == other.lat && lon == other.lon && additionalProperties == other.additionalProperties
                        }
                    ...
                    /** Current position of the transit vehicle. */
                    class Position @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
                        private val lat: JsonField<Double>,
                        private val lon: JsonField<Double>,
                        private val additionalProperties: MutableMap<String, JsonValue>,
                        ...
                        override fun equals(other: Any?): Boolean {
                          ...
                          return other is Position && lat == other.lat && lon == other.lon && additionalProperties == other.additionalProperties
                        }
            ...
            class NearbyStopId @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
                ...
                @JsonCreator
                private constructor(
                    @JsonProperty("distanceFromQuery") @ExcludeMissing distanceFromQuery: JsonField<Double> = JsonMissing.of(),
                    @JsonProperty("stopId") @ExcludeMissing stopId: JsonField<String> = JsonMissing.of()
                ) : this(
                  distanceFromQuery,
                  stopId,
                ...
                /** @throws OnebusawaySdkInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value). */
                fun distanceFromQuery(): Double? = distanceFromQuery.getNullable("distanceFromQuery")

                /** @throws OnebusawaySdkInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value). */
                fun stopId(): String? = stopId.getNullable("stopId")

                /**
                 * Returns the raw JSON value of [distanceFromQuery].
                 *
                 * Unlike [distanceFromQuery], this method doesn't throw if the JSON field has an unexpected type.
                 */
                @JsonProperty("distanceFromQuery")
                @ExcludeMissing
                fun _distanceFromQuery(): JsonField<Double> = distanceFromQuery
                ...
                companion object {
                    ...
                    /** Returns a mutable builder for constructing an instance of [NearbyStopId]. */
                    fun builder() = Builder()
                }

                /** A builder for [NearbyStopId]. */
                class Builder internal constructor() {

                    private var distanceFromQuery: JsonField<Double> = JsonMissing.of()
                    private var stopId: JsonField<String> = JsonMissing.of()
                    private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

                    internal fun from(nearbyStopId: NearbyStopId) =
                        apply {
                            distanceFromQuery = nearbyStopId.distanceFromQuery
                            stopId = nearbyStopId.stopId
                            additionalProperties = nearbyStopId.additionalProperties.toMutableMap()
                        }

                    fun distanceFromQuery(distanceFromQuery: Double) = distanceFromQuery(JsonField.of(distanceFromQuery))

                    /**
                     * Sets [Builder.distanceFromQuery] to an arbitrary JSON value.
                     *
                     * You should usually call [Builder.distanceFromQuery] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
                     * supported value.
                     */
                    fun distanceFromQuery(distanceFromQuery: JsonField<Double>) =
                        apply {
                    ...
                    /**
                     * Returns an immutable instance of [NearbyStopId].
                     *
                     * Further updates to this [Builder] will not mutate the returned instance.
                     */
                    fun build(): NearbyStopId =
                        NearbyStopId(
                          distanceFromQuery,
                          stopId,
                          additionalProperties.toMutableMap(),
                 ...
                 * Used for best match union deserialization.
                 */
                internal fun validity(): Int = (if (distanceFromQuery.asKnown() == null) 0 else 1) + (if (stopId.asKnown() == null) 0 else 1)
                ...
                override fun equals(other: Any?): Boolean {
                  ...
                  return other is NearbyStopId && distanceFromQuery == other.distanceFromQuery && stopId == other.stopId && additionalProperties == other.additionalProperties
                }

                private val hashCode: Int by lazy { Objects.hash(distanceFromQuery, stopId, additionalProperties) }

                override fun hashCode(): Int = hashCode

                override fun toString() = "NearbyStopId{distanceFromQuery=$distanceFromQuery, stopId=$stopId, additionalProperties=$additionalProperties}"
            }
            ...
            override fun equals(other: Any?): Boolean {
              ...
              return other is Entry && arrivalsAndDepartures == other.arrivalsAndDepartures && limitExceeded == other.limitExceeded && nearbyStopIds == other.nearbyStopIds && stopIds == other.stopIds && situationIds == other.situationIds && additionalProperties == other.additionalProperties
            }

            private val hashCode: Int by lazy { Objects.hash(arrivalsAndDepartures, limitExceeded, nearbyStopIds, stopIds, situationIds, additionalProperties) }

            override fun hashCode(): Int = hashCode

            override fun toString() = "Entry{arrivalsAndDepartures=$arrivalsAndDepartures, limitExceeded=$limitExceeded, nearbyStopIds=$nearbyStopIds, stopIds=$stopIds, situationIds=$situationIds, additionalProperties=$additionalProperties}"
        }
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is Data && entry == other.entry && references == other.references && additionalProperties == other.additionalProperties
        }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is ArrivalsAndDeparturesForLocationListResponse && code == other.code && currentTime == other.currentTime && text == other.text && version == other.version && data == other.data && additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() = "ArrivalsAndDeparturesForLocationListResponse{code=$code, currentTime=$currentTime, text=$text, version=$version, data=$data, additionalProperties=$additionalProperties}"
}
