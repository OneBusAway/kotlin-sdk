...
class ScheduleForStopRetrieveResponse @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ScheduleForStopRetrieveResponse].
         *
    ...
    class Builder internal constructor() {
        ...
        internal fun from(scheduleForStopRetrieveResponse: ScheduleForStopRetrieveResponse) =
            apply {
                ...
                additionalProperties = scheduleForStopRetrieveResponse.additionalProperties.toMutableMap()
            }
     ...
     *   expected type.
     */
    fun validate(): ScheduleForStopRetrieveResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    class Data @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
        ...
        class Entry @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
            ...
            private constructor(
                ...
                @JsonProperty("stopRouteSchedules") @ExcludeMissing stopRouteSchedules: JsonField<List<StopRouteSchedule>> = JsonMissing.of()
            ) : this(
              date,
              stopId,
              stopRouteSchedules,
             ...
             *
             * Unlike [stopRouteSchedules], this method doesn't throw if the JSON field has an unexpected type.
             */
            ...
            class Builder internal constructor() {
                 ...
                 *
                 * You should usually call [Builder.date] with a well-typed [Long] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun date(date: JsonField<Long>) =
                    apply {
                        this.date = date
                    }
                 ...
                 *
                 * You should usually call [Builder.stopRouteSchedules] with a well-typed `List<StopRouteSchedule>` value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                 ...
                 */
                fun addStopRouteSchedule(stopRouteSchedule: StopRouteSchedule) =
                    apply {
                        stopRouteSchedules = (stopRouteSchedules ?: JsonField.of(mutableListOf())).also {
             ...
             * Used for best match union deserialization.
             */
            internal fun validity(): Int = (if (date.asKnown() == null) 0 else 1) + (if (stopId.asKnown() == null) 0 else 1) + (stopRouteSchedules.asKnown()?.sumOf { it.validity().toInt() } ?: 0)

            class StopRouteSchedule @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
                private val routeId: JsonField<String>,
                private val stopRouteDirectionSchedules: JsonField<List<StopRouteDirectionSchedule>>,
                private val additionalProperties: MutableMap<String, JsonValue>,
                ...
                private constructor(
                    ...
                    @JsonProperty("stopRouteDirectionSchedules") @ExcludeMissing stopRouteDirectionSchedules: JsonField<List<StopRouteDirectionSchedule>> = JsonMissing.of()
                ) : this(
                  routeId,
                 ...
                 *
                 * Unlike [stopRouteDirectionSchedules], this method doesn't throw if the JSON field has an unexpected type.
                 */
                @JsonProperty("stopRouteDirectionSchedules")
                @ExcludeMissing
                fun _stopRouteDirectionSchedules(): JsonField<List<StopRouteDirectionSchedule>> = stopRouteDirectionSchedules
                ...
                companion object {
                    ...
                    /**
                     * Returns a mutable builder for constructing an instance of [StopRouteSchedule].
                     *
                     * The following fields are required:
                     *
                     * ```kotlin
                ...
                class Builder internal constructor() {
                    ...
                    private var stopRouteDirectionSchedules: JsonField<MutableList<StopRouteDirectionSchedule>>? = null
                    private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

                    internal fun from(stopRouteSchedule: StopRouteSchedule) =
                        apply {
                            routeId = stopRouteSchedule.routeId
                            stopRouteDirectionSchedules = stopRouteSchedule.stopRouteDirectionSchedules.map { it.toMutableList() }
                     ...
                     *
                     * You should usually call [Builder.stopRouteDirectionSchedules] with a well-typed `List<StopRouteDirectionSchedule>` value instead. This method is primarily for setting the field to an undocumented or not yet
                     * supported value.
                     */
                    fun stopRouteDirectionSchedules(stopRouteDirectionSchedules: JsonField<List<StopRouteDirectionSchedule>>) =
                        apply {
                            this.stopRouteDirectionSchedules = stopRouteDirectionSchedules.map { it.toMutableList() }
                        }
                     ...
                     * @throws IllegalStateException if the field was previously set to a non-list.
                     */
                    fun addStopRouteDirectionSchedule(stopRouteDirectionSchedule: StopRouteDirectionSchedule) =
                        apply {
                            stopRouteDirectionSchedules = (stopRouteDirectionSchedules ?: JsonField.of(mutableListOf())).also {
                                checkKnown("stopRouteDirectionSchedules", it).add(stopRouteDirectionSchedule)
                            }
                        }
                 ...
                 *   expected type.
                 */
                fun validate(): StopRouteSchedule =
                    apply {
                        if (validated) {
                          return@apply
                        }
                 ...
                 * Used for best match union deserialization.
                 */
                internal fun validity(): Int = (if (routeId.asKnown() == null) 0 else 1) + (stopRouteDirectionSchedules.asKnown()?.sumOf { it.validity().toInt() } ?: 0)

                class StopRouteDirectionSchedule @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
                    ...
                    @JsonCreator
                    private constructor(
                        @JsonProperty("scheduleStopTimes") @ExcludeMissing scheduleStopTimes: JsonField<List<ScheduleStopTime>> = JsonMissing.of(),
                        @JsonProperty("tripHeadsign") @ExcludeMissing tripHeadsign: JsonField<String> = JsonMissing.of(),
                        @JsonProperty("scheduleFrequencies") @ExcludeMissing scheduleFrequencies: JsonField<List<ScheduleFrequency>> = JsonMissing.of()
                    ) : this(
                      scheduleStopTimes,
                      tripHeadsign,
                      scheduleFrequencies,
                    ...
                    fun scheduleFrequencies(): List<ScheduleFrequency>? = scheduleFrequencies.getNullable("scheduleFrequencies")

                    /**
                     * Returns the raw JSON value of [scheduleStopTimes].
                     *
                     * Unlike [scheduleStopTimes], this method doesn't throw if the JSON field has an unexpected type.
                     */
                     ...
                     *
                     * Unlike [scheduleFrequencies], this method doesn't throw if the JSON field has an unexpected type.
                     */
                    @JsonProperty("scheduleFrequencies")
                    @ExcludeMissing
                    fun _scheduleFrequencies(): JsonField<List<ScheduleFrequency>> = scheduleFrequencies
                    ...
                    companion object {
                        ...
                        /**
                         * Returns a mutable builder for constructing an instance of [StopRouteDirectionSchedule].
                         *
                         * The following fields are required:
                         *
                         * ```kotlin
                    ...
                    class Builder internal constructor() {
                        ...
                        private var scheduleStopTimes: JsonField<MutableList<ScheduleStopTime>>? = null
                        private var tripHeadsign: JsonField<String>? = null
                        private var scheduleFrequencies: JsonField<MutableList<ScheduleFrequency>>? = null
                        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

                        internal fun from(stopRouteDirectionSchedule: StopRouteDirectionSchedule) =
                            apply {
                                scheduleStopTimes = stopRouteDirectionSchedule.scheduleStopTimes.map { it.toMutableList() }
                                tripHeadsign = stopRouteDirectionSchedule.tripHeadsign
                                scheduleFrequencies = stopRouteDirectionSchedule.scheduleFrequencies.map { it.toMutableList() }
                                additionalProperties = stopRouteDirectionSchedule.additionalProperties.toMutableMap()
                            }
                         ...
                         *
                         * You should usually call [Builder.scheduleStopTimes] with a well-typed `List<ScheduleStopTime>` value instead. This method is primarily for setting the field to an undocumented or not yet
                         * supported value.
                         */
                        fun scheduleStopTimes(scheduleStopTimes: JsonField<List<ScheduleStopTime>>) =
                            apply {
                         ...
                         * @throws IllegalStateException if the field was previously set to a non-list.
                         */
                        fun addScheduleStopTime(scheduleStopTime: ScheduleStopTime) =
                            apply {
                                scheduleStopTimes = (scheduleStopTimes ?: JsonField.of(mutableListOf())).also {
                         ...
                         *
                         * You should usually call [Builder.scheduleFrequencies] with a well-typed `List<ScheduleFrequency>` value instead. This method is primarily for setting the field to an undocumented or not yet
                         * supported value.
                         */
                        fun scheduleFrequencies(scheduleFrequencies: JsonField<List<ScheduleFrequency>>) =
                            apply {
                                this.scheduleFrequencies = scheduleFrequencies.map { it.toMutableList() }
                            }
                         ...
                         * @throws IllegalStateException if the field was previously set to a non-list.
                         */
                        fun addScheduleFrequency(scheduleFrequency: ScheduleFrequency) =
                            apply {
                                scheduleFrequencies = (scheduleFrequencies ?: JsonField.of(mutableListOf())).also {
                     ...
                     *   expected type.
                     */
                    fun validate(): StopRouteDirectionSchedule =
                        apply {
                            if (validated) {
                              return@apply
                            }
                     ...
                     * Used for best match union deserialization.
                     */
                    internal fun validity(): Int = (scheduleStopTimes.asKnown()?.sumOf { it.validity().toInt() } ?: 0) + (if (tripHeadsign.asKnown() == null) 0 else 1) + (scheduleFrequencies.asKnown()?.sumOf { it.validity().toInt() } ?: 0)

                    class ScheduleStopTime @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
                        ...
                        companion object {
                            ...
                            /**
                             * Returns a mutable builder for constructing an instance of [ScheduleStopTime].
                             *
                             * The following fields are required:
                             *
                             * ```kotlin
                        ...
                        class Builder internal constructor() {
                            ...
                            internal fun from(scheduleStopTime: ScheduleStopTime) =
                                apply {
                                    ...
                                    additionalProperties = scheduleStopTime.additionalProperties.toMutableMap()
                                }
                         ...
                         * Used for best match union deserialization.
                         */
                        internal fun validity(): Int = (if (arrivalEnabled.asKnown() == null) 0 else 1) + (if (arrivalTime.asKnown() == null) 0 else 1) + (if (departureEnabled.asKnown() == null) 0 else 1) + (if (departureTime.asKnown() == null) 0 else 1) + (if (serviceId.asKnown() == null) 0 else 1) + (if (tripId.asKnown() == null) 0 else 1) + (if (stopHeadsign.asKnown() == null) 0 else 1)
                        ...
                        override fun equals(other: Any?): Boolean {
                          ...
                          return other is ScheduleStopTime && arrivalEnabled == other.arrivalEnabled && arrivalTime == other.arrivalTime && departureEnabled == other.departureEnabled && departureTime == other.departureTime && serviceId == other.serviceId && tripId == other.tripId && stopHeadsign == other.stopHeadsign && additionalProperties == other.additionalProperties
                        }
                        ...
                        override fun toString() = "ScheduleStopTime{arrivalEnabled=$arrivalEnabled, arrivalTime=$arrivalTime, departureEnabled=$departureEnabled, departureTime=$departureTime, serviceId=$serviceId, tripId=$tripId, stopHeadsign=$stopHeadsign, additionalProperties=$additionalProperties}"
                    }

                    class ScheduleFrequency @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
                        ...
                        @JsonCreator
                        private constructor(
                            @JsonProperty("endTime") @ExcludeMissing endTime: JsonField<Long> = JsonMissing.of(),
                            @JsonProperty("headway") @ExcludeMissing headway: JsonField<Int> = JsonMissing.of(),
                            @JsonProperty("serviceDate") @ExcludeMissing serviceDate: JsonField<Long> = JsonMissing.of(),
                            @JsonProperty("serviceId") @ExcludeMissing serviceId: JsonField<String> = JsonMissing.of(),
                            @JsonProperty("startTime") @ExcludeMissing startTime: JsonField<Long> = JsonMissing.of(),
                            @JsonProperty("tripId") @ExcludeMissing tripId: JsonField<String> = JsonMissing.of()
                        ) : this(
                          endTime,
                          headway,
                         ...
                         *
                         * Unlike [headway], this method doesn't throw if the JSON field has an unexpected type.
                         */
                        ...
                        companion object {
                            ...
                            /**
                             * Returns a mutable builder for constructing an instance of [ScheduleFrequency].
                             *
                             * The following fields are required:
                             *
                             * ```kotlin
                        ...
                        class Builder internal constructor() {
                            ...
                            internal fun from(scheduleFrequency: ScheduleFrequency) =
                                apply {
                                    ...
                                    additionalProperties = scheduleFrequency.additionalProperties.toMutableMap()
                                }
                             ...
                             *
                             * You should usually call [Builder.endTime] with a well-typed [Long] value instead. This method is primarily for setting the field to an undocumented or not yet
                             * supported value.
                             */
                            fun endTime(endTime: JsonField<Long>) =
                                apply {
                             ...
                             *
                             * You should usually call [Builder.headway] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
                             * supported value.
                             */
                            fun headway(headway: JsonField<Int>) =
                                apply {
                             ...
                             *
                             * You should usually call [Builder.startTime] with a well-typed [Long] value instead. This method is primarily for setting the field to an undocumented or not yet
                             * supported value.
                             */
                            fun startTime(startTime: JsonField<Long>) =
                                apply {
                         ...
                         *   expected type.
                         */
                        fun validate(): ScheduleFrequency =
                            apply {
                                if (validated) {
                                  return@apply
                                }
                         ...
                         * Used for best match union deserialization.
                         */
                        internal fun validity(): Int = (if (endTime.asKnown() == null) 0 else 1) + (if (headway.asKnown() == null) 0 else 1) + (if (serviceDate.asKnown() == null) 0 else 1) + (if (serviceId.asKnown() == null) 0 else 1) + (if (startTime.asKnown() == null) 0 else 1) + (if (tripId.asKnown() == null) 0 else 1)
                        ...
                        override fun equals(other: Any?): Boolean {
                          ...
                          return other is ScheduleFrequency && endTime == other.endTime && headway == other.headway && serviceDate == other.serviceDate && serviceId == other.serviceId && startTime == other.startTime && tripId == other.tripId && additionalProperties == other.additionalProperties
                        }
                        ...
                        override fun toString() = "ScheduleFrequency{endTime=$endTime, headway=$headway, serviceDate=$serviceDate, serviceId=$serviceId, startTime=$startTime, tripId=$tripId, additionalProperties=$additionalProperties}"
                    }
                    ...
                    override fun equals(other: Any?): Boolean {
                      ...
                      return other is StopRouteDirectionSchedule && scheduleStopTimes == other.scheduleStopTimes && tripHeadsign == other.tripHeadsign && scheduleFrequencies == other.scheduleFrequencies && additionalProperties == other.additionalProperties
                    }
                    ...
                    override fun toString() = "StopRouteDirectionSchedule{scheduleStopTimes=$scheduleStopTimes, tripHeadsign=$tripHeadsign, scheduleFrequencies=$scheduleFrequencies, additionalProperties=$additionalProperties}"
                }
                ...
                override fun equals(other: Any?): Boolean {
                  ...
                  return other is StopRouteSchedule && routeId == other.routeId && stopRouteDirectionSchedules == other.stopRouteDirectionSchedules && additionalProperties == other.additionalProperties
                }
            ...
            override fun equals(other: Any?): Boolean {
              ...
              return other is Entry && date == other.date && stopId == other.stopId && stopRouteSchedules == other.stopRouteSchedules && additionalProperties == other.additionalProperties
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is ScheduleForStopRetrieveResponse && code == other.code && currentTime == other.currentTime && text == other.text && version == other.version && data == other.data && additionalProperties == other.additionalProperties
    }
