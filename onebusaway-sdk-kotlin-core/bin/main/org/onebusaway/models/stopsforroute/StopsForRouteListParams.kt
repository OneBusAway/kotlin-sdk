...
class StopsForRouteListParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(stopsForRouteListParams: StopsForRouteListParams) =
            apply {
         ...
         */
        fun includePolylines(includePolylines: Boolean) = includePolylines(includePolylines as Boolean?)
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is StopsForRouteListParams && routeId == other.routeId && includePolylines == other.includePolylines && time == other.time && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(routeId, includePolylines, time, additionalHeaders, additionalQueryParams)

    override fun toString() = "StopsForRouteListParams{routeId=$routeId, includePolylines=$includePolylines, time=$time, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
