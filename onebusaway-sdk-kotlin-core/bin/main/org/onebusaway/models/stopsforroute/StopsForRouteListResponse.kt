...
class StopsForRouteListResponse @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(stopsForRouteListResponse: StopsForRouteListResponse) =
            apply {
     ...
     *   expected type.
     */
    fun validate(): StopsForRouteListResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    class Data @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
        ...
        class Entry @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
            ...
            @JsonCreator
            private constructor(
                @JsonProperty("polylines") @ExcludeMissing polylines: JsonField<List<Polyline>> = JsonMissing.of(),
                @JsonProperty("routeId") @ExcludeMissing routeId: JsonField<String> = JsonMissing.of(),
                @JsonProperty("stopGroupings") @ExcludeMissing stopGroupings: JsonField<List<StopGrouping>> = JsonMissing.of(),
             ...
             *
             * Unlike [polylines], this method doesn't throw if the JSON field has an unexpected type.
             */
             ...
             *
             * Unlike [stopGroupings], this method doesn't throw if the JSON field has an unexpected type.
             */
            ...
            class Builder internal constructor() {
                 ...
                 *
                 * You should usually call [Builder.polylines] with a well-typed `List<Polyline>` value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun polylines(polylines: JsonField<List<Polyline>>) =
                    apply {
                ...
                fun addPolyline(polyline: Polyline) =
                    apply {
                        polylines = (polylines ?: JsonField.of(mutableListOf())).also {
                 ...
                 *
                 * You should usually call [Builder.stopGroupings] with a well-typed `List<StopGrouping>` value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun stopGroupings(stopGroupings: JsonField<List<StopGrouping>>) =
                    apply {
                 ...
                 * @throws IllegalStateException if the field was previously set to a non-list.
                 */
                fun addStopGrouping(stopGrouping: StopGrouping) =
                    apply {
                        stopGroupings = (stopGroupings ?: JsonField.of(mutableListOf())).also {
             ...
             * Used for best match union deserialization.
             */
            internal fun validity(): Int = (polylines.asKnown()?.sumOf { it.validity().toInt() } ?: 0) + (if (routeId.asKnown() == null) 0 else 1) + (stopGroupings.asKnown()?.sumOf { it.validity().toInt() } ?: 0) + (stopIds.asKnown()?.size ?: 0)

            class Polyline @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
                ...
                class Builder internal constructor() {
                    ...
                    internal fun from(polyline: Polyline) =
                        apply {
                ...
                override fun equals(other: Any?): Boolean {
                  ...
                  return other is Polyline && length == other.length && levels == other.levels && points == other.points && additionalProperties == other.additionalProperties
                }
            ...
            class StopGrouping @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
                ...
                class Builder internal constructor() {
                    ...
                    internal fun from(stopGrouping: StopGrouping) =
                        apply {
                            id = stopGrouping.id
                 ...
                 * Used for best match union deserialization.
                 */
                internal fun validity(): Int = (if (id.asKnown() == null) 0 else 1) + (name.asKnown()?.validity() ?: 0) + (polylines.asKnown()?.sumOf { it.validity().toInt() } ?: 0) + (stopIds.asKnown()?.size ?: 0)

                class Name @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
                    ...
                    private constructor(
                        ...
                        @JsonProperty("names") @ExcludeMissing names: JsonField<List<String>> = JsonMissing.of(),
                    ...
                    class Builder internal constructor() {
                         ...
                         *
                         * You should usually call [Builder.names] with a well-typed `List<String>` value instead. This method is primarily for setting the field to an undocumented or not yet
                         * supported value.
                         */
                        fun names(names: JsonField<List<String>>) =
                            apply {
                        ...
                        fun addName(name: String) =
                            apply {
                                names = (names ?: JsonField.of(mutableListOf())).also {
                     ...
                     * Used for best match union deserialization.
                     */
                    internal fun validity(): Int = (if (name.asKnown() == null) 0 else 1) + (names.asKnown()?.size ?: 0) + (if (type.asKnown() == null) 0 else 1)
                    ...
                    override fun equals(other: Any?): Boolean {
                      ...
                      return other is Name && name == other.name && names == other.names && type == other.type && additionalProperties == other.additionalProperties
                    }
                ...
                override fun equals(other: Any?): Boolean {
                  ...
                  return other is StopGrouping && id == other.id && name == other.name && polylines == other.polylines && stopIds == other.stopIds && additionalProperties == other.additionalProperties
                }
            ...
            override fun equals(other: Any?): Boolean {
              ...
              return other is Entry && polylines == other.polylines && routeId == other.routeId && stopGroupings == other.stopGroupings && stopIds == other.stopIds && additionalProperties == other.additionalProperties
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is StopsForRouteListResponse && code == other.code && currentTime == other.currentTime && text == other.text && version == other.version && data == other.data && additionalProperties == other.additionalProperties
    }
