...
class StopsForAgencyListParams private constructor(
    ...
    /** A builder for [StopsForAgencyListParams]. */
    class Builder internal constructor() {
        ...
        internal fun from(stopsForAgencyListParams: StopsForAgencyListParams) =
            apply {
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is StopsForAgencyListParams && agencyId == other.agencyId && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(agencyId, additionalHeaders, additionalQueryParams)

    override fun toString() = "StopsForAgencyListParams{agencyId=$agencyId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
