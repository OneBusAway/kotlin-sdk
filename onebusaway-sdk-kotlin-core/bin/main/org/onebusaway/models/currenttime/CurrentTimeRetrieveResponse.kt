...
class CurrentTimeRetrieveResponse @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(currentTimeRetrieveResponse: CurrentTimeRetrieveResponse) =
            apply {
     ...
     *   expected type.
     */
    fun validate(): CurrentTimeRetrieveResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    class Data @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
        ...
        class Entry @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
            ...
            @JsonCreator
            private constructor(
                @JsonProperty("readableTime") @ExcludeMissing readableTime: JsonField<String> = JsonMissing.of(),
            ...
            fun readableTime(): String? = readableTime.getNullable("readableTime")
             ...
             *
             * Unlike [readableTime], this method doesn't throw if the JSON field has an unexpected type.
             */
            ...
            class Builder internal constructor() {
                 ...
                 *
                 * You should usually call [Builder.readableTime] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun readableTime(readableTime: JsonField<String>) =
                    apply {
                 ...
                 *
                 * You should usually call [Builder.time] with a well-typed [Long] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun time(time: JsonField<Long>) =
                    apply {
                        this.time = time
                    }
             ...
             * Used for best match union deserialization.
             */
            internal fun validity(): Int = (if (readableTime.asKnown() == null) 0 else 1) + (if (time.asKnown() == null) 0 else 1)
            ...
            override fun equals(other: Any?): Boolean {
              ...
              return other is Entry && readableTime == other.readableTime && time == other.time && additionalProperties == other.additionalProperties
            }
            ...
            override fun toString() = "Entry{readableTime=$readableTime, time=$time, additionalProperties=$additionalProperties}"
        }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is CurrentTimeRetrieveResponse && code == other.code && currentTime == other.currentTime && text == other.text && version == other.version && data == other.data && additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() = "CurrentTimeRetrieveResponse{code=$code, currentTime=$currentTime, text=$text, version=$version, data=$data, additionalProperties=$additionalProperties}"
}
