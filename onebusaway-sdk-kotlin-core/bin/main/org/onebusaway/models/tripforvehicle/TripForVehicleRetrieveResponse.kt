...
class TripForVehicleRetrieveResponse @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    ...
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [TripForVehicleRetrieveResponse].
         *
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is TripForVehicleRetrieveResponse && code == other.code && currentTime == other.currentTime && text == other.text && version == other.version && data == other.data && additionalProperties == other.additionalProperties
    }
