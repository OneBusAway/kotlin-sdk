...
class TripDetailRetrieveParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(tripDetailRetrieveParams: TripDetailRetrieveParams) =
            apply {
        ...
        /** Whether to include the full schedule element in the tripDetails section (defaults to true). */
        fun includeSchedule(includeSchedule: Boolean?) =
            apply {
        ...
        /** Whether to include the full status element in the tripDetails section (defaults to true). */
        fun includeStatus(includeStatus: Boolean?) =
            apply {
        ...
        /** Whether to include the full trip element in the references section (defaults to true). */
        fun includeTrip(includeTrip: Boolean?) =
            apply {
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is TripDetailRetrieveParams && tripId == other.tripId && includeSchedule == other.includeSchedule && includeStatus == other.includeStatus && includeTrip == other.includeTrip && serviceDate == other.serviceDate && time == other.time && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(tripId, includeSchedule, includeStatus, includeTrip, serviceDate, time, additionalHeaders, additionalQueryParams)

    override fun toString() = "TripDetailRetrieveParams{tripId=$tripId, includeSchedule=$includeSchedule, includeStatus=$includeStatus, includeTrip=$includeTrip, serviceDate=$serviceDate, time=$time, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
