...
class TripDetailRetrieveResponse @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    ...
    /** A builder for [TripDetailRetrieveResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(tripDetailRetrieveResponse: TripDetailRetrieveResponse) =
            apply {
                code = tripDetailRetrieveResponse.code
                currentTime = tripDetailRetrieveResponse.currentTime
                text = tripDetailRetrieveResponse.text
                version = tripDetailRetrieveResponse.version
                data = tripDetailRetrieveResponse.data
                additionalProperties = tripDetailRetrieveResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [TripDetailRetrieveResponse].
         *
     ...
     *   expected type.
     */
    fun validate(): TripDetailRetrieveResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    class Data @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
        ...
        class Entry @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
             ...
             * Used for best match union deserialization.
             */
            internal fun validity(): Int = (if (tripId.asKnown() == null) 0 else 1) + (if (frequency.asKnown() == null) 0 else 1) + (schedule.asKnown()?.validity() ?: 0) + (if (serviceDate.asKnown() == null) 0 else 1) + (situationIds.asKnown()?.size ?: 0) + (status.asKnown()?.validity() ?: 0)
            ...
            override fun equals(other: Any?): Boolean {
              ...
              return other is Entry && tripId == other.tripId && frequency == other.frequency && schedule == other.schedule && serviceDate == other.serviceDate && situationIds == other.situationIds && status == other.status && additionalProperties == other.additionalProperties
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is TripDetailRetrieveResponse && code == other.code && currentTime == other.currentTime && text == other.text && version == other.version && data == other.data && additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() = "TripDetailRetrieveResponse{code=$code, currentTime=$currentTime, text=$text, version=$version, data=$data, additionalProperties=$additionalProperties}"
}
