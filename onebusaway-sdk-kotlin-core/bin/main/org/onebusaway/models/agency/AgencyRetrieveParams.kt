...
class AgencyRetrieveParams private constructor(
    ...
    companion object {
        ...
        fun none(): AgencyRetrieveParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        internal fun from(agencyRetrieveParams: AgencyRetrieveParams) =
            apply {
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is AgencyRetrieveParams && agencyId == other.agencyId && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(agencyId, additionalHeaders, additionalQueryParams)

    override fun toString() = "AgencyRetrieveParams{agencyId=$agencyId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
