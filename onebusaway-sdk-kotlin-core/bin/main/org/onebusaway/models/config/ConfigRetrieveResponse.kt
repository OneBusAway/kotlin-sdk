...
class ConfigRetrieveResponse @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(configRetrieveResponse: ConfigRetrieveResponse) =
            apply {
     ...
     *   expected type.
     */
    fun validate(): ConfigRetrieveResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    class Data @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
        ...
        class Entry @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
            ...
            private constructor(
                ...
                @JsonProperty("gitProperties") @ExcludeMissing gitProperties: JsonField<GitProperties> = JsonMissing.of(),
                @JsonProperty("name") @ExcludeMissing name: JsonField<String> = JsonMissing.of(),
                @JsonProperty("serviceDateFrom") @ExcludeMissing serviceDateFrom: JsonField<String> = JsonMissing.of(),
                @JsonProperty("serviceDateTo") @ExcludeMissing serviceDateTo: JsonField<String> = JsonMissing.of()
            ) : this(
              id,
              gitProperties,
              name,
             ...
             *
             * Unlike [gitProperties], this method doesn't throw if the JSON field has an unexpected type.
             */
             ...
             *
             * Unlike [serviceDateFrom], this method doesn't throw if the JSON field has an unexpected type.
             */
             ...
             *
             * Unlike [serviceDateTo], this method doesn't throw if the JSON field has an unexpected type.
             */
            ...
            class Builder internal constructor() {
                 ...
                 *
                 * You should usually call [Builder.gitProperties] with a well-typed [GitProperties] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun gitProperties(gitProperties: JsonField<GitProperties>) =
                    apply {
                 ...
                 *
                 * You should usually call [Builder.serviceDateFrom] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun serviceDateFrom(serviceDateFrom: JsonField<String>) =
                    apply {
                 ...
                 *
                 * You should usually call [Builder.serviceDateTo] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun serviceDateTo(serviceDateTo: JsonField<String>) =
                    apply {
             ...
             * Used for best match union deserialization.
             */
            internal fun validity(): Int = (if (id.asKnown() == null) 0 else 1) + (gitProperties.asKnown()?.validity() ?: 0) + (if (name.asKnown() == null) 0 else 1) + (if (serviceDateFrom.asKnown() == null) 0 else 1) + (if (serviceDateTo.asKnown() == null) 0 else 1)

            class GitProperties @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
                ...
                @JsonCreator
                private constructor(
                    @JsonProperty("git.branch") @ExcludeMissing gitBranch: JsonField<String> = JsonMissing.of(),
                    @JsonProperty("git.build.host") @ExcludeMissing gitBuildHost: JsonField<String> = JsonMissing.of(),
                    @JsonProperty("git.build.time") @ExcludeMissing gitBuildTime: JsonField<String> = JsonMissing.of(),
                    @JsonProperty("git.build.user.email") @ExcludeMissing gitBuildUserEmail: JsonField<String> = JsonMissing.of(),
                    @JsonProperty("git.build.user.name") @ExcludeMissing gitBuildUserName: JsonField<String> = JsonMissing.of(),
                    @JsonProperty("git.build.version") @ExcludeMissing gitBuildVersion: JsonField<String> = JsonMissing.of(),
                    @JsonProperty("git.closest.tag.commit.count") @ExcludeMissing gitClosestTagCommitCount: JsonField<String> = JsonMissing.of(),
                    @JsonProperty("git.closest.tag.name") @ExcludeMissing gitClosestTagName: JsonField<String> = JsonMissing.of(),
                    @JsonProperty("git.commit.id") @ExcludeMissing gitCommitId: JsonField<String> = JsonMissing.of(),
                    @JsonProperty("git.commit.id.abbrev") @ExcludeMissing gitCommitIdAbbrev: JsonField<String> = JsonMissing.of(),
                    @JsonProperty("git.commit.id.describe") @ExcludeMissing gitCommitIdDescribe: JsonField<String> = JsonMissing.of(),
                    @JsonProperty("git.commit.id.describe-short") @ExcludeMissing gitCommitIdDescribeShort: JsonField<String> = JsonMissing.of(),
                    @JsonProperty("git.commit.message.full") @ExcludeMissing gitCommitMessageFull: JsonField<String> = JsonMissing.of(),
                    @JsonProperty("git.commit.message.short") @ExcludeMissing gitCommitMessageShort: JsonField<String> = JsonMissing.of(),
                    @JsonProperty("git.commit.time") @ExcludeMissing gitCommitTime: JsonField<String> = JsonMissing.of(),
                    @JsonProperty("git.commit.user.email") @ExcludeMissing gitCommitUserEmail: JsonField<String> = JsonMissing.of(),
                    @JsonProperty("git.commit.user.name") @ExcludeMissing gitCommitUserName: JsonField<String> = JsonMissing.of(),
                    @JsonProperty("git.dirty") @ExcludeMissing gitDirty: JsonField<String> = JsonMissing.of(),
                    @JsonProperty("git.remote.origin.url") @ExcludeMissing gitRemoteOriginUrl: JsonField<String> = JsonMissing.of(),
                    @JsonProperty("git.tags") @ExcludeMissing gitTags: JsonField<String> = JsonMissing.of()
                ) : this(
                  gitBranch,
                  gitBuildHost,
                  gitBuildTime,
                ...
                /** @throws OnebusawaySdkInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value). */
                fun gitBuildUserEmail(): String? = gitBuildUserEmail.getNullable("git.build.user.email")

                /** @throws OnebusawaySdkInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value). */
                fun gitBuildUserName(): String? = gitBuildUserName.getNullable("git.build.user.name")

                /** @throws OnebusawaySdkInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value). */
                fun gitBuildVersion(): String? = gitBuildVersion.getNullable("git.build.version")

                /** @throws OnebusawaySdkInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value). */
                fun gitClosestTagCommitCount(): String? = gitClosestTagCommitCount.getNullable("git.closest.tag.commit.count")

                /** @throws OnebusawaySdkInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value). */
                fun gitClosestTagName(): String? = gitClosestTagName.getNullable("git.closest.tag.name")

                /** @throws OnebusawaySdkInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value). */
                fun gitCommitId(): String? = gitCommitId.getNullable("git.commit.id")

                /** @throws OnebusawaySdkInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value). */
                fun gitCommitIdAbbrev(): String? = gitCommitIdAbbrev.getNullable("git.commit.id.abbrev")

                /** @throws OnebusawaySdkInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value). */
                fun gitCommitIdDescribe(): String? = gitCommitIdDescribe.getNullable("git.commit.id.describe")

                /** @throws OnebusawaySdkInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value). */
                fun gitCommitIdDescribeShort(): String? = gitCommitIdDescribeShort.getNullable("git.commit.id.describe-short")

                /** @throws OnebusawaySdkInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value). */
                fun gitCommitMessageFull(): String? = gitCommitMessageFull.getNullable("git.commit.message.full")

                /** @throws OnebusawaySdkInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value). */
                fun gitCommitMessageShort(): String? = gitCommitMessageShort.getNullable("git.commit.message.short")

                /** @throws OnebusawaySdkInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value). */
                fun gitCommitTime(): String? = gitCommitTime.getNullable("git.commit.time")

                /** @throws OnebusawaySdkInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value). */
                fun gitCommitUserEmail(): String? = gitCommitUserEmail.getNullable("git.commit.user.email")

                /** @throws OnebusawaySdkInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value). */
                fun gitCommitUserName(): String? = gitCommitUserName.getNullable("git.commit.user.name")

                /** @throws OnebusawaySdkInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value). */
                fun gitDirty(): String? = gitDirty.getNullable("git.dirty")

                /** @throws OnebusawaySdkInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value). */
                fun gitRemoteOriginUrl(): String? = gitRemoteOriginUrl.getNullable("git.remote.origin.url")
                 ...
                 *
                 * Unlike [gitBuildHost], this method doesn't throw if the JSON field has an unexpected type.
                 */
                 ...
                 *
                 * Unlike [gitBuildTime], this method doesn't throw if the JSON field has an unexpected type.
                 */
                 ...
                 *
                 * Unlike [gitBuildUserEmail], this method doesn't throw if the JSON field has an unexpected type.
                 */
                 ...
                 *
                 * Unlike [gitBuildUserName], this method doesn't throw if the JSON field has an unexpected type.
                 */
                 ...
                 *
                 * Unlike [gitBuildVersion], this method doesn't throw if the JSON field has an unexpected type.
                 */
                 ...
                 *
                 * Unlike [gitClosestTagCommitCount], this method doesn't throw if the JSON field has an unexpected type.
                 */
                 ...
                 *
                 * Unlike [gitClosestTagName], this method doesn't throw if the JSON field has an unexpected type.
                 */
                 ...
                 *
                 * Unlike [gitCommitId], this method doesn't throw if the JSON field has an unexpected type.
                 */
                 ...
                 *
                 * Unlike [gitCommitIdAbbrev], this method doesn't throw if the JSON field has an unexpected type.
                 */
                 ...
                 *
                 * Unlike [gitCommitIdDescribe], this method doesn't throw if the JSON field has an unexpected type.
                 */
                 ...
                 *
                 * Unlike [gitCommitIdDescribeShort], this method doesn't throw if the JSON field has an unexpected type.
                 */
                 ...
                 *
                 * Unlike [gitCommitMessageFull], this method doesn't throw if the JSON field has an unexpected type.
                 */
                 ...
                 *
                 * Unlike [gitCommitMessageShort], this method doesn't throw if the JSON field has an unexpected type.
                 */
                 ...
                 *
                 * Unlike [gitCommitTime], this method doesn't throw if the JSON field has an unexpected type.
                 */
                 ...
                 *
                 * Unlike [gitCommitUserEmail], this method doesn't throw if the JSON field has an unexpected type.
                 */
                 ...
                 *
                 * Unlike [gitCommitUserName], this method doesn't throw if the JSON field has an unexpected type.
                 */
                 ...
                 *
                 * Unlike [gitDirty], this method doesn't throw if the JSON field has an unexpected type.
                 */
                 ...
                 *
                 * Unlike [gitRemoteOriginUrl], this method doesn't throw if the JSON field has an unexpected type.
                 */
                 ...
                 *
                 * Unlike [gitTags], this method doesn't throw if the JSON field has an unexpected type.
                 */
                ...
                class Builder internal constructor() {
                    ...
                    internal fun from(gitProperties: GitProperties) =
                        apply {
                     ...
                     *
                     * You should usually call [Builder.gitBranch] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
                     * supported value.
                     */
                    fun gitBranch(gitBranch: JsonField<String>) =
                        apply {
                     ...
                     *
                     * You should usually call [Builder.gitBuildHost] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
                     * supported value.
                     */
                    fun gitBuildHost(gitBuildHost: JsonField<String>) =
                        apply {
                     ...
                     *
                     * You should usually call [Builder.gitBuildTime] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
                     * supported value.
                     */
                    fun gitBuildTime(gitBuildTime: JsonField<String>) =
                        apply {
                     ...
                     *
                     * You should usually call [Builder.gitBuildUserEmail] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
                     * supported value.
                     */
                    fun gitBuildUserEmail(gitBuildUserEmail: JsonField<String>) =
                        apply {
                     ...
                     *
                     * You should usually call [Builder.gitBuildUserName] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
                     * supported value.
                     */
                    fun gitBuildUserName(gitBuildUserName: JsonField<String>) =
                        apply {
                     ...
                     *
                     * You should usually call [Builder.gitBuildVersion] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
                     * supported value.
                     */
                    fun gitBuildVersion(gitBuildVersion: JsonField<String>) =
                        apply {
                     ...
                     *
                     * You should usually call [Builder.gitClosestTagCommitCount] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
                     * supported value.
                     */
                     ...
                     *
                     * You should usually call [Builder.gitClosestTagName] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
                     * supported value.
                     */
                    fun gitClosestTagName(gitClosestTagName: JsonField<String>) =
                        apply {
                     ...
                     *
                     * You should usually call [Builder.gitCommitId] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
                     * supported value.
                     */
                    fun gitCommitId(gitCommitId: JsonField<String>) =
                        apply {
                     ...
                     *
                     * You should usually call [Builder.gitCommitIdAbbrev] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
                     * supported value.
                     */
                    fun gitCommitIdAbbrev(gitCommitIdAbbrev: JsonField<String>) =
                        apply {
                     ...
                     *
                     * You should usually call [Builder.gitCommitIdDescribe] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
                     * supported value.
                     */
                    fun gitCommitIdDescribe(gitCommitIdDescribe: JsonField<String>) =
                        apply {
                     ...
                     *
                     * You should usually call [Builder.gitCommitIdDescribeShort] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
                     * supported value.
                     */
                     ...
                     *
                     * You should usually call [Builder.gitCommitMessageFull] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
                     * supported value.
                     */
                    fun gitCommitMessageFull(gitCommitMessageFull: JsonField<String>) =
                        apply {
                     ...
                     *
                     * You should usually call [Builder.gitCommitMessageShort] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
                     * supported value.
                     */
                    fun gitCommitMessageShort(gitCommitMessageShort: JsonField<String>) =
                        apply {
                     ...
                     *
                     * You should usually call [Builder.gitCommitTime] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
                     * supported value.
                     */
                    fun gitCommitTime(gitCommitTime: JsonField<String>) =
                        apply {
                     ...
                     *
                     * You should usually call [Builder.gitCommitUserEmail] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
                     * supported value.
                     */
                    fun gitCommitUserEmail(gitCommitUserEmail: JsonField<String>) =
                        apply {
                     ...
                     *
                     * You should usually call [Builder.gitCommitUserName] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
                     * supported value.
                     */
                    fun gitCommitUserName(gitCommitUserName: JsonField<String>) =
                        apply {
                     ...
                     *
                     * You should usually call [Builder.gitDirty] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
                     * supported value.
                     */
                    fun gitDirty(gitDirty: JsonField<String>) =
                        apply {
                     ...
                     *
                     * You should usually call [Builder.gitRemoteOriginUrl] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
                     * supported value.
                     */
                    fun gitRemoteOriginUrl(gitRemoteOriginUrl: JsonField<String>) =
                        apply {
                     ...
                     *
                     * You should usually call [Builder.gitTags] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
                     * supported value.
                     */
                    fun gitTags(gitTags: JsonField<String>) =
                        apply {
                 ...
                 * Used for best match union deserialization.
                 */
                internal fun validity(): Int = (if (gitBranch.asKnown() == null) 0 else 1) + (if (gitBuildHost.asKnown() == null) 0 else 1) + (if (gitBuildTime.asKnown() == null) 0 else 1) + (if (gitBuildUserEmail.asKnown() == null) 0 else 1) + (if (gitBuildUserName.asKnown() == null) 0 else 1) + (if (gitBuildVersion.asKnown() == null) 0 else 1) + (if (gitClosestTagCommitCount.asKnown() == null) 0 else 1) + (if (gitClosestTagName.asKnown() == null) 0 else 1) + (if (gitCommitId.asKnown() == null) 0 else 1) + (if (gitCommitIdAbbrev.asKnown() == null) 0 else 1) + (if (gitCommitIdDescribe.asKnown() == null) 0 else 1) + (if (gitCommitIdDescribeShort.asKnown() == null) 0 else 1) + (if (gitCommitMessageFull.asKnown() == null) 0 else 1) + (if (gitCommitMessageShort.asKnown() == null) 0 else 1) + (if (gitCommitTime.asKnown() == null) 0 else 1) + (if (gitCommitUserEmail.asKnown() == null) 0 else 1) + (if (gitCommitUserName.asKnown() == null) 0 else 1) + (if (gitDirty.asKnown() == null) 0 else 1) + (if (gitRemoteOriginUrl.asKnown() == null) 0 else 1) + (if (gitTags.asKnown() == null) 0 else 1)
            ...
            override fun equals(other: Any?): Boolean {
              ...
              return other is Entry && id == other.id && gitProperties == other.gitProperties && name == other.name && serviceDateFrom == other.serviceDateFrom && serviceDateTo == other.serviceDateTo && additionalProperties == other.additionalProperties
            }
            ...
            override fun toString() = "Entry{id=$id, gitProperties=$gitProperties, name=$name, serviceDateFrom=$serviceDateFrom, serviceDateTo=$serviceDateTo, additionalProperties=$additionalProperties}"
        }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is ConfigRetrieveResponse && code == other.code && currentTime == other.currentTime && text == other.text && version == other.version && data == other.data && additionalProperties == other.additionalProperties
    }
