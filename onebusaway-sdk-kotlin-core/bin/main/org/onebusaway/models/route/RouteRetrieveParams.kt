...
class RouteRetrieveParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(routeRetrieveParams: RouteRetrieveParams) =
            apply {
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is RouteRetrieveParams && routeId == other.routeId && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(routeId, additionalHeaders, additionalQueryParams)

    override fun toString() = "RouteRetrieveParams{routeId=$routeId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
