...
class RoutesForLocationListParams private constructor(
    ...
    companion object {
        ...
        fun none(): RoutesForLocationListParams = builder().build()
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is RoutesForLocationListParams && lat == other.lat && latSpan == other.latSpan && lon == other.lon && lonSpan == other.lonSpan && query == other.query && radius == other.radius && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(lat, latSpan, lon, lonSpan, query, radius, additionalHeaders, additionalQueryParams)

    override fun toString() = "RoutesForLocationListParams{lat=$lat, latSpan=$latSpan, lon=$lon, lonSpan=$lonSpan, query=$query, radius=$radius, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
