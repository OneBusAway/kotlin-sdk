...
class RoutesForLocationListResponse @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [RoutesForLocationListResponse].
         *
    ...
    class Builder internal constructor() {
        ...
        internal fun from(routesForLocationListResponse: RoutesForLocationListResponse) =
            apply {
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is RoutesForLocationListResponse && code == other.code && currentTime == other.currentTime && text == other.text && version == other.version && data == other.data && additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() = "RoutesForLocationListResponse{code=$code, currentTime=$currentTime, text=$text, version=$version, data=$data, additionalProperties=$additionalProperties}"
}
