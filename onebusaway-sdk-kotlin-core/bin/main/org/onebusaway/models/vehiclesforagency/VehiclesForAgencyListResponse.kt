...
class VehiclesForAgencyListResponse @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [VehiclesForAgencyListResponse].
         *
    ...
    class Builder internal constructor() {
        ...
        internal fun from(vehiclesForAgencyListResponse: VehiclesForAgencyListResponse) =
            apply {
        ...
        /**
         * Returns an immutable instance of [VehiclesForAgencyListResponse].
         *
     ...
     *   expected type.
     */
    fun validate(): VehiclesForAgencyListResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    class Data @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
        ...
        class List @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
            ...
            class Builder internal constructor() {
                 ...
                 *
                 * You should usually call [Builder.location] with a well-typed [Location] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
             ...
             * Used for best match union deserialization.
             */
            internal fun validity(): Int = (if (lastLocationUpdateTime.asKnown() == null) 0 else 1) + (if (lastUpdateTime.asKnown() == null) 0 else 1) + (if (vehicleId.asKnown() == null) 0 else 1) + (location.asKnown()?.validity() ?: 0) + (if (occupancyCapacity.asKnown() == null) 0 else 1) + (if (occupancyCount.asKnown() == null) 0 else 1) + (if (occupancyStatus.asKnown() == null) 0 else 1) + (if (phase.asKnown() == null) 0 else 1) + (if (status.asKnown() == null) 0 else 1) + (if (tripId.asKnown() == null) 0 else 1) + (tripStatus.asKnown()?.validity() ?: 0)

            class Location @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
                ...
                override fun equals(other: Any?): Boolean {
                  ...
                  return other is Location && lat == other.lat && lon == other.lon && additionalProperties == other.additionalProperties
                }
                ...
                override fun toString() = "Location{lat=$lat, lon=$lon, additionalProperties=$additionalProperties}"
            }
            ...
            override fun equals(other: Any?): Boolean {
              ...
              return other is List && lastLocationUpdateTime == other.lastLocationUpdateTime && lastUpdateTime == other.lastUpdateTime && vehicleId == other.vehicleId && location == other.location && occupancyCapacity == other.occupancyCapacity && occupancyCount == other.occupancyCount && occupancyStatus == other.occupancyStatus && phase == other.phase && status == other.status && tripId == other.tripId && tripStatus == other.tripStatus && additionalProperties == other.additionalProperties
            }

            private val hashCode: Int by lazy { Objects.hash(lastLocationUpdateTime, lastUpdateTime, vehicleId, location, occupancyCapacity, occupancyCount, occupancyStatus, phase, status, tripId, tripStatus, additionalProperties) }

            override fun hashCode(): Int = hashCode

            override fun toString() = "List{lastLocationUpdateTime=$lastLocationUpdateTime, lastUpdateTime=$lastUpdateTime, vehicleId=$vehicleId, location=$location, occupancyCapacity=$occupancyCapacity, occupancyCount=$occupancyCount, occupancyStatus=$occupancyStatus, phase=$phase, status=$status, tripId=$tripId, tripStatus=$tripStatus, additionalProperties=$additionalProperties}"
        }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is VehiclesForAgencyListResponse && code == other.code && currentTime == other.currentTime && text == other.text && version == other.version && data == other.data && additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() = "VehiclesForAgencyListResponse{code=$code, currentTime=$currentTime, text=$text, version=$version, data=$data, additionalProperties=$additionalProperties}"
}
