...
class VehiclesForAgencyListParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(vehiclesForAgencyListParams: VehiclesForAgencyListParams) =
            apply {
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is VehiclesForAgencyListParams && agencyId == other.agencyId && time == other.time && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(agencyId, time, additionalHeaders, additionalQueryParams)

    override fun toString() = "VehiclesForAgencyListParams{agencyId=$agencyId, time=$time, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
