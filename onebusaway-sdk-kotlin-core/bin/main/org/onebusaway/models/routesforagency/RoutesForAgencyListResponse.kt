...
class RoutesForAgencyListResponse @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [RoutesForAgencyListResponse].
         *
    ...
    /** A builder for [RoutesForAgencyListResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(routesForAgencyListResponse: RoutesForAgencyListResponse) =
            apply {
                code = routesForAgencyListResponse.code
                currentTime = routesForAgencyListResponse.currentTime
                text = routesForAgencyListResponse.text
                version = routesForAgencyListResponse.version
                data = routesForAgencyListResponse.data
                additionalProperties = routesForAgencyListResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [RoutesForAgencyListResponse].
         *
         ...
         */
        fun build(): RoutesForAgencyListResponse =
     ...
     *   expected type.
     */
    fun validate(): RoutesForAgencyListResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    class Data @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
        ...
        class List @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
            ...
            override fun equals(other: Any?): Boolean {
              ...
              return other is List && id == other.id && agencyId == other.agencyId && type == other.type && color == other.color && description == other.description && longName == other.longName && nullSafeShortName == other.nullSafeShortName && shortName == other.shortName && textColor == other.textColor && url == other.url && additionalProperties == other.additionalProperties
            }
            ...
            override fun toString() = "List{id=$id, agencyId=$agencyId, type=$type, color=$color, description=$description, longName=$longName, nullSafeShortName=$nullSafeShortName, shortName=$shortName, textColor=$textColor, url=$url, additionalProperties=$additionalProperties}"
        }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is RoutesForAgencyListResponse && code == other.code && currentTime == other.currentTime && text == other.text && version == other.version && data == other.data && additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() = "RoutesForAgencyListResponse{code=$code, currentTime=$currentTime, text=$text, version=$version, data=$data, additionalProperties=$additionalProperties}"
}
