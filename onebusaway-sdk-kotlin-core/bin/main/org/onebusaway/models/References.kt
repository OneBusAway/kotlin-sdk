...
class References @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    ...
    @JsonCreator
    private constructor(
        @JsonProperty("agencies") @ExcludeMissing agencies: JsonField<List<Agency>> = JsonMissing.of(),
        @JsonProperty("routes") @ExcludeMissing routes: JsonField<List<Route>> = JsonMissing.of(),
        @JsonProperty("situations") @ExcludeMissing situations: JsonField<List<Situation>> = JsonMissing.of(),
        @JsonProperty("stops") @ExcludeMissing stops: JsonField<List<Stop>> = JsonMissing.of(),
        @JsonProperty("stopTimes") @ExcludeMissing stopTimes: JsonField<List<StopTime>> = JsonMissing.of(),
    ...
    @ExcludeMissing
    fun _agencies(): JsonField<List<Agency>> = agencies
    ...
    @JsonProperty("routes")
    @ExcludeMissing
    fun _routes(): JsonField<List<Route>> = routes
    ...
    class Builder internal constructor() {
        ...
        internal fun from(references: References) =
            apply {
         ...
         *
         * You should usually call [Builder.agencies] with a well-typed `List<Agency>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun agencies(agencies: JsonField<List<Agency>>) =
            apply {
        ...
        fun addAgency(agency: Agency) =
            apply {
                agencies = (agencies ?: JsonField.of(mutableListOf())).also {
         ...
         *
         * You should usually call [Builder.routes] with a well-typed `List<Route>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun routes(routes: JsonField<List<Route>>) =
            apply {
        ...
        fun addRoute(route: Route) =
            apply {
                routes = (routes ?: JsonField.of(mutableListOf())).also {
         ...
         *
         * You should usually call [Builder.situations] with a well-typed `List<Situation>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun situations(situations: JsonField<List<Situation>>) =
            apply {
         ...
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addSituation(situation: Situation) =
            apply {
                situations = (situations ?: JsonField.of(mutableListOf())).also {
         ...
         *
         * You should usually call [Builder.stops] with a well-typed `List<Stop>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
         ...
         *
         * You should usually call [Builder.stopTimes] with a well-typed `List<StopTime>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
         ...
         *
         * You should usually call [Builder.trips] with a well-typed `List<Trip>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
     ...
     */
    internal fun validity(): Int = (agencies.asKnown()?.sumOf { it.validity().toInt() } ?: 0) + (routes.asKnown()?.sumOf { it.validity().toInt() } ?: 0) + (situations.asKnown()?.sumOf { it.validity().toInt() } ?: 0) + (stops.asKnown()?.sumOf { it.validity().toInt() } ?: 0) + (stopTimes.asKnown()?.sumOf { it.validity().toInt() } ?: 0) + (trips.asKnown()?.sumOf { it.validity().toInt() } ?: 0)

    class Agency @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
        ...
        private constructor(
            ...
            @JsonProperty("disclaimer") @ExcludeMissing disclaimer: JsonField<String> = JsonMissing.of(),
            ...
            @JsonProperty("privateService") @ExcludeMissing privateService: JsonField<Boolean> = JsonMissing.of()
        ) : this(
          id,
          name,
          timezone,
        ...
        @ExcludeMissing
        fun _fareUrl(): JsonField<String> = fareUrl
        ...
        @JsonProperty("lang")
        @ExcludeMissing
        fun _lang(): JsonField<String> = lang
         ...
         *
         * Unlike [privateService], this method doesn't throw if the JSON field has an unexpected type.
         */
        ...
        class Builder internal constructor() {
            ...
            internal fun from(agency: Agency) =
                apply {
                    id = agency.id
                    name = agency.name
             ...
             *
             * You should usually call [Builder.timezone] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
             ...
             *
             * You should usually call [Builder.disclaimer] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun disclaimer(disclaimer: JsonField<String>) =
                apply {
             ...
             *
             * You should usually call [Builder.fareUrl] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun fareUrl(fareUrl: JsonField<String>) =
                apply {
             ...
             *
             * You should usually call [Builder.lang] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun lang(lang: JsonField<String>) =
                apply {
                    this.lang = lang
                }
             ...
             *
             * You should usually call [Builder.phone] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
             ...
             *
             * You should usually call [Builder.privateService] with a well-typed [Boolean] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun privateService(privateService: JsonField<Boolean>) =
                apply {
         ...
         * Used for best match union deserialization.
         */
        internal fun validity(): Int = (if (id.asKnown() == null) 0 else 1) + (if (name.asKnown() == null) 0 else 1) + (if (timezone.asKnown() == null) 0 else 1) + (if (url.asKnown() == null) 0 else 1) + (if (disclaimer.asKnown() == null) 0 else 1) + (if (email.asKnown() == null) 0 else 1) + (if (fareUrl.asKnown() == null) 0 else 1) + (if (lang.asKnown() == null) 0 else 1) + (if (phone.asKnown() == null) 0 else 1) + (if (privateService.asKnown() == null) 0 else 1)
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is Agency && id == other.id && name == other.name && timezone == other.timezone && url == other.url && disclaimer == other.disclaimer && email == other.email && fareUrl == other.fareUrl && lang == other.lang && phone == other.phone && privateService == other.privateService && additionalProperties == other.additionalProperties
        }
        ...
        override fun toString() = "Agency{id=$id, name=$name, timezone=$timezone, url=$url, disclaimer=$disclaimer, email=$email, fareUrl=$fareUrl, lang=$lang, phone=$phone, privateService=$privateService, additionalProperties=$additionalProperties}"
    }

    class Route @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
        private val id: JsonField<String>,
        ...
        private constructor(
            @JsonProperty("id") @ExcludeMissing id: JsonField<String> = JsonMissing.of(),
            @JsonProperty("agencyId") @ExcludeMissing agencyId: JsonField<String> = JsonMissing.of(),
            ...
            @JsonProperty("longName") @ExcludeMissing longName: JsonField<String> = JsonMissing.of(),
            @JsonProperty("nullSafeShortName") @ExcludeMissing nullSafeShortName: JsonField<String> = JsonMissing.of(),
            @JsonProperty("shortName") @ExcludeMissing shortName: JsonField<String> = JsonMissing.of(),
            @JsonProperty("textColor") @ExcludeMissing textColor: JsonField<String> = JsonMissing.of(),
            @JsonProperty("url") @ExcludeMissing url: JsonField<String> = JsonMissing.of()
        ) : this(
          id,
          agencyId,
        ...
        @ExcludeMissing
        fun _agencyId(): JsonField<String> = agencyId
        ...
        @ExcludeMissing
        fun _longName(): JsonField<String> = longName

        /**
         * Returns the raw JSON value of [nullSafeShortName].
         *
         * Unlike [nullSafeShortName], this method doesn't throw if the JSON field has an unexpected type.
         */
        ...
        class Builder internal constructor() {
             ...
             *
             * You should usually call [Builder.agencyId] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun agencyId(agencyId: JsonField<String>) =
                apply {
             ...
             *
             * You should usually call [Builder.type] with a well-typed [Long] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun type(type: JsonField<Long>) =
                apply {
                    this.type = type
                }
             ...
             *
             * You should usually call [Builder.color] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
             ...
             *
             * You should usually call [Builder.longName] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun longName(longName: JsonField<String>) =
                apply {
             ...
             *
             * You should usually call [Builder.nullSafeShortName] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun nullSafeShortName(nullSafeShortName: JsonField<String>) =
                apply {
             ...
             *
             * You should usually call [Builder.textColor] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun textColor(textColor: JsonField<String>) =
                apply {
         ...
         * Used for best match union deserialization.
         */
        internal fun validity(): Int = (if (id.asKnown() == null) 0 else 1) + (if (agencyId.asKnown() == null) 0 else 1) + (if (type.asKnown() == null) 0 else 1) + (if (color.asKnown() == null) 0 else 1) + (if (description.asKnown() == null) 0 else 1) + (if (longName.asKnown() == null) 0 else 1) + (if (nullSafeShortName.asKnown() == null) 0 else 1) + (if (shortName.asKnown() == null) 0 else 1) + (if (textColor.asKnown() == null) 0 else 1) + (if (url.asKnown() == null) 0 else 1)
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is Route && id == other.id && agencyId == other.agencyId && type == other.type && color == other.color && description == other.description && longName == other.longName && nullSafeShortName == other.nullSafeShortName && shortName == other.shortName && textColor == other.textColor && url == other.url && additionalProperties == other.additionalProperties
        }
        ...
        override fun toString() = "Route{id=$id, agencyId=$agencyId, type=$type, color=$color, description=$description, longName=$longName, nullSafeShortName=$nullSafeShortName, shortName=$shortName, textColor=$textColor, url=$url, additionalProperties=$additionalProperties}"
    }

    class Situation @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
        private val id: JsonField<String>,
        ...
        private constructor(
            @JsonProperty("id") @ExcludeMissing id: JsonField<String> = JsonMissing.of(),
            @JsonProperty("creationTime") @ExcludeMissing creationTime: JsonField<Long> = JsonMissing.of(),
            @JsonProperty("activeWindows") @ExcludeMissing activeWindows: JsonField<List<ActiveWindow>> = JsonMissing.of(),
            @JsonProperty("allAffects") @ExcludeMissing allAffects: JsonField<List<AllAffect>> = JsonMissing.of(),
            @JsonProperty("consequenceMessage") @ExcludeMissing consequenceMessage: JsonField<String> = JsonMissing.of(),
            @JsonProperty("consequences") @ExcludeMissing consequences: JsonField<List<Consequence>> = JsonMissing.of(),
            @JsonProperty("description") @ExcludeMissing description: JsonField<Description> = JsonMissing.of(),
            @JsonProperty("publicationWindows") @ExcludeMissing publicationWindows: JsonField<List<PublicationWindow>> = JsonMissing.of(),
        ...
        /** @throws OnebusawaySdkInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value). */
        fun publicationWindows(): List<PublicationWindow>? = publicationWindows.getNullable("publicationWindows")
         ...
         *
         * Unlike [creationTime], this method doesn't throw if the JSON field has an unexpected type.
         */
         ...
         *
         * Unlike [activeWindows], this method doesn't throw if the JSON field has an unexpected type.
         */
         ...
         *
         * Unlike [consequenceMessage], this method doesn't throw if the JSON field has an unexpected type.
         */
         ...
         *
         * Unlike [consequences], this method doesn't throw if the JSON field has an unexpected type.
         */
         ...
         *
         * Unlike [publicationWindows], this method doesn't throw if the JSON field has an unexpected type.
         */
        ...
        @ExcludeMissing
        fun _summary(): JsonField<Summary> = summary
        ...
        class Builder internal constructor() {
            ...
            internal fun from(situation: Situation) =
                apply {
                    id = situation.id
             ...
             *
             * You should usually call [Builder.creationTime] with a well-typed [Long] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun creationTime(creationTime: JsonField<Long>) =
                apply {
             ...
             *
             * You should usually call [Builder.activeWindows] with a well-typed `List<ActiveWindow>` value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun activeWindows(activeWindows: JsonField<List<ActiveWindow>>) =
                apply {
             ...
             * @throws IllegalStateException if the field was previously set to a non-list.
             */
            fun addActiveWindow(activeWindow: ActiveWindow) =
                apply {
                    activeWindows = (activeWindows ?: JsonField.of(mutableListOf())).also {
             ...
             *
             * You should usually call [Builder.allAffects] with a well-typed `List<AllAffect>` value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun allAffects(allAffects: JsonField<List<AllAffect>>) =
                apply {
             ...
             * @throws IllegalStateException if the field was previously set to a non-list.
             */
            fun addAllAffect(allAffect: AllAffect) =
                apply {
                    allAffects = (allAffects ?: JsonField.of(mutableListOf())).also {
             ...
             *
             * You should usually call [Builder.consequenceMessage] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun consequenceMessage(consequenceMessage: JsonField<String>) =
                apply {
             ...
             *
             * You should usually call [Builder.consequences] with a well-typed `List<Consequence>` value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun consequences(consequences: JsonField<List<Consequence>>) =
                apply {
            ...
            fun addConsequence(consequence: Consequence) =
                apply {
                    consequences = (consequences ?: JsonField.of(mutableListOf())).also {
             ...
             * Sets [Builder.description] to an arbitrary JSON value.
             *
             * You should usually call [Builder.description] with a well-typed [Description] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun description(description: JsonField<Description>) =
                apply {
                    this.description = description
                }
             ...
             *
             * You should usually call [Builder.publicationWindows] with a well-typed `List<PublicationWindow>` value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
             ...
             * @throws IllegalStateException if the field was previously set to a non-list.
             */
            fun addPublicationWindow(publicationWindow: PublicationWindow) =
                apply {
                    publicationWindows = (publicationWindows ?: JsonField.of(mutableListOf())).also {
             ...
             *
             * You should usually call [Builder.summary] with a well-typed [Summary] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun summary(summary: JsonField<Summary>) =
                apply {
             ...
             * Sets [Builder.url] to an arbitrary JSON value.
             *
             * You should usually call [Builder.url] with a well-typed [Url] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun url(url: JsonField<Url>) =
                apply {
                    this.url = url
                }
         ...
         * Used for best match union deserialization.
         */
        internal fun validity(): Int = (if (id.asKnown() == null) 0 else 1) + (if (creationTime.asKnown() == null) 0 else 1) + (activeWindows.asKnown()?.sumOf { it.validity().toInt() } ?: 0) + (allAffects.asKnown()?.sumOf { it.validity().toInt() } ?: 0) + (if (consequenceMessage.asKnown() == null) 0 else 1) + (consequences.asKnown()?.sumOf { it.validity().toInt() } ?: 0) + (description.asKnown()?.validity() ?: 0) + (publicationWindows.asKnown()?.sumOf { it.validity().toInt() } ?: 0) + (if (reason.asKnown() == null) 0 else 1) + (if (severity.asKnown() == null) 0 else 1) + (summary.asKnown()?.validity() ?: 0) + (url.asKnown()?.validity() ?: 0)

        class ActiveWindow @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
            ...
            class Builder internal constructor() {
                ...
                internal fun from(activeWindow: ActiveWindow) =
                    apply {
                 ...
                 *
                 * You should usually call [Builder.from] with a well-typed [Long] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun from(from: JsonField<Long>) =
                    apply {
                        this.from = from
                    }
                 ...
                 *
                 * You should usually call [Builder.to] with a well-typed [Long] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun to(to: JsonField<Long>) =
                    apply {
                        this.to = to
                    }
             ...
             * Used for best match union deserialization.
             */
            internal fun validity(): Int = (if (from.asKnown() == null) 0 else 1) + (if (to.asKnown() == null) 0 else 1)
            ...
            override fun equals(other: Any?): Boolean {
              ...
              return other is ActiveWindow && from == other.from && to == other.to && additionalProperties == other.additionalProperties
            }
        ...
        class AllAffect @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
            private val agencyId: JsonField<String>,
            ...
            private constructor(
                @JsonProperty("agencyId") @ExcludeMissing agencyId: JsonField<String> = JsonMissing.of(),
                @JsonProperty("applicationId") @ExcludeMissing applicationId: JsonField<String> = JsonMissing.of(),
                @JsonProperty("directionId") @ExcludeMissing directionId: JsonField<String> = JsonMissing.of(),
            ...
            class Builder internal constructor() {
                ...
                internal fun from(allAffect: AllAffect) =
                    apply {
                 ...
                 *
                 * You should usually call [Builder.applicationId] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun applicationId(applicationId: JsonField<String>) =
                    apply {
                 ...
                 *
                 * You should usually call [Builder.directionId] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
             ...
             * Used for best match union deserialization.
             */
            internal fun validity(): Int = (if (agencyId.asKnown() == null) 0 else 1) + (if (applicationId.asKnown() == null) 0 else 1) + (if (directionId.asKnown() == null) 0 else 1) + (if (routeId.asKnown() == null) 0 else 1) + (if (stopId.asKnown() == null) 0 else 1) + (if (tripId.asKnown() == null) 0 else 1)
            ...
            override fun equals(other: Any?): Boolean {
              ...
              return other is AllAffect && agencyId == other.agencyId && applicationId == other.applicationId && directionId == other.directionId && routeId == other.routeId && stopId == other.stopId && tripId == other.tripId && additionalProperties == other.additionalProperties
            }
        ...
        class Consequence @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
            ...
            private constructor(
                ...
                @JsonProperty("conditionDetails") @ExcludeMissing conditionDetails: JsonField<ConditionDetails> = JsonMissing.of()
            ) : this(
              condition,
              conditionDetails,
              mutableMapOf(),
            ...
            /** @throws OnebusawaySdkInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value). */
            fun conditionDetails(): ConditionDetails? = conditionDetails.getNullable("conditionDetails")
             ...
             *
             * Unlike [conditionDetails], this method doesn't throw if the JSON field has an unexpected type.
             */
            ...
            class Builder internal constructor() {
                ...
                internal fun from(consequence: Consequence) =
                    apply {
                 ...
                 *
                 * You should usually call [Builder.conditionDetails] with a well-typed [ConditionDetails] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
             ...
             * Used for best match union deserialization.
             */
            internal fun validity(): Int = (if (condition.asKnown() == null) 0 else 1) + (conditionDetails.asKnown()?.validity() ?: 0)

            class ConditionDetails @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
                ...
                @JsonCreator
                private constructor(
                    @JsonProperty("diversionPath") @ExcludeMissing diversionPath: JsonField<DiversionPath> = JsonMissing.of(),
                    @JsonProperty("diversionStopIds") @ExcludeMissing diversionStopIds: JsonField<List<String>> = JsonMissing.of()
                ) : this(
                  diversionPath,
                  diversionStopIds,
                  mutableMapOf(),
                ...
                /** @throws OnebusawaySdkInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value). */
                fun diversionStopIds(): List<String>? = diversionStopIds.getNullable("diversionStopIds")

                /**
                 * Returns the raw JSON value of [diversionPath].
                 *
                 * Unlike [diversionPath], this method doesn't throw if the JSON field has an unexpected type.
                 */
                 ...
                 *
                 * Unlike [diversionStopIds], this method doesn't throw if the JSON field has an unexpected type.
                 */
                ...
                class Builder internal constructor() {
                    ...
                    internal fun from(conditionDetails: ConditionDetails) =
                        apply {
                            diversionPath = conditionDetails.diversionPath
                            diversionStopIds = conditionDetails.diversionStopIds.map { it.toMutableList() }
                     ...
                     *
                     * You should usually call [Builder.diversionPath] with a well-typed [DiversionPath] value instead. This method is primarily for setting the field to an undocumented or not yet
                     * supported value.
                     */
                    fun diversionPath(diversionPath: JsonField<DiversionPath>) =
                        apply {
                     ...
                     *
                     * You should usually call [Builder.diversionStopIds] with a well-typed `List<String>` value instead. This method is primarily for setting the field to an undocumented or not yet
                     * supported value.
                     */
                     ...
                     * @throws IllegalStateException if the field was previously set to a non-list.
                     */
                    fun addDiversionStopId(diversionStopId: String) =
                        apply {
                            diversionStopIds = (diversionStopIds ?: JsonField.of(mutableListOf())).also {
                 ...
                 * Used for best match union deserialization.
                 */
                internal fun validity(): Int = (diversionPath.asKnown()?.validity() ?: 0) + (diversionStopIds.asKnown()?.size ?: 0)

                class DiversionPath @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
                    ...
                    private constructor(
                        ...
                        @JsonProperty("points") @ExcludeMissing points: JsonField<String> = JsonMissing.of()
                    ) : this(
                      length,
                      levels,
                      points,
                    ...
                    companion object {
                        ...
                        /** Returns a mutable builder for constructing an instance of [DiversionPath]. */
                        fun builder() = Builder()
                    }
                    ...
                    class Builder internal constructor() {
                        ...
                        internal fun from(diversionPath: DiversionPath) =
                            apply {
                         ...
                         *
                         * You should usually call [Builder.length] with a well-typed [Long] value instead. This method is primarily for setting the field to an undocumented or not yet
                         * supported value.
                         */
                        fun length(length: JsonField<Long>) =
                            apply {
                                this.length = length
                            }
                         ...
                         *
                         * You should usually call [Builder.levels] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
                         * supported value.
                         */
                        fun levels(levels: JsonField<String>) =
                            apply {
                                this.levels = levels
                            }
                         ...
                         *
                         * You should usually call [Builder.points] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
                         * supported value.
                         */
                        fun points(points: JsonField<String>) =
                            apply {
                                this.points = points
                            }
                     ...
                     * Used for best match union deserialization.
                     */
                    internal fun validity(): Int = (if (length.asKnown() == null) 0 else 1) + (if (levels.asKnown() == null) 0 else 1) + (if (points.asKnown() == null) 0 else 1)
                    ...
                    override fun equals(other: Any?): Boolean {
                      ...
                      return other is DiversionPath && length == other.length && levels == other.levels && points == other.points && additionalProperties == other.additionalProperties
                    }
                ...
                override fun equals(other: Any?): Boolean {
                  ...
                  return other is ConditionDetails && diversionPath == other.diversionPath && diversionStopIds == other.diversionStopIds && additionalProperties == other.additionalProperties
                }
            ...
            override fun equals(other: Any?): Boolean {
              ...
              return other is Consequence && condition == other.condition && conditionDetails == other.conditionDetails && additionalProperties == other.additionalProperties
            }
        ...
        class Description @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
            private val lang: JsonField<String>,
            ...
            class Builder internal constructor() {
                ...
                internal fun from(description: Description) =
                    apply {
             ...
             * Used for best match union deserialization.
             */
            internal fun validity(): Int = (if (lang.asKnown() == null) 0 else 1) + (if (value.asKnown() == null) 0 else 1)
            ...
            override fun equals(other: Any?): Boolean {
              ...
              return other is Description && lang == other.lang && value == other.value && additionalProperties == other.additionalProperties
            }
        ...
        class PublicationWindow @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
            private val from: JsonField<Long>,
            private val to: JsonField<Long>,
            private val additionalProperties: MutableMap<String, JsonValue>,
            ...
            class Builder internal constructor() {
                ...
                internal fun from(publicationWindow: PublicationWindow) =
                    apply {
             ...
             *   expected type.
             */
            fun validate(): PublicationWindow =
                apply {
                    if (validated) {
                      return@apply
                    }
            ...
            override fun equals(other: Any?): Boolean {
              ...
              return other is PublicationWindow && from == other.from && to == other.to && additionalProperties == other.additionalProperties
            }
        ...
        class Summary @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
            private val lang: JsonField<String>,
            private val value: JsonField<String>,
            private val additionalProperties: MutableMap<String, JsonValue>,
            ...
            class Builder internal constructor() {
                ...
                internal fun from(summary: Summary) =
                    apply {
                        lang = summary.lang
                        value = summary.value
            ...
            override fun equals(other: Any?): Boolean {
              ...
              return other is Summary && lang == other.lang && value == other.value && additionalProperties == other.additionalProperties
            }
        ...
        class Url @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
            private val lang: JsonField<String>,
            private val value: JsonField<String>,
            private val additionalProperties: MutableMap<String, JsonValue>,
            ...
            override fun equals(other: Any?): Boolean {
              ...
              return other is Url && lang == other.lang && value == other.value && additionalProperties == other.additionalProperties
            }
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is Situation && id == other.id && creationTime == other.creationTime && activeWindows == other.activeWindows && allAffects == other.allAffects && consequenceMessage == other.consequenceMessage && consequences == other.consequences && description == other.description && publicationWindows == other.publicationWindows && reason == other.reason && severity == other.severity && summary == other.summary && url == other.url && additionalProperties == other.additionalProperties
        }
    ...
    class Stop @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
        ...
        private constructor(
            ...
            @JsonProperty("locationType") @ExcludeMissing locationType: JsonField<Long> = JsonMissing.of(),
            @JsonProperty("lon") @ExcludeMissing lon: JsonField<Double> = JsonMissing.of(),
            @JsonProperty("name") @ExcludeMissing name: JsonField<String> = JsonMissing.of(),
            @JsonProperty("parent") @ExcludeMissing parent: JsonField<String> = JsonMissing.of(),
            @JsonProperty("routeIds") @ExcludeMissing routeIds: JsonField<List<String>> = JsonMissing.of(),
            @JsonProperty("staticRouteIds") @ExcludeMissing staticRouteIds: JsonField<List<String>> = JsonMissing.of(),
            @JsonProperty("code") @ExcludeMissing code: JsonField<String> = JsonMissing.of(),
            @JsonProperty("direction") @ExcludeMissing direction: JsonField<String> = JsonMissing.of(),
            @JsonProperty("wheelchairBoarding") @ExcludeMissing wheelchairBoarding: JsonField<String> = JsonMissing.of()
        ) : this(
          id,
          lat,
          locationType,
         ...
         *
         * Unlike [staticRouteIds], this method doesn't throw if the JSON field has an unexpected type.
         */
         ...
         *
         * Unlike [wheelchairBoarding], this method doesn't throw if the JSON field has an unexpected type.
         */
        ...
        class Builder internal constructor() {
             ...
             *
             * You should usually call [Builder.locationType] with a well-typed [Long] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
             ...
             *
             * You should usually call [Builder.parent] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
             ...
             *
             * You should usually call [Builder.routeIds] with a well-typed `List<String>` value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
             ...
             *
             * You should usually call [Builder.staticRouteIds] with a well-typed `List<String>` value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
             ...
             *
             * You should usually call [Builder.wheelchairBoarding] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
         ...
         * Used for best match union deserialization.
         */
        internal fun validity(): Int = (if (id.asKnown() == null) 0 else 1) + (if (lat.asKnown() == null) 0 else 1) + (if (locationType.asKnown() == null) 0 else 1) + (if (lon.asKnown() == null) 0 else 1) + (if (name.asKnown() == null) 0 else 1) + (if (parent.asKnown() == null) 0 else 1) + (routeIds.asKnown()?.size ?: 0) + (staticRouteIds.asKnown()?.size ?: 0) + (if (code.asKnown() == null) 0 else 1) + (if (direction.asKnown() == null) 0 else 1) + (if (wheelchairBoarding.asKnown() == null) 0 else 1)
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is Stop && id == other.id && lat == other.lat && locationType == other.locationType && lon == other.lon && name == other.name && parent == other.parent && routeIds == other.routeIds && staticRouteIds == other.staticRouteIds && code == other.code && direction == other.direction && wheelchairBoarding == other.wheelchairBoarding && additionalProperties == other.additionalProperties
        }
        ...
        override fun toString() = "Stop{id=$id, lat=$lat, locationType=$locationType, lon=$lon, name=$name, parent=$parent, routeIds=$routeIds, staticRouteIds=$staticRouteIds, code=$code, direction=$direction, wheelchairBoarding=$wheelchairBoarding, additionalProperties=$additionalProperties}"
    }

    class StopTime @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
        ...
        @JsonCreator
        private constructor(
            @JsonProperty("arrivalTime") @ExcludeMissing arrivalTime: JsonField<Long> = JsonMissing.of(),
            @JsonProperty("departureTime") @ExcludeMissing departureTime: JsonField<Long> = JsonMissing.of(),
            ...
            @JsonProperty("stopHeadsign") @ExcludeMissing stopHeadsign: JsonField<String> = JsonMissing.of(),
            @JsonProperty("stopId") @ExcludeMissing stopId: JsonField<String> = JsonMissing.of()
        ) : this(
          arrivalTime,
          departureTime,
         ...
         *
         * Unlike [stopHeadsign], this method doesn't throw if the JSON field has an unexpected type.
         */
        ...
        class Builder internal constructor() {
             ...
             *
             * You should usually call [Builder.arrivalTime] with a well-typed [Long] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
             ...
             *
             * You should usually call [Builder.departureTime] with a well-typed [Long] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
             ...
             *
             * You should usually call [Builder.stopHeadsign] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
         ...
         * Used for best match union deserialization.
         */
        internal fun validity(): Int = (if (arrivalTime.asKnown() == null) 0 else 1) + (if (departureTime.asKnown() == null) 0 else 1) + (if (distanceAlongTrip.asKnown() == null) 0 else 1) + (if (historicalOccupancy.asKnown() == null) 0 else 1) + (if (stopHeadsign.asKnown() == null) 0 else 1) + (if (stopId.asKnown() == null) 0 else 1)
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is StopTime && arrivalTime == other.arrivalTime && departureTime == other.departureTime && distanceAlongTrip == other.distanceAlongTrip && historicalOccupancy == other.historicalOccupancy && stopHeadsign == other.stopHeadsign && stopId == other.stopId && additionalProperties == other.additionalProperties
        }
    ...
    class Trip @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
        private val id: JsonField<String>,
        private val routeId: JsonField<String>,
        ...
        private constructor(
            @JsonProperty("id") @ExcludeMissing id: JsonField<String> = JsonMissing.of(),
            @JsonProperty("routeId") @ExcludeMissing routeId: JsonField<String> = JsonMissing.of(),
            @JsonProperty("serviceId") @ExcludeMissing serviceId: JsonField<String> = JsonMissing.of(),
            @JsonProperty("blockId") @ExcludeMissing blockId: JsonField<String> = JsonMissing.of(),
            @JsonProperty("directionId") @ExcludeMissing directionId: JsonField<String> = JsonMissing.of(),
            @JsonProperty("peakOffpeak") @ExcludeMissing peakOffpeak: JsonField<Long> = JsonMissing.of(),
            ...
            @JsonProperty("tripShortName") @ExcludeMissing tripShortName: JsonField<String> = JsonMissing.of()
        ) : this(
          id,
          routeId,
          serviceId,
         ...
         *
         * Unlike [tripShortName], this method doesn't throw if the JSON field has an unexpected type.
         */
        ...
        class Builder internal constructor() {
             ...
             *
             * You should usually call [Builder.serviceId] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
             ...
             *
             * You should usually call [Builder.blockId] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
             ...
             *
             * You should usually call [Builder.peakOffpeak] with a well-typed [Long] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
             ...
             *
             * You should usually call [Builder.shapeId] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
             ...
             *
             * You should usually call [Builder.tripShortName] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
         ...
         * Used for best match union deserialization.
         */
        internal fun validity(): Int = (if (id.asKnown() == null) 0 else 1) + (if (routeId.asKnown() == null) 0 else 1) + (if (serviceId.asKnown() == null) 0 else 1) + (if (blockId.asKnown() == null) 0 else 1) + (if (directionId.asKnown() == null) 0 else 1) + (if (peakOffpeak.asKnown() == null) 0 else 1) + (if (routeShortName.asKnown() == null) 0 else 1) + (if (shapeId.asKnown() == null) 0 else 1) + (if (timeZone.asKnown() == null) 0 else 1) + (if (tripHeadsign.asKnown() == null) 0 else 1) + (if (tripShortName.asKnown() == null) 0 else 1)
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is Trip && id == other.id && routeId == other.routeId && serviceId == other.serviceId && blockId == other.blockId && directionId == other.directionId && peakOffpeak == other.peakOffpeak && routeShortName == other.routeShortName && shapeId == other.shapeId && timeZone == other.timeZone && tripHeadsign == other.tripHeadsign && tripShortName == other.tripShortName && additionalProperties == other.additionalProperties
        }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is References && agencies == other.agencies && routes == other.routes && situations == other.situations && stops == other.stops && stopTimes == other.stopTimes && trips == other.trips && additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() = "References{agencies=$agencies, routes=$routes, situations=$situations, stops=$stops, stopTimes=$stopTimes, trips=$trips, additionalProperties=$additionalProperties}"
}
