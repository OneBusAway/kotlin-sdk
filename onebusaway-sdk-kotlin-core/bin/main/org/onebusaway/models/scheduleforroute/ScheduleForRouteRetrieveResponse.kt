...
class ScheduleForRouteRetrieveResponse @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    ...
    class Data @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
         ...
         * Used for best match union deserialization.
         */
        internal fun validity(): Int = (entry.asKnown()?.validity() ?: 0)
        ...
        class Entry @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
            ...
            private constructor(
                ...
                @JsonProperty("scheduleDate") @ExcludeMissing scheduleDate: JsonField<Long> = JsonMissing.of(),
                @JsonProperty("serviceIds") @ExcludeMissing serviceIds: JsonField<List<String>> = JsonMissing.of(),
                @JsonProperty("stopTripGroupings") @ExcludeMissing stopTripGroupings: JsonField<List<StopTripGrouping>> = JsonMissing.of()
            ) : this(
              routeId,
              scheduleDate,
              serviceIds,
             ...
             *
             * Unlike [scheduleDate], this method doesn't throw if the JSON field has an unexpected type.
             */
             ...
             *
             * Unlike [serviceIds], this method doesn't throw if the JSON field has an unexpected type.
             */
             ...
             *
             * Unlike [stopTripGroupings], this method doesn't throw if the JSON field has an unexpected type.
             */
            ...
            class Builder internal constructor() {
                 ...
                 *
                 * You should usually call [Builder.scheduleDate] with a well-typed [Long] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                 ...
                 *
                 * You should usually call [Builder.serviceIds] with a well-typed `List<String>` value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                 ...
                 *
                 * You should usually call [Builder.stopTripGroupings] with a well-typed `List<StopTripGrouping>` value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
             ...
             * Used for best match union deserialization.
             */
            internal fun validity(): Int = (if (routeId.asKnown() == null) 0 else 1) + (if (scheduleDate.asKnown() == null) 0 else 1) + (serviceIds.asKnown()?.size ?: 0) + (stopTripGroupings.asKnown()?.sumOf { it.validity().toInt() } ?: 0)

            class StopTripGrouping @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
                ...
                private constructor(
                    ...
                    @JsonProperty("tripHeadsigns") @ExcludeMissing tripHeadsigns: JsonField<List<String>> = JsonMissing.of(),
                    @JsonProperty("tripIds") @ExcludeMissing tripIds: JsonField<List<String>> = JsonMissing.of(),
                    @JsonProperty("tripsWithStopTimes") @ExcludeMissing tripsWithStopTimes: JsonField<List<TripsWithStopTime>> = JsonMissing.of()
                ) : this(
                  directionId,
                  stopIds,
                  tripHeadsigns,
                 ...
                 *
                 * Unlike [tripHeadsigns], this method doesn't throw if the JSON field has an unexpected type.
                 */
                 ...
                 *
                 * Unlike [tripIds], this method doesn't throw if the JSON field has an unexpected type.
                 */
                 ...
                 *
                 * Unlike [tripsWithStopTimes], this method doesn't throw if the JSON field has an unexpected type.
                 */
                ...
                class Builder internal constructor() {
                     ...
                     *
                     * You should usually call [Builder.tripHeadsigns] with a well-typed `List<String>` value instead. This method is primarily for setting the field to an undocumented or not yet
                     * supported value.
                     */
                     ...
                     *
                     * You should usually call [Builder.tripIds] with a well-typed `List<String>` value instead. This method is primarily for setting the field to an undocumented or not yet
                     * supported value.
                     */
                     ...
                     *
                     * You should usually call [Builder.tripsWithStopTimes] with a well-typed `List<TripsWithStopTime>` value instead. This method is primarily for setting the field to an undocumented or not yet
                     * supported value.
                     */
                 ...
                 * Used for best match union deserialization.
                 */
                internal fun validity(): Int = (if (directionId.asKnown() == null) 0 else 1) + (stopIds.asKnown()?.size ?: 0) + (tripHeadsigns.asKnown()?.size ?: 0) + (tripIds.asKnown()?.size ?: 0) + (tripsWithStopTimes.asKnown()?.sumOf { it.validity().toInt() } ?: 0)

                class TripsWithStopTime @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
                     ...
                     * Used for best match union deserialization.
                     */
                    internal fun validity(): Int = (stopTimes.asKnown()?.sumOf { it.validity().toInt() } ?: 0) + (if (tripId.asKnown() == null) 0 else 1)
                    ...
                    class StopTime @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
                        ...
                        /** @throws OnebusawaySdkInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value). */
                        fun serviceId(): String? = serviceId.getNullable("serviceId")
                         ...
                         * Used for best match union deserialization.
                         */
                        internal fun validity(): Int = (if (arrivalEnabled.asKnown() == null) 0 else 1) + (if (arrivalTime.asKnown() == null) 0 else 1) + (if (departureEnabled.asKnown() == null) 0 else 1) + (if (departureTime.asKnown() == null) 0 else 1) + (if (stopId.asKnown() == null) 0 else 1) + (if (tripId.asKnown() == null) 0 else 1) + (if (serviceId.asKnown() == null) 0 else 1) + (if (stopHeadsign.asKnown() == null) 0 else 1)
                    ...
                    override fun equals(other: Any?): Boolean {
                      ...
                      return other is TripsWithStopTime && stopTimes == other.stopTimes && tripId == other.tripId && additionalProperties == other.additionalProperties
                    }
                ...
                override fun equals(other: Any?): Boolean {
                  ...
                  return other is StopTripGrouping && directionId == other.directionId && stopIds == other.stopIds && tripHeadsigns == other.tripHeadsigns && tripIds == other.tripIds && tripsWithStopTimes == other.tripsWithStopTimes && additionalProperties == other.additionalProperties
                }
            ...
            override fun equals(other: Any?): Boolean {
              ...
              return other is Entry && routeId == other.routeId && scheduleDate == other.scheduleDate && serviceIds == other.serviceIds && stopTripGroupings == other.stopTripGroupings && additionalProperties == other.additionalProperties
            }

            private val hashCode: Int by lazy { Objects.hash(routeId, scheduleDate, serviceIds, stopTripGroupings, additionalProperties) }

            override fun hashCode(): Int = hashCode

            override fun toString() = "Entry{routeId=$routeId, scheduleDate=$scheduleDate, serviceIds=$serviceIds, stopTripGroupings=$stopTripGroupings, additionalProperties=$additionalProperties}"
        }
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is Data && entry == other.entry && additionalProperties == other.additionalProperties
        }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is ScheduleForRouteRetrieveResponse && code == other.code && currentTime == other.currentTime && text == other.text && version == other.version && data == other.data && additionalProperties == other.additionalProperties
    }
