...
/** stops-for-location */
class StopsForLocationListParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(stopsForLocationListParams: StopsForLocationListParams) =
            apply {
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is StopsForLocationListParams && lat == other.lat && latSpan == other.latSpan && lon == other.lon && lonSpan == other.lonSpan && query == other.query && radius == other.radius && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(lat, latSpan, lon, lonSpan, query, radius, additionalHeaders, additionalQueryParams)

    override fun toString() = "StopsForLocationListParams{lat=$lat, latSpan=$latSpan, lon=$lon, lonSpan=$lonSpan, query=$query, radius=$radius, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
