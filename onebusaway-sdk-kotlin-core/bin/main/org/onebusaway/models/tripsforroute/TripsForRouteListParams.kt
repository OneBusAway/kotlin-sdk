...
class TripsForRouteListParams private constructor(
    ...
    /** Determine whether full tripStatus elements with real-time information are included. Defaults to false. */
    ...
    class Builder internal constructor() {
        ...
        internal fun from(tripsForRouteListParams: TripsForRouteListParams) =
            apply {
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is TripsForRouteListParams && routeId == other.routeId && includeSchedule == other.includeSchedule && includeStatus == other.includeStatus && time == other.time && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(routeId, includeSchedule, includeStatus, time, additionalHeaders, additionalQueryParams)

    override fun toString() = "TripsForRouteListParams{routeId=$routeId, includeSchedule=$includeSchedule, includeStatus=$includeStatus, time=$time, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
