...
class TripsForRouteListResponse @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [TripsForRouteListResponse].
         *
    ...
    /** A builder for [TripsForRouteListResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(tripsForRouteListResponse: TripsForRouteListResponse) =
            apply {
                code = tripsForRouteListResponse.code
                currentTime = tripsForRouteListResponse.currentTime
                text = tripsForRouteListResponse.text
                version = tripsForRouteListResponse.version
                data = tripsForRouteListResponse.data
                additionalProperties = tripsForRouteListResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [TripsForRouteListResponse].
         *
         ...
         */
        fun build(): TripsForRouteListResponse =
     ...
     *   expected type.
     */
    fun validate(): TripsForRouteListResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    class Data @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
        ...
        class Builder internal constructor() {
             ...
             *
             * You should usually call [Builder.list] with a well-typed `kotlin.collections.List<List>` value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun list(list: JsonField<kotlin.collections.List<List>>) =
                apply {
            ...
            fun addList(list: List) =
                apply {
                    this.list = (this.list ?: JsonField.of(mutableListOf())).also {
         ...
         * Used for best match union deserialization.
         */
        internal fun validity(): Int = (list.asKnown()?.sumOf { it.validity().toInt() } ?: 0) + (references.asKnown()?.validity() ?: 0) + (if (limitExceeded.asKnown() == null) 0 else 1)

        class List @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
            ...
            private constructor(
                ...
                @JsonProperty("situationIds") @ExcludeMissing situationIds: JsonField<kotlin.collections.List<String>> = JsonMissing.of()
            ) : this(
              schedule,
              status,
              tripId,
            ...
            class Builder internal constructor() {
                 ...
                 *
                 * You should usually call [Builder.schedule] with a well-typed [Schedule] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                ...
                fun situationIds(situationIds: kotlin.collections.List<String>) = situationIds(JsonField.of(situationIds))

                /**
                 * Sets [Builder.situationIds] to an arbitrary JSON value.
                 *
                 * You should usually call [Builder.situationIds] with a well-typed `kotlin.collections.List<String>` value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
             ...
             * Used for best match union deserialization.
             */
            internal fun validity(): Int = (schedule.asKnown()?.validity() ?: 0) + (status.asKnown()?.validity() ?: 0) + (if (tripId.asKnown() == null) 0 else 1) + (if (frequency.asKnown() == null) 0 else 1) + (if (serviceDate.asKnown() == null) 0 else 1) + (situationIds.asKnown()?.size ?: 0)

            class Schedule @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
                ...
                @JsonCreator
                private constructor(
                    @JsonProperty("nextTripId") @ExcludeMissing nextTripId: JsonField<String> = JsonMissing.of(),
                    @JsonProperty("previousTripId") @ExcludeMissing previousTripId: JsonField<String> = JsonMissing.of(),
                    @JsonProperty("stopTimes") @ExcludeMissing stopTimes: JsonField<kotlin.collections.List<StopTime>> = JsonMissing.of(),
                 ...
                 *
                 * Unlike [nextTripId], this method doesn't throw if the JSON field has an unexpected type.
                 */
                 ...
                 *
                 * Unlike [previousTripId], this method doesn't throw if the JSON field has an unexpected type.
                 */
                ...
                class Builder internal constructor() {
                     ...
                     *
                     * You should usually call [Builder.nextTripId] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
                     * supported value.
                     */
                     ...
                     *
                     * You should usually call [Builder.previousTripId] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
                     * supported value.
                     */
                     ...
                     *
                     * You should usually call [Builder.stopTimes] with a well-typed `kotlin.collections.List<StopTime>` value instead. This method is primarily for setting the field to an undocumented or not yet
                     * supported value.
                     */
                    fun stopTimes(stopTimes: JsonField<kotlin.collections.List<StopTime>>) =
                        apply {
                 ...
                 * Used for best match union deserialization.
                 */
                internal fun validity(): Int = (if (nextTripId.asKnown() == null) 0 else 1) + (if (previousTripId.asKnown() == null) 0 else 1) + (stopTimes.asKnown()?.sumOf { it.validity().toInt() } ?: 0) + (if (timeZone.asKnown() == null) 0 else 1) + (if (frequency.asKnown() == null) 0 else 1)
                ...
                override fun equals(other: Any?): Boolean {
                  ...
                  return other is Schedule && nextTripId == other.nextTripId && previousTripId == other.previousTripId && stopTimes == other.stopTimes && timeZone == other.timeZone && frequency == other.frequency && additionalProperties == other.additionalProperties
                }
            ...
            /** Trip-specific status for the arriving transit vehicle. */
            class Status @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
            ...
            override fun equals(other: Any?): Boolean {
              ...
              return other is List && schedule == other.schedule && status == other.status && tripId == other.tripId && frequency == other.frequency && serviceDate == other.serviceDate && situationIds == other.situationIds && additionalProperties == other.additionalProperties
            }
            ...
            override fun toString() = "List{schedule=$schedule, status=$status, tripId=$tripId, frequency=$frequency, serviceDate=$serviceDate, situationIds=$situationIds, additionalProperties=$additionalProperties}"
        }
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is Data && list == other.list && references == other.references && limitExceeded == other.limitExceeded && additionalProperties == other.additionalProperties
        }

        private val hashCode: Int by lazy { Objects.hash(list, references, limitExceeded, additionalProperties) }

        override fun hashCode(): Int = hashCode

        override fun toString() = "Data{list=$list, references=$references, limitExceeded=$limitExceeded, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is TripsForRouteListResponse && code == other.code && currentTime == other.currentTime && text == other.text && version == other.version && data == other.data && additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() = "TripsForRouteListResponse{code=$code, currentTime=$currentTime, text=$text, version=$version, data=$data, additionalProperties=$additionalProperties}"
}
