...
class ShapeRetrieveResponse @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(shapeRetrieveResponse: ShapeRetrieveResponse) =
            apply {
     ...
     *   expected type.
     */
    fun validate(): ShapeRetrieveResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    class Data @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
        ...
        class Entry @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
             ...
             * Used for best match union deserialization.
             */
            internal fun validity(): Int = (if (length.asKnown() == null) 0 else 1) + (if (points.asKnown() == null) 0 else 1) + (if (levels.asKnown() == null) 0 else 1)
            ...
            override fun equals(other: Any?): Boolean {
              ...
              return other is Entry && length == other.length && points == other.points && levels == other.levels && additionalProperties == other.additionalProperties
            }
            ...
            override fun toString() = "Entry{length=$length, points=$points, levels=$levels, additionalProperties=$additionalProperties}"
        }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is ShapeRetrieveResponse && code == other.code && currentTime == other.currentTime && text == other.text && version == other.version && data == other.data && additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() = "ShapeRetrieveResponse{code=$code, currentTime=$currentTime, text=$text, version=$version, data=$data, additionalProperties=$additionalProperties}"
}
