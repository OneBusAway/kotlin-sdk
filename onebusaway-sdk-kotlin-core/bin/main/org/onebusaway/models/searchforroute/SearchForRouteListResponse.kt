...
class SearchForRouteListResponse @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(searchForRouteListResponse: SearchForRouteListResponse) =
            apply {
        ...
        /**
         * Returns an immutable instance of [SearchForRouteListResponse].
         *
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is SearchForRouteListResponse && code == other.code && currentTime == other.currentTime && text == other.text && version == other.version && data == other.data && additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() = "SearchForRouteListResponse{code=$code, currentTime=$currentTime, text=$text, version=$version, data=$data, additionalProperties=$additionalProperties}"
}
