...
class SearchForRouteListParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(searchForRouteListParams: SearchForRouteListParams) =
            apply {
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is SearchForRouteListParams && input == other.input && maxCount == other.maxCount && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(input, maxCount, additionalHeaders, additionalQueryParams)

    override fun toString() = "SearchForRouteListParams{input=$input, maxCount=$maxCount, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
