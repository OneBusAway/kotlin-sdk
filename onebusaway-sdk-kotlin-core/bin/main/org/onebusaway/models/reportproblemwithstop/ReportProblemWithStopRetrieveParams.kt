...
class ReportProblemWithStopRetrieveParams private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [ReportProblemWithStopRetrieveParams]. */
        fun builder() = Builder()
    }
    ...
    class Builder internal constructor() {
         ...
         * This unboxed primitive overload exists for backwards compatibility.
         */
        fun userLocationAccuracy(userLocationAccuracy: Float) = userLocationAccuracy(userLocationAccuracy as Float?)

        /** The reporting user’s current longitude */
        fun userLon(userLon: Float?) =
            apply {
    ...
    class Code @JsonCreator private constructor(
         ...
         * for the unknown case.
         *
         * @throws OnebusawaySdkInvalidDataException if this class instance's value is a not a known member.
         */
        fun known(): Known =
            when (this) {
         ...
         * doesn't throw.
         *
         * @throws OnebusawaySdkInvalidDataException if this class instance's value does not have the expected
         *   primitive type.
         */
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is ReportProblemWithStopRetrieveParams && stopId == other.stopId && code == other.code && userComment == other.userComment && userLat == other.userLat && userLocationAccuracy == other.userLocationAccuracy && userLon == other.userLon && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(stopId, code, userComment, userLat, userLocationAccuracy, userLon, additionalHeaders, additionalQueryParams)
