...
class AgenciesWithCoverageListResponse @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AgenciesWithCoverageListResponse].
         *
    ...
    class Builder internal constructor() {
        ...
        internal fun from(agenciesWithCoverageListResponse: AgenciesWithCoverageListResponse) =
            apply {
                ...
                additionalProperties = agenciesWithCoverageListResponse.additionalProperties.toMutableMap()
            }
     ...
     *   expected type.
     */
    fun validate(): AgenciesWithCoverageListResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    class Data @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
        ...
        class List @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
            ...
            private constructor(
                ...
                @JsonProperty("latSpan") @ExcludeMissing latSpan: JsonField<Double> = JsonMissing.of(),
                @JsonProperty("lon") @ExcludeMissing lon: JsonField<Double> = JsonMissing.of(),
                @JsonProperty("lonSpan") @ExcludeMissing lonSpan: JsonField<Double> = JsonMissing.of()
            ) : this(
              agencyId,
              lat,
              latSpan,
            ...
            @ExcludeMissing
            fun _latSpan(): JsonField<Double> = latSpan
            ...
            @ExcludeMissing
            fun _lonSpan(): JsonField<Double> = lonSpan
            ...
            class Builder internal constructor() {
                 ...
                 *
                 * You should usually call [Builder.latSpan] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun latSpan(latSpan: JsonField<Double>) =
                    apply {
                 ...
                 *
                 * You should usually call [Builder.lonSpan] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun lonSpan(lonSpan: JsonField<Double>) =
                    apply {
             ...
             * Used for best match union deserialization.
             */
            internal fun validity(): Int = (if (agencyId.asKnown() == null) 0 else 1) + (if (lat.asKnown() == null) 0 else 1) + (if (latSpan.asKnown() == null) 0 else 1) + (if (lon.asKnown() == null) 0 else 1) + (if (lonSpan.asKnown() == null) 0 else 1)
            ...
            override fun equals(other: Any?): Boolean {
              ...
              return other is List && agencyId == other.agencyId && lat == other.lat && latSpan == other.latSpan && lon == other.lon && lonSpan == other.lonSpan && additionalProperties == other.additionalProperties
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is AgenciesWithCoverageListResponse && code == other.code && currentTime == other.currentTime && text == other.text && version == other.version && data == other.data && additionalProperties == other.additionalProperties
    }
