...
class SearchForStopListParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(searchForStopListParams: SearchForStopListParams) =
            apply {
        ...
        /**
         * Returns an immutable instance of [SearchForStopListParams].
         *
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is SearchForStopListParams && input == other.input && maxCount == other.maxCount && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(input, maxCount, additionalHeaders, additionalQueryParams)

    override fun toString() = "SearchForStopListParams{input=$input, maxCount=$maxCount, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
