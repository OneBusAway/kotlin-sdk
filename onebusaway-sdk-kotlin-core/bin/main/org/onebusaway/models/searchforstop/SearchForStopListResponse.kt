...
class SearchForStopListResponse @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SearchForStopListResponse].
         *
    ...
    /** A builder for [SearchForStopListResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(searchForStopListResponse: SearchForStopListResponse) =
            apply {
                code = searchForStopListResponse.code
                currentTime = searchForStopListResponse.currentTime
                text = searchForStopListResponse.text
                version = searchForStopListResponse.version
                data = searchForStopListResponse.data
                additionalProperties = searchForStopListResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [SearchForStopListResponse].
         *
     ...
     *   expected type.
     */
    fun validate(): SearchForStopListResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    class Data @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
         ...
         * Used for best match union deserialization.
         */
        internal fun validity(): Int = (list.asKnown()?.sumOf { it.validity().toInt() } ?: 0) + (if (outOfRange.asKnown() == null) 0 else 1) + (references.asKnown()?.validity() ?: 0) + (if (limitExceeded.asKnown() == null) 0 else 1)
        ...
        class List @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
            ...
            private constructor(
                ...
                @JsonProperty("routeIds") @ExcludeMissing routeIds: JsonField<kotlin.collections.List<String>> = JsonMissing.of(),
                @JsonProperty("staticRouteIds") @ExcludeMissing staticRouteIds: JsonField<kotlin.collections.List<String>> = JsonMissing.of(),
            ...
            class Builder internal constructor() {
                 ...
                 *
                 * You should usually call [Builder.routeIds] with a well-typed `kotlin.collections.List<String>` value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun routeIds(routeIds: JsonField<kotlin.collections.List<String>>) =
                    apply {
                ...
                fun staticRouteIds(staticRouteIds: kotlin.collections.List<String>) = staticRouteIds(JsonField.of(staticRouteIds))

                /**
                 * Sets [Builder.staticRouteIds] to an arbitrary JSON value.
                 *
                 * You should usually call [Builder.staticRouteIds] with a well-typed `kotlin.collections.List<String>` value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
            ...
            override fun equals(other: Any?): Boolean {
              ...
              return other is List && id == other.id && lat == other.lat && locationType == other.locationType && lon == other.lon && name == other.name && parent == other.parent && routeIds == other.routeIds && staticRouteIds == other.staticRouteIds && code == other.code && direction == other.direction && wheelchairBoarding == other.wheelchairBoarding && additionalProperties == other.additionalProperties
            }
            ...
            override fun toString() = "List{id=$id, lat=$lat, locationType=$locationType, lon=$lon, name=$name, parent=$parent, routeIds=$routeIds, staticRouteIds=$staticRouteIds, code=$code, direction=$direction, wheelchairBoarding=$wheelchairBoarding, additionalProperties=$additionalProperties}"
        }
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is Data && list == other.list && outOfRange == other.outOfRange && references == other.references && limitExceeded == other.limitExceeded && additionalProperties == other.additionalProperties
        }

        private val hashCode: Int by lazy { Objects.hash(list, outOfRange, references, limitExceeded, additionalProperties) }

        override fun hashCode(): Int = hashCode

        override fun toString() = "Data{list=$list, outOfRange=$outOfRange, references=$references, limitExceeded=$limitExceeded, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is SearchForStopListResponse && code == other.code && currentTime == other.currentTime && text == other.text && version == other.version && data == other.data && additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() = "SearchForStopListResponse{code=$code, currentTime=$currentTime, text=$text, version=$version, data=$data, additionalProperties=$additionalProperties}"
}
