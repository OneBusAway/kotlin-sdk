...
class BlockRetrieveResponse @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(blockRetrieveResponse: BlockRetrieveResponse) =
            apply {
     ...
     *   expected type.
     */
    fun validate(): BlockRetrieveResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    class Data @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
        ...
        class Entry @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
            ...
            private constructor(
                ...
                @JsonProperty("configurations") @ExcludeMissing configurations: JsonField<List<Configuration>> = JsonMissing.of()
            ) : this(
              id,
              configurations,
              mutableMapOf(),
            ...
            class Builder internal constructor() {
                 ...
                 *
                 * You should usually call [Builder.configurations] with a well-typed `List<Configuration>` value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun configurations(configurations: JsonField<List<Configuration>>) =
                    apply {
                ...
                fun addConfiguration(configuration: Configuration) =
                    apply {
                        configurations = (configurations ?: JsonField.of(mutableListOf())).also {
             ...
             * Used for best match union deserialization.
             */
            internal fun validity(): Int = (if (id.asKnown() == null) 0 else 1) + (configurations.asKnown()?.sumOf { it.validity().toInt() } ?: 0)

            class Configuration @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
                ...
                @JsonCreator
                private constructor(
                    @JsonProperty("activeServiceIds") @ExcludeMissing activeServiceIds: JsonField<List<String>> = JsonMissing.of(),
                    @JsonProperty("trips") @ExcludeMissing trips: JsonField<List<Trip>> = JsonMissing.of(),
                    @JsonProperty("inactiveServiceIds") @ExcludeMissing inactiveServiceIds: JsonField<List<String>> = JsonMissing.of()
                ) : this(
                  activeServiceIds,
                  trips,
                  inactiveServiceIds,
                ...
                fun inactiveServiceIds(): List<String>? = inactiveServiceIds.getNullable("inactiveServiceIds")

                /**
                 * Returns the raw JSON value of [activeServiceIds].
                 *
                 * Unlike [activeServiceIds], this method doesn't throw if the JSON field has an unexpected type.
                 */
                 ...
                 *
                 * Unlike [inactiveServiceIds], this method doesn't throw if the JSON field has an unexpected type.
                 */
                ...
                class Builder internal constructor() {
                    ...
                    internal fun from(configuration: Configuration) =
                        apply {
                            ...
                            inactiveServiceIds = configuration.inactiveServiceIds.map { it.toMutableList() }
                     ...
                     *
                     * You should usually call [Builder.activeServiceIds] with a well-typed `List<String>` value instead. This method is primarily for setting the field to an undocumented or not yet
                     * supported value.
                     */
                    fun activeServiceIds(activeServiceIds: JsonField<List<String>>) =
                        apply {
                     ...
                     * @throws IllegalStateException if the field was previously set to a non-list.
                     */
                    fun addActiveServiceId(activeServiceId: String) =
                        apply {
                            activeServiceIds = (activeServiceIds ?: JsonField.of(mutableListOf())).also {
                     ...
                     *
                     * You should usually call [Builder.inactiveServiceIds] with a well-typed `List<String>` value instead. This method is primarily for setting the field to an undocumented or not yet
                     * supported value.
                     */
                    fun inactiveServiceIds(inactiveServiceIds: JsonField<List<String>>) =
                        apply {
                     ...
                     * @throws IllegalStateException if the field was previously set to a non-list.
                     */
                    fun addInactiveServiceId(inactiveServiceId: String) =
                        apply {
                            inactiveServiceIds = (inactiveServiceIds ?: JsonField.of(mutableListOf())).also {
                 ...
                 * Used for best match union deserialization.
                 */
                internal fun validity(): Int = (activeServiceIds.asKnown()?.size ?: 0) + (trips.asKnown()?.sumOf { it.validity().toInt() } ?: 0) + (inactiveServiceIds.asKnown()?.size ?: 0)
                ...
                class Trip @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
                    ...
                    @JsonCreator
                    private constructor(
                        @JsonProperty("accumulatedSlackTime") @ExcludeMissing accumulatedSlackTime: JsonField<Float> = JsonMissing.of(),
                        @JsonProperty("blockStopTimes") @ExcludeMissing blockStopTimes: JsonField<List<BlockStopTime>> = JsonMissing.of(),
                        @JsonProperty("distanceAlongBlock") @ExcludeMissing distanceAlongBlock: JsonField<Float> = JsonMissing.of(),
                    ...
                    /** @throws OnebusawaySdkInvalidDataException if the JSON field has an unexpected type or is unexpectedly missing or null (e.g. if the server responded with an unexpected value). */
                    fun accumulatedSlackTime(): Float = accumulatedSlackTime.getRequired("accumulatedSlackTime")

                    /** @throws OnebusawaySdkInvalidDataException if the JSON field has an unexpected type or is unexpectedly missing or null (e.g. if the server responded with an unexpected value). */
                    fun blockStopTimes(): List<BlockStopTime> = blockStopTimes.getRequired("blockStopTimes")

                    /** @throws OnebusawaySdkInvalidDataException if the JSON field has an unexpected type or is unexpectedly missing or null (e.g. if the server responded with an unexpected value). */
                    fun distanceAlongBlock(): Float = distanceAlongBlock.getRequired("distanceAlongBlock")
                     ...
                     *
                     * Unlike [accumulatedSlackTime], this method doesn't throw if the JSON field has an unexpected type.
                     */
                     ...
                     *
                     * Unlike [blockStopTimes], this method doesn't throw if the JSON field has an unexpected type.
                     */
                     ...
                     *
                     * Unlike [distanceAlongBlock], this method doesn't throw if the JSON field has an unexpected type.
                     */
                    ...
                    class Builder internal constructor() {
                        ...
                        fun accumulatedSlackTime(accumulatedSlackTime: Float) = accumulatedSlackTime(JsonField.of(accumulatedSlackTime))

                        /**
                         * Sets [Builder.accumulatedSlackTime] to an arbitrary JSON value.
                         *
                         * You should usually call [Builder.accumulatedSlackTime] with a well-typed [Float] value instead. This method is primarily for setting the field to an undocumented or not yet
                         * supported value.
                         */
                         ...
                         *
                         * You should usually call [Builder.blockStopTimes] with a well-typed `List<BlockStopTime>` value instead. This method is primarily for setting the field to an undocumented or not yet
                         * supported value.
                         */
                        fun blockStopTimes(blockStopTimes: JsonField<List<BlockStopTime>>) =
                            apply {
                         ...
                         * @throws IllegalStateException if the field was previously set to a non-list.
                         */
                        fun addBlockStopTime(blockStopTime: BlockStopTime) =
                            apply {
                                blockStopTimes = (blockStopTimes ?: JsonField.of(mutableListOf())).also {
                                    checkKnown("blockStopTimes", it).add(blockStopTime)
                                }
                            }

                        fun distanceAlongBlock(distanceAlongBlock: Float) = distanceAlongBlock(JsonField.of(distanceAlongBlock))

                        /**
                         * Sets [Builder.distanceAlongBlock] to an arbitrary JSON value.
                         *
                         * You should usually call [Builder.distanceAlongBlock] with a well-typed [Float] value instead. This method is primarily for setting the field to an undocumented or not yet
                         * supported value.
                         */
                        fun distanceAlongBlock(distanceAlongBlock: JsonField<Float>) =
                            apply {
                     ...
                     * Used for best match union deserialization.
                     */
                    internal fun validity(): Int = (if (accumulatedSlackTime.asKnown() == null) 0 else 1) + (blockStopTimes.asKnown()?.sumOf { it.validity().toInt() } ?: 0) + (if (distanceAlongBlock.asKnown() == null) 0 else 1) + (if (tripId.asKnown() == null) 0 else 1)

                    class BlockStopTime @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
                        private val accumulatedSlackTime: JsonField<Float>,
                        ...
                        private constructor(
                            @JsonProperty("accumulatedSlackTime") @ExcludeMissing accumulatedSlackTime: JsonField<Float> = JsonMissing.of(),
                            @JsonProperty("blockSequence") @ExcludeMissing blockSequence: JsonField<Long> = JsonMissing.of(),
                            @JsonProperty("distanceAlongBlock") @ExcludeMissing distanceAlongBlock: JsonField<Float> = JsonMissing.of(),
                            @JsonProperty("stopTime") @ExcludeMissing stopTime: JsonField<StopTime> = JsonMissing.of()
                        ) : this(
                          accumulatedSlackTime,
                          blockSequence,
                          distanceAlongBlock,
                         ...
                         *
                         * Unlike [blockSequence], this method doesn't throw if the JSON field has an unexpected type.
                         */
                        ...
                        class Builder internal constructor() {
                            ...
                            internal fun from(blockStopTime: BlockStopTime) =
                                apply {
                                    ...
                                    additionalProperties = blockStopTime.additionalProperties.toMutableMap()
                                }
                             ...
                             *
                             * You should usually call [Builder.blockSequence] with a well-typed [Long] value instead. This method is primarily for setting the field to an undocumented or not yet
                             * supported value.
                             */
                            fun blockSequence(blockSequence: JsonField<Long>) =
                                apply {
                             ...
                             *
                             * You should usually call [Builder.stopTime] with a well-typed [StopTime] value instead. This method is primarily for setting the field to an undocumented or not yet
                             * supported value.
                             */
                            fun stopTime(stopTime: JsonField<StopTime>) =
                                apply {
                         ...
                         * Used for best match union deserialization.
                         */
                        internal fun validity(): Int = (if (accumulatedSlackTime.asKnown() == null) 0 else 1) + (if (blockSequence.asKnown() == null) 0 else 1) + (if (distanceAlongBlock.asKnown() == null) 0 else 1) + (stopTime.asKnown()?.validity() ?: 0)
                        ...
                        class StopTime @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
                            ...
                            private constructor(
                                ...
                                @JsonProperty("dropOffType") @ExcludeMissing dropOffType: JsonField<Long> = JsonMissing.of(),
                                @JsonProperty("pickupType") @ExcludeMissing pickupType: JsonField<Long> = JsonMissing.of()
                            ) : this(
                              arrivalTime,
                              departureTime,
                              stopId,
                             ...
                             *
                             * Unlike [dropOffType], this method doesn't throw if the JSON field has an unexpected type.
                             */
                             ...
                             *
                             * Unlike [pickupType], this method doesn't throw if the JSON field has an unexpected type.
                             */
                            ...
                            class Builder internal constructor() {
                                 ...
                                 *
                                 * You should usually call [Builder.dropOffType] with a well-typed [Long] value instead. This method is primarily for setting the field to an undocumented or not yet
                                 * supported value.
                                 */
                                fun dropOffType(dropOffType: JsonField<Long>) =
                                    apply {
                                 ...
                                 *
                                 * You should usually call [Builder.pickupType] with a well-typed [Long] value instead. This method is primarily for setting the field to an undocumented or not yet
                                 * supported value.
                                 */
                                fun pickupType(pickupType: JsonField<Long>) =
                                    apply {
                             ...
                             * Used for best match union deserialization.
                             */
                            internal fun validity(): Int = (if (arrivalTime.asKnown() == null) 0 else 1) + (if (departureTime.asKnown() == null) 0 else 1) + (if (stopId.asKnown() == null) 0 else 1) + (if (dropOffType.asKnown() == null) 0 else 1) + (if (pickupType.asKnown() == null) 0 else 1)
                            ...
                            override fun equals(other: Any?): Boolean {
                              ...
                              return other is StopTime && arrivalTime == other.arrivalTime && departureTime == other.departureTime && stopId == other.stopId && dropOffType == other.dropOffType && pickupType == other.pickupType && additionalProperties == other.additionalProperties
                            }
                            ...
                            override fun toString() = "StopTime{arrivalTime=$arrivalTime, departureTime=$departureTime, stopId=$stopId, dropOffType=$dropOffType, pickupType=$pickupType, additionalProperties=$additionalProperties}"
                        }
                        ...
                        override fun equals(other: Any?): Boolean {
                          ...
                          return other is BlockStopTime && accumulatedSlackTime == other.accumulatedSlackTime && blockSequence == other.blockSequence && distanceAlongBlock == other.distanceAlongBlock && stopTime == other.stopTime && additionalProperties == other.additionalProperties
                        }
                        ...
                        override fun toString() = "BlockStopTime{accumulatedSlackTime=$accumulatedSlackTime, blockSequence=$blockSequence, distanceAlongBlock=$distanceAlongBlock, stopTime=$stopTime, additionalProperties=$additionalProperties}"
                    }
                    ...
                    override fun equals(other: Any?): Boolean {
                      ...
                      return other is Trip && accumulatedSlackTime == other.accumulatedSlackTime && blockStopTimes == other.blockStopTimes && distanceAlongBlock == other.distanceAlongBlock && tripId == other.tripId && additionalProperties == other.additionalProperties
                    }
                    ...
                    override fun toString() = "Trip{accumulatedSlackTime=$accumulatedSlackTime, blockStopTimes=$blockStopTimes, distanceAlongBlock=$distanceAlongBlock, tripId=$tripId, additionalProperties=$additionalProperties}"
                }
                ...
                override fun equals(other: Any?): Boolean {
                  ...
                  return other is Configuration && activeServiceIds == other.activeServiceIds && trips == other.trips && inactiveServiceIds == other.inactiveServiceIds && additionalProperties == other.additionalProperties
                }
                ...
                override fun toString() = "Configuration{activeServiceIds=$activeServiceIds, trips=$trips, inactiveServiceIds=$inactiveServiceIds, additionalProperties=$additionalProperties}"
            }
            ...
            override fun equals(other: Any?): Boolean {
              ...
              return other is Entry && id == other.id && configurations == other.configurations && additionalProperties == other.additionalProperties
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is BlockRetrieveResponse && code == other.code && currentTime == other.currentTime && text == other.text && version == other.version && data == other.data && additionalProperties == other.additionalProperties
    }
