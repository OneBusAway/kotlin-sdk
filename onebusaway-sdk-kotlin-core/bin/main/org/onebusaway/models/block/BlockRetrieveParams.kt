...
class BlockRetrieveParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(blockRetrieveParams: BlockRetrieveParams) =
            apply {
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is BlockRetrieveParams && blockId == other.blockId && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(blockId, additionalHeaders, additionalQueryParams)

    override fun toString() = "BlockRetrieveParams{blockId=$blockId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
