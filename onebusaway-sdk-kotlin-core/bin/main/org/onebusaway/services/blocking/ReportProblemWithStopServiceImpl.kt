...
class ReportProblemWithStopServiceImpl internal constructor(
    ...
    override fun withOptions(modifier: (ClientOptions.Builder) -> Unit): ReportProblemWithStopService = ReportProblemWithStopServiceImpl(clientOptions.toBuilder().apply(modifier).build())
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun withOptions(modifier: (ClientOptions.Builder) -> Unit): ReportProblemWithStopService.WithRawResponse = ReportProblemWithStopServiceImpl.WithRawResponseImpl(clientOptions.toBuilder().apply(modifier).build())

        private val retrieveHandler: Handler<ResponseWrapper> = jsonHandler<ResponseWrapper>(clientOptions.jsonMapper)
        ...
        override fun retrieve(params: ReportProblemWithStopRetrieveParams, requestOptions: RequestOptions): HttpResponseFor<ResponseWrapper> {
          ...
          val request = HttpRequest.builder()
            ...
            .addPathSegments("api", "where", "report-problem-with-stop", "${params._pathParam(0)}.json")
            .build()
            .prepare(
