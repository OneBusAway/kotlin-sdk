...
class ArrivalAndDepartureServiceImpl internal constructor(
    ...
    override fun withOptions(modifier: (ClientOptions.Builder) -> Unit): ArrivalAndDepartureService = ArrivalAndDepartureServiceImpl(clientOptions.toBuilder().apply(modifier).build())
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun withOptions(modifier: (ClientOptions.Builder) -> Unit): ArrivalAndDepartureService.WithRawResponse = ArrivalAndDepartureServiceImpl.WithRawResponseImpl(clientOptions.toBuilder().apply(modifier).build())
