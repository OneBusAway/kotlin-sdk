...
class ShapeServiceImpl internal constructor(
    ...
    override fun withOptions(modifier: (ClientOptions.Builder) -> Unit): ShapeService = ShapeServiceImpl(clientOptions.toBuilder().apply(modifier).build())
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun withOptions(modifier: (ClientOptions.Builder) -> Unit): ShapeService.WithRawResponse = ShapeServiceImpl.WithRawResponseImpl(clientOptions.toBuilder().apply(modifier).build())
