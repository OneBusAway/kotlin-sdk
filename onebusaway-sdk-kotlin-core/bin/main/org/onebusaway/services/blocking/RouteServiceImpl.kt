...
class RouteServiceImpl internal constructor(
    ...
    override fun withOptions(modifier: (ClientOptions.Builder) -> Unit): RouteService = RouteServiceImpl(clientOptions.toBuilder().apply(modifier).build())
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun withOptions(modifier: (ClientOptions.Builder) -> Unit): RouteService.WithRawResponse = RouteServiceImpl.WithRawResponseImpl(clientOptions.toBuilder().apply(modifier).build())

        private val retrieveHandler: Handler<RouteRetrieveResponse> = jsonHandler<RouteRetrieveResponse>(clientOptions.jsonMapper)
