...
interface TripService {
    ...
    fun retrieve(tripId: String, params: TripRetrieveParams = TripRetrieveParams.none(), requestOptions: RequestOptions = RequestOptions.none()): TripRetrieveResponse =
        retrieve(
          params.toBuilder()
              .tripId(tripId)
    ...
    interface WithRawResponse {
        ...
        /** Returns a raw HTTP response for `get /api/where/trip/{tripID}.json`, but is otherwise the             same as [TripService.retrieve]. */
        @MustBeClosed
        fun retrieve(tripId: String, params: TripRetrieveParams = TripRetrieveParams.none(), requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<TripRetrieveResponse> =
            retrieve(
              params.toBuilder()
                  .tripId(tripId)
                  .build(), requestOptions
        ...
        /** @see retrieve */
        @MustBeClosed
        fun retrieve(tripId: String, requestOptions: RequestOptions): HttpResponseFor<TripRetrieveResponse> =
            retrieve(
              tripId,
              TripRetrieveParams.none(),
              requestOptions,
