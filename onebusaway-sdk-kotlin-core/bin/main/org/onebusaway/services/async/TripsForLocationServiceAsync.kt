...
interface TripsForLocationServiceAsync {
    ...
    /** A view of [TripsForLocationServiceAsync] that provides access to raw HTTP responses for each method. */
    interface WithRawResponse {
         ...
         * The original service is not modified.
         */
        fun withOptions(modifier: (ClientOptions.Builder) -> Unit): TripsForLocationServiceAsync.WithRawResponse

        /** Returns a raw HTTP response for `get /api/where/trips-for-location.json`, but is otherwise the             same as [TripsForLocationServiceAsync.list]. */
        @MustBeClosed
