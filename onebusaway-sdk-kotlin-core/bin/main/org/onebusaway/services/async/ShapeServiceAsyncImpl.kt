...
class ShapeServiceAsyncImpl internal constructor(
    ...
    override fun withOptions(modifier: (ClientOptions.Builder) -> Unit): ShapeServiceAsync = ShapeServiceAsyncImpl(clientOptions.toBuilder().apply(modifier).build())
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun withOptions(modifier: (ClientOptions.Builder) -> Unit): ShapeServiceAsync.WithRawResponse = ShapeServiceAsyncImpl.WithRawResponseImpl(clientOptions.toBuilder().apply(modifier).build())

        private val retrieveHandler: Handler<ShapeRetrieveResponse> = jsonHandler<ShapeRetrieveResponse>(clientOptions.jsonMapper)
