...
class RoutesForLocationServiceAsyncImpl internal constructor(
    ...
    override fun withOptions(modifier: (ClientOptions.Builder) -> Unit): RoutesForLocationServiceAsync = RoutesForLocationServiceAsyncImpl(clientOptions.toBuilder().apply(modifier).build())
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun withOptions(modifier: (ClientOptions.Builder) -> Unit): RoutesForLocationServiceAsync.WithRawResponse = RoutesForLocationServiceAsyncImpl.WithRawResponseImpl(clientOptions.toBuilder().apply(modifier).build())

        private val listHandler: Handler<RoutesForLocationListResponse> = jsonHandler<RoutesForLocationListResponse>(clientOptions.jsonMapper)
