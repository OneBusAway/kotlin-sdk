...
/**
 * A client for interacting with the Onebusaway SDK REST API asynchronously.
...
interface OnebusawaySdkClientAsync {
    ...
    /** A view of [OnebusawaySdkClientAsync] that provides access to raw HTTP responses for each method. */
    interface WithRawResponse {
         ...
         * The original service is not modified.
         */
        fun withOptions(modifier: (ClientOptions.Builder) -> Unit): OnebusawaySdkClientAsync.WithRawResponse
        ...
        fun arrivalsAndDeparturesForLocation(): ArrivalsAndDeparturesForLocationServiceAsync.WithRawResponse
