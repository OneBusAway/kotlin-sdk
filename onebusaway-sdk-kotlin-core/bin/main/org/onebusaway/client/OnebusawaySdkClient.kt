...
/**
 * A client for interacting with the Onebusaway SDK REST API synchronously.
...
interface OnebusawaySdkClient {
    ...
    interface WithRawResponse {
         ...
         * The original service is not modified.
         */
        fun withOptions(modifier: (ClientOptions.Builder) -> Unit): OnebusawaySdkClient.WithRawResponse
        ...
        fun arrivalsAndDeparturesForLocation(): ArrivalsAndDeparturesForLocationService.WithRawResponse
