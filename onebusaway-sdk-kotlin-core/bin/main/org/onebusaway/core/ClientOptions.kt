...
import org.onebusaway.core.PhantomReachableSleeper
import org.onebusaway.core.Sleeper
import org.onebusaway.core.Timeout
import org.onebusaway.core.checkJacksonVersionCompatibility
...
class ClientOptions private constructor(
     ...
     *
     * Use the one published in `onebusaway-sdk-kotlin-client-okhttp` or implement your
     * own.
     *
     ...
     *
     * Defaults to [org.onebusaway.core.jsonMapper]. The default is usually sufficient
    ...
    class Builder internal constructor() {
        ...
        fun fromEnv() =
            apply {
                ...
                (System.getProperty("onebusawaysdk.baseUrl") ?: System.getenv("ONEBUSAWAY_SDK_BASE_URL"))?.let {
                    baseUrl(it)
                }
                (System.getProperty("onebusawaysdk.onebusawayApiKey") ?: System.getenv("ONEBUSAWAY_API_KEY"))?.let {
                    apiKey(it)
                }
