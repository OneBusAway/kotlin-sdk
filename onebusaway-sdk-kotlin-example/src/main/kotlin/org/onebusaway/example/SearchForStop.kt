...
object SearchForStop {
    ...
    fun main(args: Array<String>) {
        ...
        val params = SearchForStopListParams.builder().input(searchInput).build()

        // Retrieve the stop search results
        val searchForStopListResponse: SearchForStopListResponse =
            client.searchForStop().list(params)
