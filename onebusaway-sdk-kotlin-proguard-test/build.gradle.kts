...
dependencies {
    testImplementation(project(":onebusaway-sdk-kotlin"))
...
val proguardJar by tasks.registering(proguard.gradle.ProGuardTask::class) {
    ...
    configuration("../onebusaway-sdk-kotlin-core/src/main/resources/META-INF/proguard/onebusaway-sdk-kotlin-core.pro")
}
...
val r8Jar by tasks.registering(JavaExec::class) {
    ...
    args = listOf(
        ...
        "--pg-conf", "./test.pro",
        "--pg-conf", "../onebusaway-sdk-kotlin-core/src/main/resources/META-INF/proguard/onebusaway-sdk-kotlin-core.pro",
